...
async function runSelfTest() {
  ...
  pass(validateVersionSet({ workspaceVersion: "1.2.0-alpha.15", lockVersion: "1.2.0-alpha.15", packageVersion: "1.2.0-alpha.15", tauriVersion: "1.2.0-alpha.15" }) === "1.2.0-alpha.15", "synchronized version set is accepted");
  rejects(() => validateVersionSet({ workspaceVersion: "1.2.0-alpha.15", lockVersion: "1.2.0-alpha.14", packageVersion: "1.2.0-alpha.15", tauriVersion: "1.2.0-alpha.15" }), /version drift/, "version drift is rejected");

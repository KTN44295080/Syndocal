...
| Independent FX | Color / Chaser / Move / Valueは独立body/runtime/editor。Curveと2種Mappingsは既存runtimeのrecipe分類 | Daslightは独立generator群 | 劣 | T19でCurve / Mapping / Colour Mappingを独立化 |

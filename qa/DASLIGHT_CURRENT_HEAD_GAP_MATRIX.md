...
- 監査日: 2026-08-09
- 監査基準: 本ファイルを含む現HEAD（visual MIDI/OSC/DMX Learn + DVC MIDI feedback + DVC DMX Control Mapping復元 + Move Symmetry照合 + DVC beam-target保持 + Plasma/Rainbow source parity）

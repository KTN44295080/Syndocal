...
export function MappingStageObjectPanel(props: MappingStageObjectPanelProps) {
  ...
  return (
    <Show
      ...
      fallback={
        <details class="mappingStageObjectTool" data-mapping-stage-object-tool>
          <summary
            data-mapping-stage-object-guidance
            title="Select a stage object on the map, or open object tools to create one."
          >

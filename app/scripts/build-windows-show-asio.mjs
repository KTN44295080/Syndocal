...
async function runSelfTest() {
  ...
  pass(validateVersionSet({ workspaceVersion: "1.2.0-alpha.18", lockVersion: "1.2.0-alpha.18", packageVersion: "1.2.0-alpha.18", tauriVersion: "1.2.0-alpha.18" }) === "1.2.0-alpha.18", "synchronized version set is accepted");
  rejects(() => validateVersionSet({ workspaceVersion: "1.2.0-alpha.18", lockVersion: "1.2.0-alpha.14", packageVersion: "1.2.0-alpha.18", tauriVersion: "1.2.0-alpha.18" }), /version drift/, "version drift is rejected");

...
- Updated viewport acceptance so all five reference browser sizes require the dedicated VJ surface and reject a visible lighting desk in VJ mode. The 1920x1080 primary gate and 1920x1032 measured-client-size fixture results/screenshots are the browser visual sign-off; 2048x1152 is the extended ceiling and 1366x768/1280x720 are compact containment fallbacks. Native evidence remains a separate acceptance path.

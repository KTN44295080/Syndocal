...
const files = new Map(
  await Promise.all(
    [
      ...
      "../src/components/MappingStageObjectPanel.tsx",
      "../src/components/PatchFixtureFormPanel.tsx",
      "../src/components/PatchProfileBrowserPanel.tsx",
...
const expectedGuidance = [
  ...
  ["../src/components/MappingStageObjectPanel.tsx", "Select a stage object on the map, or open object tools to create one."],
  ["../src/components/PatchProfileBrowserPanel.tsx", "No cached GDTF profiles."],
  ["../src/components/PatchProfileBrowserPanel.tsx", "No recently used profiles."],
  ...
  ["../src/components/PatchFixtureFormPanel.tsx", "Choose a fixture profile above to arm patching."],

...
```json syndocal-q1-q4-ledger
{
  ...
  "expected_counts": {
    ...
    "flow_markers": { "Open": 34, "Deferred": 8, "Complete": 16 },
    "q1_rows": 32,
    "q2_decisions": 15,
    "q3_risks": 14,
    "q4_evidence": 41
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2", "disposition": "Follow current-source software/runtime/UI and rendered-browser proof is accepted; persistence focus/selection, native synchronization, audible/external clocks, and physical/venue boundaries remain." },
      "nonclaim": "This row does not claim Timeline persistence, audible-device acceptance, native A/V/Lighting synchronization, external-clock behavior, physical output, or that pre-rendered WAV evidence replaces the runtime scheduler requirement.",
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-TIMELINE-MUSICAL-SW-2026-09-12", "EV-TIMELINE-FOLLOW-SW-2026-09-13"]
    },
    {
      "id": "COV-UI-SHELL-001",

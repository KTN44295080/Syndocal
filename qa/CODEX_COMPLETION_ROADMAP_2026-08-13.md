...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p io --locked show_clock_lan -- --nocapture --test-threads=1", "expected_count": 19 },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Protocol admission, deterministic estimator/bounded-slew/Hold/STALE, action scheduling, output-generation gate, exact-peer loopback transport, process-owned Primary/Standby IPC workers, and current-source engine beat-position continuity are implemented; action/Hold/Re-arm authority wiring, ShowClock output-gate integration, restart replay restoration, partition/rejoin, witness/interlock, and two-machine venue proof remain." },
      "nonclaim": "This row does not claim action IPC, Manual Hold/Re-arm authority, ShowClock output-gate arm, automatic failover, physical output, restart replay restoration, partition/rejoin, or two-machine venue acceptance.",
  ...
  "q4_evidence": [
    ...
    { "id": "EV-SHOWCLOCK-PROTOCOL-SW-2026-09-12", "scope": "Current-main ShowClock v1 authenticated sample/action admission and Manual Hold/Re-arm protocol core, including bounded dedupe and redacted key ownership", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p protocol --locked -- --test-threads=1", "exit_code": 0, "assertion_count": 226, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Pure protocol tests have no shipped binary artifact; the current source, lockfile, command, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/SHOWCLOCK_PROTOCOL_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is only the transport-neutral protocol/fence core; it does not constitute current-source acceptance of LAN discovery/pairing, clock estimator accuracy, native output authority, automatic failover, physical devices, partition/rejoin, two-machine soak, or venue acceptance.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
    ...
    { "id": "EV-SHOWCLOCK-RUNTIME-LAN-SW-2026-09-12", "scope": "Current-main ShowClock deterministic estimator with bounded slew, expiry-derived STALE/Hold/Re-arm, bounded action scheduling, all-domain output-generation gate, and exact-peer signed UDP loopback transport", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p io --locked show_clock_lan -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 19, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source protocol/IO tests have no shipped binary artifact; exact sources, pinned Windows linker, commands, results, and loopback-only boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is current-source and loopback software evidence only; it does not constitute Tauri IPC/UI wiring, physical output, restart replay restoration, real wired two-machine partition/rejoin, witness/interlock, automatic failover, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] }
    ,{ "id": "EV-SHOWCLOCK-IPC-UI-2PROC-SW-2026-09-12", "scope": "Current-main ShowClock process-owned Primary/Standby Tauri IPC lifecycle, authenticated action IPC, fixed-capacity generation-bound scheduling, Manual Hold/Re-arm, exact-peer two-process sample loopback, stale-on-primary-loss, session-incarnation fence, Setup/IO UI wiring, and native release/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; cargo test --manifest-path app/src-tauri/Cargo.toml --locked show_clock_ipc::tests -- --nocapture --test-threads=1; cargo test -p io --locked --test show_clock_two_process -- --nocapture --test-threads=1; pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run build; pnpm.cmd --dir app run check:frontend-invokes; pnpm.cmd --dir app run check:frontend-command-routing; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app tauri build --no-bundle", "exit_code": 0, "assertion_count": 23, "ignored_count": 0, "warning_count": 0, "artifact_hash": "89D70698A224920F04B22CC8A5C733DB0C5A6B560F039A3ECF0DCE66365E00D6", "artifact_na_reason": "The native release build produces the current checkout executable; this hash is the exact current-source process-smoke binary and is not a signed or published release artifact.", "raw_evidence_paths": ["qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md", "qa/LUNA_SHOWCLOCK_REVIEW_HANDOFF_2026-09-12.md"], "currency_nonclaim": "Current-source ShowClock action/fence IPC/UI, two-process loopback, and Windows native build/process-smoke evidence only; it does not constitute native UI interaction matrix, output-gate arm, physical output, restart replay restoration, real wired two-machine partition/rejoin, witness/interlock, automatic failover, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] }

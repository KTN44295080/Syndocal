...
use crate::control_plane_command::{
    OUTPUT_BLACKOUT_SET_OPERATION_ID, OUTPUT_BLACKOUT_RELEASE_OPERATION_ID, OUTPUT_CONTROL_COMMAND_SCHEMA_VERSION,
    ...
    OUTPUT_VIDEO_CLIP_TAKE_OPERATION_ID, OUTPUT_VIDEO_MASTER_SET_OPERATION_ID,
...
mod tests {
    ...
    #[test]
    fn show_spout_reset_operation_accepts_only_current_schema() {
        assert_eq!(OUTPUT_CONTROL_COMMAND_SCHEMA_VERSION, 11);

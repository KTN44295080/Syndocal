...
| Editing and UI | Complete locally; final operator sign-off open | Transaction Undo/Redo, revisioned snapshot delta, 90/100/110% scale, keyboard/focus gates, saved layout, English/Japanese 100% static coverage; maximized 1920x1080 is the primary visual gate, with 2048x1152 ceiling and 1366x768/1280x720 fallback containment for the full-window Lighting FX/VJ desks and persistent Touch safety deck | Operator rehearsal with the final console/controller layout |

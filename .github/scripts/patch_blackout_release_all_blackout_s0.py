...
# Aggregate totals are derived from family counts by the preceding runtime
# guard patch. Removing two frontend aliases therefore requires changing only
# the two frontend family counts; legacy/source totals follow automatically.
replace_exact(
    registry,

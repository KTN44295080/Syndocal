...
Current product metadata is `1.2.0-alpha.50` on branch
...
- Windows: `Syndocal_1.2.0-alpha.50_x64-setup.exe` (NSIS)、`Syndocal_1.2.0-alpha.50_x64_ja-JP.msi`
- macOS: `.app`、DMG
- Linux: `.deb`、AppImage

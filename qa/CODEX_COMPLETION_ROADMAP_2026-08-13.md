...
```json syndocal-q1-q4-ledger
{
  ...
  "q4_evidence": [
    ...
    { "id": "EV-AI3-NATIVE-INGRESS-CURRENT-SW-2026-09-14", "scope": "Current-source AI3 ingress/admission/ownership/safety contracts adjacent to native client and device acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:frontend-command-routing; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime", "exit_code": 0, "assertion_count": 5, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Source checks produce no native client, device, or physical-output artifact; the admission inventory source fingerprint and external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/SYNDOCAL_AI_CONTROL_PLANE_ROADMAP.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "Current-source admission, ownership, and safety evidence only; it does not establish native MIDI/OSC/DMX/Remote ingress, real Art-Net/fixture behavior, reconnect, latency, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },

...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p io --locked show_clock_lan -- --nocapture --test-threads=1", "expected_count": 22 },
      "native_proof": { "status": "recorded", "artifact_hash": "ABE07C3592AC2F06EA94BD19E1CBCBE592848224430451AFD3FA712E954F34B5", "raw_evidence_paths": ["qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md", "qa/LUNA_SHOWCLOCK_REVIEW_HANDOFF_2026-09-12.md"], "na_reason": null },

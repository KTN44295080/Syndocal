...
const invokeBlackoutRelease: FrontendTauriInvoke = async <T,>(command: string, args?: Record<string, unknown>) => {
...
export function BlackoutReleaseControl() {
            ...
            <Show when={prepared()} keyed>
              {(consent) => (
                <>
                  ...
                  <small>
                    This request is single-use and expires automatically.
                  </small>
                </>
              )}
            </Show>

...
```json syndocal-q1-q4-ledger
{
  ...
  "q4_evidence": [
    ...
    {"id":"EV-OUTPUT-COM5-PREPARE-UI-CURRENT-2026-09-15","scope":"Current native COM5 USB-DMX Prepare attempt, fail-closed publication result, All Blackout rejection, and exact-process restart recovery","kind":"current-source-automated","status":"accepted-current","date":"2026-09-15","command":"Native release Syndocal UI: load samples/phase1-mini-show.sdc; select COM5 FTDI; Prepare confirmation Yes; observe 4/4 optional Open DMX arm publication_failed; All Blackout invalid_request/forbidden; discard-close and restart exact target/release/syndocal.exe","exit_code":0,"assertion_count":4,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"Native screenshots are stored under C:\\TEMP and are not shipped artifacts; no physical fixture receipt or serial-DMX analyzer artifact was produced.","raw_evidence_paths":["qa/DMX_USB_RDM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md","qa/VIDEO_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This records current native fail-closed and application-restart behavior only; it is not current-source acceptance and does not claim physical zero delivery, fixture output, blackout delivery, RDM/TOD, analyzer timing, or product completion.","linked_q1_ids":["COV-OUTPUT-LOCAL-001"]}
  ]
}
```

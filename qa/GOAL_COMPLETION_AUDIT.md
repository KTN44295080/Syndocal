...
| Lighting Cue Engine v2 | Complete locally | Cue Lists/Executors, tracking/block, Parts, IFCB Fade/Delay, Follow, MIB, HTP/LTP, Programmer/Blind, reference Palettes, DMX Input/Merge, ENTTEC Pro-compatible/DMXKing/Open DMX serial output, RDM protocol tests | Art-Net/sACN/serial waveform, QLC+-class serial VID/PID and dual-port expansion, RDM fixtures/gateway, controller round trip |

...
main after validation. The final main ref was pushed and equals `origin/main`;
the exact post-record SHA is reported in the integration handoff. The remaining
boundaries are not a request to reimplement this feature.

...
- Desktopは起動時最大化を既定とし、F11でwindow fullscreen、Escで解除できる状態を維持する。主browser visual gateは1920x1080、1920x1032はbrowser上のmeasured-client-size fixtureとし、native受入の最大化client 1920x1032、F11 fullscreen 1920x1080、Esc後の1920x1032復帰とは証拠を分離する。2048x1152は拡張上限回帰、1366x768／1280x720は小画面containment fallbackとして別に維持する。fallback通過だけでUIデザイン合格としない。

...
use protocol::{
    CueId, FixtureId, LearnedOscControl, OscControlAction, OscControlMapping, OscInputConfig,
    VideoLayerId, VideoOutputId, VideoParam,
};
...
mod tests {
        ...
        let packet = OscPacket::Bundle(OscBundle {
            ...
            content: vec![
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/fixture/42/Dimmer".to_string(),
                    args: vec![OscType::Float(0.5)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/fixture/42/highlight".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/fixture/42/solo".to_string(),
                    args: vec![OscType::Bool(false)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/fixture/42/park".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
            ],
        });
    ...
    fn maps_global_clock_and_blackout_messages() {
        let packet = OscPacket::Bundle(OscBundle {
            ...
            content: vec![
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/blackout".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/cue/pause".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/cue/go".to_string(),
                    args: Vec::new(),
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/cue/back".to_string(),
                    args: Vec::new(),
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/cue/9".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/cue/10/go".to_string(),
                    args: vec![OscType::Bool(false)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/timeline/play".to_string(),
                    args: Vec::new(),
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/timeline/seek".to_string(),
                    args: vec![OscType::Int(24_000)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/timeline/pause".to_string(),
                    args: Vec::new(),
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/master".to_string(),
                    args: vec![OscType::Float(0.42)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/submaster/front".to_string(),
                    args: vec![OscType::Float(0.25)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/group/front/highlight".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/group/front/solo".to_string(),
                    args: vec![OscType::Bool(false)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/group/front/park".to_string(),
                    args: Vec::new(),
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/bpm".to_string(),
                    args: vec![OscType::Float(128.5)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/tap".to_string(),
                    args: Vec::new(),
                }),
            ],
        });
    ...
    fn maps_video_control_messages() {
        let packet = OscPacket::Bundle(OscBundle {
            ...
            content: vec![
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/opacity".to_string(),
                    args: vec![OscType::Float(0.5)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/transform_x".to_string(),
                    args: vec![OscType::Float(-0.25)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/enabled".to_string(),
                    args: vec![OscType::Bool(false)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/solo".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/bpm_sync".to_string(),
                    args: vec![OscType::Float(1.0)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/play".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/seek".to_string(),
                    args: vec![OscType::Int(1500)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/loop".to_string(),
                    args: vec![OscType::Bool(true), OscType::Int(500), OscType::Int(2500)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/cue/add".to_string(),
                    args: Vec::new(),
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/cue/add".to_string(),
                ...
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/cue/jump".to_string(),
                    args: vec![OscType::Int(1)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/layer/7/cue/remove".to_string(),
                    args: vec![OscType::Int(1750)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/output/3/enabled".to_string(),
                    args: vec![OscType::Bool(false)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/output/3/opacity".to_string(),
                    args: vec![OscType::Float(0.6)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/output/3/fade".to_string(),
                    args: vec![OscType::Float(0.2), OscType::Int(750)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/output/3/fade_in".to_string(),
                    args: vec![OscType::Int(250)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/output/3/fade_out".to_string(),
                    args: Vec::new(),
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/output/3/blackout".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/master".to_string(),
                    args: vec![OscType::Float(0.75)],
                }),
                OscPacket::Message(OscMessage {
                    addr: "/kdmx/video/blackout".to_string(),
                    args: vec![OscType::Bool(true)],
                }),
            ],
        });

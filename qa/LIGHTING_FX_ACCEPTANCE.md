...
3. Move: independent paired Pan/Tilt evaluation with editable path shapes/points, path translate/resize/rotate, Absolute/Relative operation and live direction/phase/size controls.

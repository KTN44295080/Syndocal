...
- Updated viewport acceptance so all five reference sizes require the dedicated VJ surface and reject a visible lighting desk in VJ mode. The maximized 1920x1080 and measured native 1920x1032 results/screenshots are the visual sign-off; 2048x1152 is the extended ceiling and 1366x768/1280x720 are compact containment fallbacks.

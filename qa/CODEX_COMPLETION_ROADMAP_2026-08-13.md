...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p io --locked show_clock_lan -- --nocapture --test-threads=1", "expected_count": 20 },
      "native_proof": { "status": "recorded", "artifact_hash": "75EE768A6500E3C0BCEFBF6B2F505046ECAFF82C8F57C42E30121266060D0CDE", "raw_evidence_paths": ["qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md", "qa/LUNA_SHOWCLOCK_REVIEW_HANDOFF_2026-09-12.md"], "na_reason": null },

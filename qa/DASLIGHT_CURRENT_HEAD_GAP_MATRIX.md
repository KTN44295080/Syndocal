...
| Independent FX | Color / Chaser / Move / Value / Curveは独立body/runtime/editor。2種Mappingsは既存runtimeのrecipe分類 | Daslightは独立generator群 | 劣 | T19-B/CでMapping / Colour Mappingを独立化 |

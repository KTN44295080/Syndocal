...
## Current execution authority — 2026-08-28
...
KDMX execution authority is `1.2.0-alpha.25` at source commit
`566a7101b0d5c9307e8d0efa5ccf499aba3eb404` on `codex/syndocal-v1.2`.
Old/new/reason: alpha.24 remains immutable historical artifact evidence; alpha.25
is the distinct native UI checkpoint, so it did not overwrite alpha.24. The
...
No current `.sdc` references either clip, so Media Library import, Timeline
...
| SHOW-P0-6 | The distributed artifact exactly matches the accepted source | Current alpha.25 source/native evidence is `566a7101b0d5c9307e8d0efa5ccf499aba3eb404` on `codex/syndocal-v1.2`. Old/new/reason: alpha.24 remains immutable historical artifact evidence; alpha.25 is the distinct native UI checkpoint and does not overwrite it. Exact MSVC 14.44 was first; `pnpm --dir app tauri build --no-bundle` passed in `3m06s`, warnings `0`; Vite `297` modules, `App-CUUI4pgY.js` `498.21 kB`, `gdtfProfileActions-54y__lyr.js` `3.91 kB`. `target/release/syndocal.exe` is Product/FileVersion `1.2.0-alpha.25`, `59,807,744` bytes, SHA-256 `D42B0A1B245197A76E3D3B5CC45DEEB1C6C33EDE6261C7DA94C34147141239C1`, LastWrite `2026-08-28T06:20:27.6424691+09:00`; PID `83252`, handle `60826240`, title `Syndocal`, responsive. Computer Use at `1920x1032` found the restore button, proving maximized state; native I/O DMX full-width selector/workbench and Setup Lighting/Profile rendering are accepted. `qa/harnesses/run-syndocal-three-display-show-acceptance.ps1` is now the StandardRelease authority for that exact alpha.25 version, size, SHA-256, and source HEAD; PowerShell 7 and Windows PowerShell 5.1 self-tests both passed `88/88`, and syntax passed in both. No Apply or hardware acceptance was run. Historical alpha.24 source build `5eb1888906613851c4c49e66717a270f13bbd7b5`, with native evidence at descendant `e4c02f8e2c9013bdb735b2b785f6c75599c0a950`, produced `target/release/syndocal.exe`, 59,803,136 bytes, Product/FileVersion `1.2.0-alpha.24`, SHA-256 `8FF5CF6670F592DFFE53477E8E14BF95CD3FCF81916FC23CAD58E7354763874D`, and responsive exact-checkout PID `63016`. The alpha.21 `536742d` artifact and former branch HEAD `2d848d4` are historical only; they do not define current authority. Historical alpha.15/alpha.14 and local-only Show-ASIO identities remain preserved separately below. | Use the accepted alpha.25 StandardRelease runner only to continue with saved real show project/mapping and physical evidence; no Apply/hardware acceptance has yet been obtained. | CURRENT ALPHA.25 SOURCE/NATIVE AND RUNNER REBIND ACCEPTED / PHYSICAL ACCEPTANCE OPEN |

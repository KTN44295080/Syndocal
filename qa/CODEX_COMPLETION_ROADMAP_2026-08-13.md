...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "cargo test -p protocol --locked show_clock -- --nocapture", "expected_count": 3 },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Protocol admission, manual fence core, and current-source engine beat-position continuity are implemented; estimator/bounded-slew/Hold/STALE, network adapter, partition/rejoin, and two-machine venue proof remain." },
      "nonclaim": "This row does not claim network, automatic failover, physical output, or two-machine venue acceptance.",
      "decision_ids": ["DEC-SHOW-TRANSPORT-001", "DEC-SHOW-FENCE-001", "DEC-CLOCK-MASTER-001"],
      "risk_ids": ["R-SHOW-SPLIT-001"],
      "evidence_ids": ["EV-SHOWCLOCK-PROTOCOL-SW-2026-09-12", "EV-SHOWCLOCK-ENGINE-CONTINUITY-SW-2026-09-12"]
    },
    {

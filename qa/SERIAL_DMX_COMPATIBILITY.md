...
2. **Complete:** add USB VID/PID/product metadata and a non-destructive protocol recommendation to Scan Serial; manual override remains available. Product-matching tests and the four-reference-viewport contract cover the behavior, with 1920x1080 primary, 2048x1152 ceiling and 1366x768/1280x720 fallbacks.

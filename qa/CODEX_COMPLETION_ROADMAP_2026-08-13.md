...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "automated_proof": { "status": "not-passing", "command": "Planned: full integrated video gate rerun on current source with nonzero selected tests.", "expected_count": null },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },
    ...
    },
    {
      ...
      "automated_proof": { "status": "not-passing", "command": "Planned: focused FX/transition-bus checker with nonzero assertions on current source.", "expected_count": null },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },
    ...
    },
    {
      ...
      "automated_proof": { "status": "not-passing", "command": "Planned: authored-audio schema/clock deterministic suite; none authored for this row yet.", "expected_count": null },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },

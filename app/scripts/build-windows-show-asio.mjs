...
async function runSelfTest() {
  ...
  pass(validateVersionSet({ workspaceVersion: "1.2.0-alpha.22", lockVersion: "1.2.0-alpha.22", packageVersion: "1.2.0-alpha.22", tauriVersion: "1.2.0-alpha.22" }) === "1.2.0-alpha.22", "synchronized version set is accepted");
  rejects(() => validateVersionSet({ workspaceVersion: "1.2.0-alpha.22", lockVersion: "1.2.0-alpha.14", packageVersion: "1.2.0-alpha.22", tauriVersion: "1.2.0-alpha.22" }), /version drift/, "version drift is rejected");

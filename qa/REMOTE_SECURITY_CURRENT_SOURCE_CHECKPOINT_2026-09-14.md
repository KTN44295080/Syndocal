...
## Continuation — current-source Remote/Security recheck — 2026-09-15

At current source HEAD `34d6109f`, the Remote/Security source and release-test
set was rerun with MSVC 14.44.35207 Build Tools. The pinned linker was printed
and `where.exe link.exe` resolved to that exact linker first. All checks exited
`0`:

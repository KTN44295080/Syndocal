...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "hardware_external_proof": { "status": "recorded", "device_topology_duration": "Current Windows host physical MIDI slice: SMC-Mixer input/output enumerated and opened through production midir; one safe All Notes Off feedback message sent. OSC/Remote clients, controller movement, LED observation, clock/MTC, latency, and DMX remain pending.", "artifact_hash": null, "raw_evidence_paths": ["qa/M4_IO_VALIDATION.md"], "na_reason": null },
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Current physical MIDI enumerate/open/safe-feedback slice is recorded; generation re-audit, controller movement/LED/clock/MTC, latency, OSC/Remote, and DMX physical matrix remain." },
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-INPUT-SW-2026-09-12", "EV-INPUT-PHYSICAL-MIDI-2026-09-12", "EV-INPUT-DMX-TIMEOUT-SW-2026-09-12", "EV-INPUT-FRONTEND-AUTHORITY-SW-2026-09-12"]
    },
    {

...
- Focused synthetic and real-DVC tests pass, the complete DVC filter is 53/53, and the full locked all-target workspace is 1,180 passed / 13 existing hardware, GPU or long-duration ignores / zero failures. Production frontend build, localization 2990/2990, release metadata, DVC MIDI 39 assertions and DVC DMX 33 assertions pass.
- `pnpm --dir app tauri build --no-bundle` passed after the exact-checkout process guard reported zero running instances. The final 2026-08-09 19:43:15+09:00 release executable is 38,952,960 bytes, version 1.1.0, SHA-256 `C23E9B3FEFF3B2E8ACEB28B7D3CD3F12F275E107C522BB90F5A6CE7E21E05A4D`. It was intentionally not launched because another task owned the desktop surface; no current native-window verification is claimed.

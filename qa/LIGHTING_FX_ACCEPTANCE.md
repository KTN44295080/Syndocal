...
`check:viewport` starts its headless browser at 1920x1080 and runs 1920x1080, native 1920x1032, 2048x1152, 1366x768 and 1280x720 in that order. When `SYNDOCAL_VIEWPORT_SCREENSHOT_DIR` is set, the default evidence set captures both maximized gates; `SYNDOCAL_VIEWPORT_CAPTURE_ALL=1` is an explicit diagnostic override for compact/ceiling screenshots.

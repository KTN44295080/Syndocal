...
At the H4 Edit checkpoint it reports exactly 23 `Open`, 8 `Deferred`, and 27
`Complete` rows (58 total); the six section-9 distribution rows remain frozen/out of scope until
...
| `DEC-SHOW-TRANSPORT-001` | ShowClock transport/discovery/versioning | Accepted: manually paired authenticated unicast over wired two-PC LAN; discovery is only an untrusted hint |
| `DEC-SHOW-FENCE-001` | witness/shared lease/physical interlock/manual Hold | Accepted: Manual Hold plus explicit operator Re-arm; no automatic failover or reclaim |
| `DEC-CLOCK-MASTER-001` | ShowClock/audio/video/device master policy | Accepted: ShowClock master with bounded device slew; no backward step |
...
```json syndocal-q1-q4-ledger
{
  ...
  "expected_counts": {
    ...
    "flow_markers": { "Open": 23, "Deferred": 8, "Complete": 27 },
    "q1_rows": 32,
    "q2_decisions": 15,
    "q3_risks": 14,
    "q4_evidence": 156
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "evidence_ids": ["EV-MEDIA-T1-A7-2026-08-13", "EV-MEDIA-T1-A8-2026-08-13", "EV-MEDIA-T1-SW-2026-09-12", "EV-UI-H4-EDIT-SW-2026-09-13"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm.cmd --dir app run check:media-thumbnails && pnpm.cmd --dir app run check:media-asset-operations && pnpm.cmd --dir app run check:media-asset-authority && pnpm.cmd --dir app run check:native-thumbnail-request && pnpm.cmd --dir app run check:bundled-library && pnpm.cmd --dir app run check:vj-first-run && node app/scripts/check-vj-media-import-access.mjs && cargo test -p engine --release --locked -j 1 media_derived -- --nocapture --test-threads=1 && cargo test -p audio --release --locked -j 1 -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 prefetch -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 ffmpeg_cli_decoder_ -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 still_image_cache_ -- --nocapture --test-threads=1", "expected_count": 12 },
      "native_proof": { "status": "recorded", "artifact_hash": "144CD12F9B247575DE4E40FC966BEA703D74206B159C736AFA5A6FE66957C9E3", "raw_evidence_paths": ["qa/MEDIA_DERIVED_SOFTWARE_NATIVE_REVALIDATION_2026-09-12.md", "qa/THUMBNAIL_REAL_FILE_PROOF_2026-09-08.md", "qa/THUMBNAIL_CANCELLATION_LIFECYCLE_REVALIDATION_2026-09-09.md", "qa/THUMBNAIL_NATIVE_CANCELLATION_CURRENT_MAIN_2026-09-12.md"], "na_reason": null },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2", "disposition": "Current-source identity/cache/work-admission policy and deterministic thumbnail, audio-analysis, video-prefetch, and frame-cache evidence are accepted; complete proxy/transcode artifacts, general derived-data UI, MP4 missing-file recovery, hard-stop decoder/OS-I/O/GPU cancellation, cold/warm workload budgets, and physical/external media acceptance remain open." },
      "nonclaim": "This row does not claim a complete proxy/transcode artifact pipeline, general waveform/proxy/analysis product UI, MP4 missing-file recovery, hard-stop decoder/OS-I/O/GPU cancellation, cold/warm workload performance budgets, native renderer/GPU/display behavior, physical or audible devices, external clients/clocks, venue/soak, cross-platform execution, signing, publication, or product-wide media acceptance.",
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-NATIVE-THUMBNAIL-CANCEL-2026-09-12", "EV-MEDIA-DERIVED-SW-2026-09-13", "EV-UI-H4-EDIT-SW-2026-09-13"]
    },
    {
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-VIDEO-SLOT-SW-2026-09-12", "EV-VIDEO-C2-C4-SW-2026-09-13", "EV-UI-H4-EDIT-SW-2026-09-13"]
    },
    {
      "id": "COV-VIDEO-FX-001",
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-VIDEO-FX-SW-2026-09-12", "EV-UI-H4-EDIT-SW-2026-09-13"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "cargo test -p video --release --locked -j 1 live_source -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 external_video -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 \"external_video\" -- --nocapture --test-threads=1 && pnpm.cmd --dir app run check:camera-input && pnpm.cmd --dir app run check:video-output-window-runtime && pnpm.cmd --dir app run check:video-output-window-observation && node app/scripts/check-timeline-source-shelf-contract.mjs", "expected_count": 19 },
      "native_proof": { "status": "recorded", "artifact_hash": "3EF1495441806FA326F8FD1AD60E41FD4717CDDB5F2350A081D41BE0DF91FEBE", "raw_evidence_paths": ["qa/VIDEO_LIVE_SOURCES_CHECKPOINT_2026-09-13.md"], "na_reason": null },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Real camera/capture permission, NDI/Spout/Syphon peer interoperability, reconnect timing, GPU interop, standalone generator input, one-hour matrices, and physical/venue acceptance remain external or separate gates." },
      "nonclaim": "This row closes only the current-source live-input identity/state/fault/retirement software slice; it does not claim real devices, peer interoperability, generator input, one-hour operation, recording integration, signing, publication, or product-wide acceptance.",
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-VIDEO-SOURCE-SW-2026-09-12", "EV-VIDEO-SOURCE-LIVE-2026-09-13"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm.cmd --dir app run check:timeline-cue-audio && pnpm.cmd --dir app run check:timeline-audio-output-bus && pnpm.cmd --dir app run check:timeline-loop-runtime && pnpm.cmd --dir app run check:timeline-transport-runtime && cargo test -p protocol --release --locked -j 1 timeline_audio_policy -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 timeline_audio -- --nocapture --test-threads=1 && cargo test -p engine --release --locked -j 1 timeline_fractional_ticks -- --nocapture --test-threads=1", "expected_count": 7 },
      "native_proof": { "status": "recorded", "artifact_hash": "0A10CFDFC49C543F3B9AD0792BA9BE3D52A32F3CF7C6F8EA30D1E8515D51AED5", "raw_evidence_paths": ["qa/AUDIO_AUTHORED_CHECKPOINT_2026-09-13.md"], "na_reason": null },
      "hardware_external_proof": { "status": "not-run", "device_topology_duration": "Real audio devices and long-duration clocks.", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "Not run: no external device acceptance was executed in this checkpoint." },
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Real audio-device/ASIO driver behavior, long-duration clock drift, physical audible output, recording ownership integration, and venue acceptance remain external or separate gates." },
      "nonclaim": "This row closes only the current-source authored Timeline audio software slice; it does not claim real audio-device behavior, physical audible output, long-duration/venue, recording integration, signing, publication, or product-wide acceptance.",
      "decision_ids": ["DEC-CLOCK-MASTER-001"],
      "risk_ids": ["R-AUDIO-OWN-001"],
      "evidence_ids": ["EV-AUDIO-AUTHORED-SW-2026-09-12", "EV-AUDIO-AUTHORED-SW-2026-09-13"]
    },
    {
      ...
      "risk_ids": ["R-AUDIO-OWN-001"],
      "evidence_ids": ["EV-AUDIO-LIVE-SW-2026-09-12", "EV-ASIO-LICENSE-CURRENT-SW-2026-09-14", "EV-ASIO-FORMAT-CURRENT-SW-2026-09-14", "EV-ASIO-FAULT-CURRENT-SW-2026-09-14", "EV-ASIO-SOAK-CURRENT-SW-2026-09-14", "EV-ASIO-LATENCY-CURRENT-SW-2026-09-14", "EV-ASIO-PERSISTENCE-CURRENT-SW-2026-09-14", "EV-ASIO-LICENSE-CURRENT-SW-2026-09-15", "EV-ASIO-FORMAT-CURRENT-SW-2026-09-15", "EV-ASIO-FAULT-CURRENT-SW-2026-09-15", "EV-ASIO-SOAK-CURRENT-SW-2026-09-15", "EV-ASIO-LATENCY-CURRENT-SW-2026-09-15", "EV-ASIO-PERSISTENCE-CURRENT-SW-2026-09-15"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 recording_ -- --nocapture --test-threads=1", "expected_count": 1 },
      "native_proof": { "status": "recorded", "artifact_hash": "BEF911C6D3BF83362504AC466B01459314A02F04D5073E3C158302BBE2CD4A21", "raw_evidence_paths": ["qa/RECORDING_CHECKPOINT_2026-09-13.md"], "na_reason": null },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Current-source lifecycle, status UI, publication/recovery, worker ownership, and Windows process smoke are recorded; real H.264/AAC codec acceptance, disk-full/power-loss boundary, authoritative asset import, terminal/two-PC ownership, encoder hardware, and the recording owner decision remain." },
      "nonclaim": "This row closes only the current-source recording lifecycle/status UI, publication/recovery, and worker-ownership software slice; it does not claim real H.264/AAC codec acceptance, disk-full/power-loss proof, two-PC ownership, authoritative asset import, native in-app recording interaction beyond process smoke, or DEC-RECORD-OWN-001 closure.",
      "decision_ids": ["DEC-RECORD-OWN-001"],
      "risk_ids": ["R-AUDIO-OWN-001"],
      "evidence_ids": ["EV-RECORDING-SW-2026-09-12", "EV-RECORDING-SW-2026-09-13", "EV-RECORDING-REAL-CODEC-LONG-2026-09-15"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:patch-transaction-d2 && pnpm --dir app run check:fixture-catalog && pnpm --dir app run check:patch-profile-counts && pnpm --dir app run check:profile-library && pnpm --dir app run check:gdtf-profile-actions && pnpm --dir app run check:fixture-live-color && pnpm --dir app run check:fixture-limits-degrees && pnpm --dir app run check:dmx-addressing && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 d2_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 patch_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 gdtf_ -- --nocapture --test-threads=1 && cargo test -p engine --release --locked -j 1 fixture_patch_ -- --nocapture --test-threads=1 && cargo test -p engine --release --locked -j 1 fixture_profile_repair_ -- --nocapture --test-threads=1 && cargo test -p gdtf --release --locked -j 1 -- --nocapture --test-threads=1", "expected_count": 14 },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Current software regressions cover cache/profile parsing, transaction rejection, allocator rollback, and repair publication failure restoration; broader D-lane audit, real repaired-profile output, and R-PATCH-ATOMIC-001 remain open." },
      ...
      "evidence_ids": ["EV-PATCH-GDTF-SW-2026-09-12", "EV-UI-H3-SETUP-SW-2026-09-13"]
    },
    {
      "id": "COV-STAGE-001",
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:stage-labels && pnpm --dir app run check:mapping-stage-geometry && node app/scripts/check-patch-transaction-d2.mjs && node app/scripts/check-project-transaction-mutation-controller.mjs && cargo test -p engine --release --locked -j 1 fixture_transform_batch -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 fixture_transform -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 stage_fixture_transform_batch -- --test-threads=1", "expected_count": 7 },
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-ALPHA11-D4-2026-08-25", "EV-STAGE-PROJECT-SW-2026-09-12", "EV-UI-H4-EDIT-SW-2026-09-13"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:project-transaction && pnpm --dir app run check:project-recovery-e3 && pnpm --dir app run check:project-publication-e4 && node app/scripts/check-project-history-preflight.mjs", "expected_count": 4 },
      "native_proof": { "status": "recorded", "artifact_hash": "1B010C40242A5C7DD7A2797EAC1ECA2D31BCACE4455BA57C7F935611075B582B", "raw_evidence_paths": ["qa/SYNDOCAL_ALPHA11_MAIN_INTEGRATION_CHECKPOINT_2026-08-25.md"], "na_reason": null },
    ...
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:project-transaction && node app/scripts/check-project-transaction-mutation-controller.mjs", "expected_count": 2 },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },
    ...
    },
    {
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-RECOVERY-SAVE-SW-2026-09-12"]
    },
    {
      "id": "COV-INPUT-001",
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:dvc-midi-shortcuts && node app/scripts/check-dvc-dmx-shortcuts.mjs && node app/scripts/check-dmx-show-setup.mjs && node app/scripts/check-dmx-addressing-helpers.mjs && pnpm --dir app run check:frontend-command-routing && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 midi_feedback_route_uses_the_narrow_engine_reader -- --test-threads=1", "expected_count": 6 },
      ...
      "hardware_external_proof": { "status": "recorded", "device_topology_duration": "Current Windows host physical MIDI slice: SMC-Mixer input/output enumerated and opened through production midir; one safe All Notes Off feedback message sent. A separate direct WinMM/Python ctypes point-light check visibly confirmed channel-1 LED on/off across three cycles. OSC/Remote clients, controller movement, MIDI Clock/MTC, latency, and DMX remain pending.", "artifact_hash": null, "raw_evidence_paths": ["qa/M4_IO_VALIDATION.md"], "na_reason": null },
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Current physical MIDI enumerate/open/safe-feedback and direct connected-unit LED point-light slices are recorded; generation re-audit, controller movement, MIDI Clock/MTC, latency, OSC/Remote, and DMX physical matrix remain." },
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-INPUT-SW-2026-09-12", "EV-INPUT-PHYSICAL-MIDI-2026-09-12", "EV-INPUT-PHYSICAL-MIDI-LED-2026-09-12", "EV-INPUT-DMX-TIMEOUT-SW-2026-09-12", "EV-INPUT-FRONTEND-AUTHORITY-SW-2026-09-12", "EV-INPUT-PHYSICAL-CURRENT-SW-2026-09-14", "EV-INPUT-PHYSICAL-MIDI-CURRENT-2026-09-14", "EV-INPUT-PHYSICAL-CURRENT-SW-2026-09-15", "EV-INPUT-PHYSICAL-MIDI-CURRENT-2026-09-15", "EV-INPUT-PHYSICAL-MIDI-INPUT-2026-09-15", "EV-AI3-INPUT-PRODUCTION-RECHECK-2026-09-18", "EV-AI3-NATIVE-INGRESS-ALIAS-CAPTURE-2026-09-21", "EV-AI3-NATIVE-INGRESS-UI-SELECTION-2026-09-21", "EV-AI3-NATIVE-INGRESS-POST-RELAUNCH-ENUM-2026-09-21", "EV-AI3-NATIVE-INGRESS-ENDPOINT-INVENTORY-2026-09-22", "EV-AI3-NATIVE-INGRESS-OPERATOR-CAPTURE-2026-09-22"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:output-ownership && pnpm --dir app run check:output-control-runtime && pnpm --dir app run check:safety-blackout-runtime && pnpm --dir app run check:video-output-routing-runtime && pnpm --dir app run check:video-output-window-runtime && pnpm --dir app run check:video-output-window-observation && cargo test -p engine --release --locked -j 1 output_ownership -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 output_ownership -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 show_spout_managed_terminal -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_retirement_spout -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_retirement_callback_failure -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 show_spout_disabled_activation -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 managed_display_window_projection -- --test-threads=1", "expected_count": 13 },
      ...
      "hardware_external_proof": { "status": "recorded", "device_topology_duration": "Current Windows host FTDI USB serial-DMX slice: COM5 (VID 0403/PID 6001), existing 121-channel Enttec Open DMX worker ran 10.02 seconds at master 20 with 439 successful sends and zero send failures; operator confirmed the connected fixture output was successful. Long-run/waveform, Art-Net/sACN, NDI/Spout/display, and ownership matrix remain pending.", "artifact_hash": null, "raw_evidence_paths": ["qa/M4_IO_VALIDATION.md"], "na_reason": null },
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Current serial-DMX port/worker and operator-confirmed fixture slice are recorded; long-run timing/waveform, Art-Net/sACN, NDI/Spout/display, replacement fence risk R-OUTPUT-SWAP-001, and all other physical matrices remain open." },
      ...
      "evidence_ids": ["EV-OUTPUT-LOCAL-SW-2026-09-12", "EV-OUTPUT-PHYSICAL-DMX-2026-09-12", "EV-OUTPUT-PHYSICAL-DMX-2026-09-15", "EV-OUTPUT-PHYSICAL-DMX-2026-09-18", "EV-UI-H5-OUTPUT-CONTROL-SW-2026-09-14", "EV-UI-H5-VIDEO-MASTER-SW-2026-09-14", "EV-UI-H5-VIDEO-TAKE-SW-2026-09-14", "EV-UI-H5-VIDEO-LAUNCH-SW-2026-09-14", "EV-UI-H5-BOTH-SW-2026-09-14", "EV-UI-H5-BOTH-BROWSER-RERUN-2026-09-14", "EV-DMX-ARTNET-CURRENT-SW-2026-09-14", "EV-DMX-USB-RDM-CURRENT-SW-2026-09-14", "EV-VIDEO-PHYSICAL-CURRENT-SW-2026-09-14", "EV-VIDEO-CAMERA-CURRENT-PHYSICAL-2026-09-14", "EV-VIDEO-CAMERA-CURRENT-PHYSICAL-2026-09-15", "EV-UI-NATIVE-PANE-DPI-CURRENT-2026-09-14", "EV-UI-H5-NATIVE-SURFACE-CURRENT-2026-09-14", "EV-DMX-ARTNET-CURRENT-SW-2026-09-15", "EV-DMX-USB-RDM-CURRENT-SW-2026-09-15", "EV-VIDEO-SCREEN-CAPTURE-CURRENT-2026-09-15", "EV-OUTPUT-COM5-PREPARE-UI-CURRENT-2026-09-15", "EV-OUTPUT-PHYSICAL-DMX-30S-2026-09-18"]
    },
    {
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-REMOTE-TOUCH-SW-2026-09-12", "EV-DJ-LINK-SETUP-SW-2026-09-13", "EV-DJ-LINK-CURRENT-SW-2026-09-14", "EV-DJ-LINK-CURRENT-SW-2026-09-15"]
    },
    {
      "id": "COV-RDM-001",
    ...
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p io --locked show_clock_lan -- --nocapture --test-threads=1", "expected_count": 23 },
      "native_proof": { "status": "recorded", "artifact_hash": "BEF911C6D3BF83362504AC466B01459314A02F04D5073E3C158302BBE2CD4A21", "raw_evidence_paths": ["qa/SHOWCLOCK_IMPLEMENTATION_CHECKPOINT_2026-09-13.md"], "na_reason": null },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Current-source protocol, estimator, scheduler, output gate, exact-peer loopback, Tauri IPC/UI, and two-process software are recorded; native UI interaction, physical output, restart replay restoration, partition/rejoin, witness/interlock, automatic failover, and two-machine venue proof remain." },
      "nonclaim": "This row closes only the current-source ShowClock implementation and loopback software slice. It does not claim native UI interaction acceptance, physical output, automatic failover, restart replay restoration, real partition/rejoin, witness/interlock, or two-machine venue acceptance.",
      "decision_ids": ["DEC-SHOW-TRANSPORT-001", "DEC-SHOW-FENCE-001", "DEC-CLOCK-MASTER-001", "DEC-SHOW-AUTH-001", "DEC-SHOW-VERSION-001", "DEC-SHOW-NETWORK-001"],
      "risk_ids": ["R-SHOW-SPLIT-001"],
      "evidence_ids": ["EV-SHOWCLOCK-PROTOCOL-SW-2026-09-12", "EV-SHOWCLOCK-ENGINE-CONTINUITY-SW-2026-09-12", "EV-SHOWCLOCK-RUNTIME-LAN-SW-2026-09-12", "EV-SHOWCLOCK-IPC-UI-2PROC-SW-2026-09-12", "EV-SHOWCLOCK-IMPLEMENTATION-SW-2026-09-13", "EV-SHOWCLOCK-VENUE-CURRENT-SW-2026-09-15"]
    },
    {
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2", "disposition": "Follow and persistence current-source software/runtime/UI and rendered-browser proof are accepted; native synchronization, audible/external clocks, and physical/venue boundaries remain." },
      "nonclaim": "This row does not claim audible-device acceptance, native A/V/Lighting synchronization, external-clock behavior, physical output, or that pre-rendered WAV evidence replaces the runtime scheduler requirement.",
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-TIMELINE-MUSICAL-SW-2026-09-12", "EV-TIMELINE-FOLLOW-SW-2026-09-13", "EV-TIMELINE-PERSISTENCE-SW-2026-09-13", "EV-UI-H4-EDIT-SW-2026-09-13"]
    },
    {
      "id": "COV-UI-SHELL-001",
      ...
      "automated_proof": { "status": "passing", "command": "pnpm.cmd --dir app run check:frontend-command-routing && pnpm.cmd --dir app run check:frontend-invokes && pnpm.cmd --dir app run check:desktop-window && pnpm.cmd --dir app run check:localization && pnpm.cmd --dir app run check:terminology && pnpm.cmd --dir app run check:tauri-build-wrapper && pnpm.cmd --dir app run check:empty-states && pnpm.cmd --dir app run check:project-shortcuts && pnpm.cmd --dir app run check:workspace-operator && pnpm.cmd --dir app run check:workspace-operator-viewport && node app/scripts/check-pane-window-lifecycle.mjs && node app/scripts/check-project-history-keyboard.mjs && node app/scripts/check-timeline-space-keyboard.mjs && pnpm.cmd --dir app run check:stage-labels", "expected_count": 14 },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2", "disposition": "H1 reachability and H2 current-source shared-shell/browser/native-process evidence are accepted; H3-H5 workflow completion, native accessibility/interaction, and physical boundaries remain." },
      "nonclaim": "This row does not claim H3-H5 shared-workspace completeness, native accessibility/interaction, or physical acceptance.",
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-UI-SHELL-SW-2026-09-12", "EV-UI-H1-REACHABILITY-SW-2026-09-13", "EV-UI-H2-SHELL-SW-2026-09-13", "EV-UI-H3-SETUP-SW-2026-09-13", "EV-UI-H4-EDIT-SW-2026-09-13", "EV-UI-H5-OUTPUT-CONTROL-SW-2026-09-14", "EV-UI-H5-VIDEO-MASTER-SW-2026-09-14", "EV-UI-H5-VIDEO-TAKE-SW-2026-09-14", "EV-UI-H5-VIDEO-LAUNCH-SW-2026-09-14", "EV-UI-H5-BOTH-SW-2026-09-14", "EV-UI-H5-BOTH-BROWSER-RERUN-2026-09-14", "EV-UI-H5-VIDEO-HIDPI-2026-09-15", "EV-UI-NATIVE-PANE-DPI-CURRENT-2026-09-14", "EV-UI-H5-NATIVE-SURFACE-CURRENT-2026-09-14", "EV-UI-H5-THREE-DISPLAY-PREFLIGHT-2026-09-15", "EV-UI-H5-NATIVE-VISUAL-CURRENT-2026-09-15", "EV-UI-H5-BROWSER-RERUN-CURRENT-2026-09-15", "EV-UI-H5-THREE-DISPLAY-TOPOLOGY-2026-09-15", "EV-UI-H5-VIDEO-REPAIR-CURRENT-2026-09-15", "EV-UI-H5-ALL-SCREEN-REVIEW-CURRENT-2026-09-15", "EV-UI-H5-ALL-SCREEN-RECHECK-CURRENT-2026-09-18", "EV-UI-H5-SHORT-OPERATOR-REPAIR-CURRENT-2026-09-18", "EV-UI-H5-DISPLAYCONFIG-RECHECK-CURRENT-2026-09-18", "EV-UI-H5-NATIVE-PRINTWINDOW-CURRENT-2026-09-18", "EV-UI-CAPTURE-HELPER-PRINTWINDOW-CURRENT-2026-09-18", "EV-UI-H5-VJ-CONTEXT-REFLOW-CURRENT-2026-09-21", "EV-UI-H5-EDIT-CONTEXT-REFLOW-CURRENT-2026-09-21"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm.cmd --dir app run check:localization && pnpm.cmd --dir app run check:terminology && pnpm.cmd --dir app run check:empty-states && node app/scripts/check-project-history-keyboard.mjs && node app/scripts/check-timeline-space-keyboard.mjs && pnpm.cmd --dir app run check:stage-labels", "expected_count": 6 },
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-ACCESSIBILITY-SW-2026-09-12", "EV-ACCESSIBILITY-CURRENT-SW-2026-09-14", "EV-ACCESSIBILITY-CURRENT-SW-2026-09-15", "EV-ACCESSIBILITY-NATIVE-UIA-CURRENT-2026-09-15", "EV-ACCESSIBILITY-CURRENT-SW-2026-09-18", "EV-ACCESSIBILITY-NATIVE-HC-200-CURRENT-2026-09-18"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:project-storage && pnpm --dir app run check:project-transaction && pnpm --dir app run check:project-recovery-e3 && pnpm --dir app run check:project-publication-e4 && pnpm --dir app run check:project-open-bootstrap && node app/scripts/check-project-history-preflight.mjs && node app/scripts/check-project-history-keyboard.mjs && node app/scripts/check-project-transaction-recovery-controller.mjs && pnpm --dir app run check:strict-json && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_file_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_recovery_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_publication_ -- --nocapture --test-threads=1", "expected_count": 12 },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "No current-source native acceptance run is recorded for this row in the owned evidence manifest." },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2 release-blocking", "disposition": "Current Windows project/version/recovery/publication regressions pass; golden corpus and hostile-input fuzz matrix, cross-platform file identity decision, and real upgrade/downgrade rehearsals remain." },
      ...
      "evidence_ids": ["EV-MIGRATION-SW-2026-09-12", "EV-MIGRATION-CORPUS-SW-2026-09-14", "EV-MIGRATION-CORPUS-RERUN-2026-09-14", "EV-MIGRATION-CORPUS-CURRENT-SW-2026-09-15", "EV-MIGRATION-CORPUS-CURRENT-SW-2026-09-18"]
    },
    {
      "id": "COV-SECURITY-001",
      ...
      "automated_proof": { "status": "passing", "command": "pnpm.cmd --dir app run check:agent-bridge && node app/scripts/check-agent-bridge-bootstrap.mjs && node app/scripts/check-tauri-admission-inventory.mjs && pnpm.cmd --dir app run check:strict-json && cargo test -p protocol --release --locked agent_authority -- --test-threads=1 && cargo test -p protocol --release --locked control_plane -- --test-threads=1", "expected_count": 6 },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2 release-blocking", "disposition": "Current authority, admission, wire, and strict-parser software checks pass; unified threat model, adversarial LAN/Remote, update/archive/path fuzz, public-network, and complete AI bypass-absence proof remain." },
      "nonclaim": "This row does not claim public-network safety, update-signature/replay acceptance, adversarial client acceptance, parser fuzz completion, or product-wide absence-of-bypass proof.",
      "decision_ids": ["DEC-AI-CONSENT-001"],
      "risk_ids": ["R-SECURITY-001", "R-AI-BYPASS-001", "R-AI-SAFETY-001"],
      "evidence_ids": ["EV-SECURITY-SW-2026-09-12", "EV-REMOTE-SECURITY-CURRENT-SW-2026-09-14", "EV-REMOTE-SECURITY-CURRENT-SW-2026-09-15", "EV-REMOTE-SECURITY-CURRENT-SW-2026-09-18", "EV-REMOTE-PAIRING-DUPLICATE-2026-09-15", "EV-REMOTE-AUTHORITY-DUPLICATE-2026-09-15"]
    },
    {
      ...
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-PERFORMANCE-STATIC-2026-09-12", "EV-PERFORMANCE-SNAPSHOT-2026-09-12", "EV-VENUE-SOAK-CURRENT-SW-2026-09-14", "EV-VENUE-SOAK-MIXED-CURRENT-SW-2026-09-14", "EV-VENUE-SOAK-MIXED-ISOLATED-CURRENT-SW-2026-09-15"]
    },
    {
      ...
      "automated_proof": { "status": "passing", "command": "pnpm --dir app run check:status && pnpm --dir app run check:release:self-test && pnpm --dir app run check:bundled-library && node app/scripts/check-windows-release-artifacts.mjs --self-test && pnpm --dir app run check:strict-json && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 diagnostic_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 updater_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement_is_redacted -- --nocapture --test-threads=1", "expected_count": 8 },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2", "disposition": "Current status, redaction, updater identity, and artifact negative suites pass; deployed support runbook drills, live signed update failure matrix, clean-machine proof, and publication acceptance remain." },
      "nonclaim": "This row does not claim diagnostics or updater resilience acceptance.",
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-OBSERVABILITY-SOFTWARE-2026-09-12", "EV-OBSERVABILITY-DIAGNOSTIC-SW-2026-09-13", "EV-OBSERVABILITY-CURRENT-SW-2026-09-14", "EV-OBSERVABILITY-CURRENT-SW-2026-09-15", "EV-OBSERVABILITY-CURRENT-SW-2026-09-18"]
    },
    {
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Current AI0-AI5 and selected AI7 software seams pass bounded checks; AI6 administration UI, AI7 complete adversarial parity/fuzz/saturation, and AI8 native/external acceptance remain." },
      "nonclaim": "This row does not claim AI0-AI8 acceptance, complete generated schema parity, external R4/R5 enablement, admin UI completion, real-client/restart/hardware acceptance, or that existing seams satisfy the full roadmap section 7 evidence rules.",
      "decision_ids": ["DEC-AI-ARCH-001", "DEC-AI-CONSENT-001"],
      "risk_ids": ["R-AI-BYPASS-001", "R-AI-SAFETY-001"],
      "evidence_ids": ["EV-AI-CONTROL-SW-2026-09-12", "EV-AI3-NATIVE-INGRESS-CURRENT-SW-2026-09-14", "EV-AI3-NATIVE-INGRESS-CURRENT-SW-2026-09-15", "EV-AI3-NATIVE-INGRESS-OPERATOR-CAPTURE-2026-09-15", "EV-AI3-NATIVE-INGRESS-BRIDGE-PREFLIGHT-2026-09-18", "EV-AI3-NATIVE-INGRESS-CAPTURE-2026-09-18", "EV-AI3-NATIVE-INGRESS-CANDIDATE-SCAN-2026-09-18", "EV-AI3-NATIVE-INGRESS-CONNECTED-CAPTURE-2026-09-18", "EV-AI3-NATIVE-INGRESS-OPERATOR-WINDOW-2026-09-18", "EV-AI3-NATIVE-INGRESS-OPERATOR-WINDOW-120S-2026-09-18", "EV-INPUT-PHYSICAL-MIDI-CURRENT-2026-09-14", "EV-INPUT-PHYSICAL-MIDI-CURRENT-2026-09-15", "EV-AI3-PHYSICAL-REARM-CURRENT-SW-2026-09-14", "EV-AI3-PHYSICAL-REARM-CURRENT-SW-2026-09-15", "EV-AI3-PHYSICAL-REARM-CURRENT-SW-2026-09-18", "EV-AI3-DURABLE-ACCEPTANCE-CURRENT-SW-2026-09-14", "EV-AI3-DURABLE-ACCEPTANCE-CURRENT-SW-2026-09-15", "EV-AI3-DURABLE-ACCEPTANCE-CURRENT-SW-2026-09-18", "EV-AI8-EXTERNAL-CURRENT-SW-2026-09-14", "EV-AI8-EXTERNAL-CURRENT-SW-2026-09-15", "EV-AI8-EXTERNAL-CURRENT-SW-2026-09-18", "EV-AI8-EXTERNAL-NATIVE-PROBE-2026-09-18", "EV-AI3-INPUT-PRODUCTION-RECHECK-2026-09-18", "EV-AI3-NATIVE-INGRESS-CURRENT-SW-2026-09-21", "EV-AI3-NATIVE-INGRESS-OPERATOR-CAPTURE-2026-09-21", "EV-AI3-NATIVE-INGRESS-ALIAS-CAPTURE-2026-09-21", "EV-AI3-NATIVE-INGRESS-UI-SELECTION-2026-09-21", "EV-AI3-NATIVE-INGRESS-POST-RELAUNCH-ENUM-2026-09-21", "EV-AI3-NATIVE-INGRESS-ENDPOINT-INVENTORY-2026-09-22", "EV-AI3-NATIVE-INGRESS-OPERATOR-CAPTURE-2026-09-22"]
    },
    {
      "id": "COV-RELEASE-001",
      ...
      "automated_proof": { "status": "passing", "command": "pnpm.cmd --dir app run check:release && pnpm.cmd --dir app run check:release:self-test && pnpm.cmd --dir app run check:warnings -- --configuration windows-native-release && pnpm.cmd --dir app run check:warnings:self-test && node app/scripts/check-windows-release-artifacts.mjs --self-test && pnpm.cmd --dir app run check:tauri-build-wrapper", "expected_count": 6 },
      "native_proof": { "status": "not-run", "artifact_hash": null, "raw_evidence_paths": [], "na_reason": "The current EXE is an unbundled development artifact; no signed release candidate or release-native acceptance run exists." },
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P0-Release", "disposition": "Software metadata/artifact/warning gates pass; signed candidate, hardware, legal, clean-machine, updater, and publication P0-Release risks block public release." },
      "nonclaim": "This row does not claim beta/RC/release readiness, signed or notarized artifacts, clean-machine/updater acceptance, physical acceptance, or publication.",
      "decision_ids": ["DEC-P2-001"],
      "risk_ids": ["R-RELEASE-HW-001", "R-RELEASE-LEGAL-001"],
      "evidence_ids": ["EV-RELEASE-SOFTWARE-2026-09-12"]
    },
    {
    ...
    },
    {
      ...
      "risk_ids": [],
      "evidence_ids": ["EV-COMPARE-PINNED-CURRENT-SW-2026-09-14"]
    },
    {
  ...
  "q2_decisions": [
    ...
    { "id": "DEC-SHOW-TRANSPORT-001", "decision": "ShowClock uses a manually paired, authenticated unicast transport over the wired two-PC LAN. Discovery is only an untrusted endpoint hint; session identity, protocol version, sequence, nonce, HMAC, and clock/fence generations are authoritative, and downgrade or replay is rejected.", "state": "Accepted", "date": "2026-09-12", "approver": "Operator/product owner via current task ShowClock architecture freeze", "alternatives": ["Auth UDP multicast discovery", "TCP brokered pairing", "Hybrid with slew tiers"], "consequences": "The first implementation may be transport-neutral and loopback-tested; the later LAN adapter must preserve the same authenticated admission boundary. No Wi-Fi, public discovery, or broker availability claim is implied.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
    { "id": "DEC-SHOW-FENCE-001", "decision": "ShowClock uses Manual Hold plus explicit operator Re-arm. Loss, crash, stale peer, and rejoin never arm or reclaim output automatically; the standby remains disarmed until the operator confirms the primary is stopped and advances the fencing generation.", "state": "Accepted", "date": "2026-09-12", "approver": "Operator/product owner via current task ShowClock architecture freeze", "alternatives": ["Strongly consistent witness service", "Physical interlock line", "Manual Hold-only policy"], "consequences": "Automatic failover and split-brain prevention by witness/interlock are not claimed. A future witness or physical interlock requires a separate decision and acceptance tranche.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
    { "id": "DEC-CLOCK-MASTER-001", "decision": "ShowClock is the authoritative show-time master. Audio, video, lighting, and device domains follow it through bounded slew; they do not independently arbitrate show time. Corrections never step time backward and invalid/stale sources fail toward Hold.", "state": "Accepted", "date": "2026-09-12", "approver": "Operator/product owner via current task ShowClock architecture freeze", "alternatives": ["Audio PTS master", "ShowClock master with device slew", "Per-domain masters with declared arbitration"], "consequences": "Authored audio, recording, and Timeline scheduling integrate against the canonical ShowClock domain; device-specific latency and resampling policy remain separate implementation gates.", "linked_q1_ids": ["COV-AUDIO-AUTHORED-001", "COV-SHOWCLOCK-001"] },
    { "id": "DEC-SHOW-AUTH-001", "decision": "ShowClock authentication is a paired-session boundary: a 32-byte HMAC key is bound to session/node identity, sequence, nonce, and clock/fence generations. Session and key state lasts only for the process incarnation; restart or explicit re-pair requires a fresh session/key, with no silent reuse or online automatic rotation.", "state": "Accepted", "date": "2026-09-13", "approver": "Operator/product owner via current task ShowClock decision freeze", "alternatives": ["Persisted long-lived shared key with replay restoration", "Online automatic key rotation", "Fresh paired session at each process incarnation"], "consequences": "Authentication and generation failures are rejected before estimator, queue, or output mutation; restart recovery requires explicit re-pair and replay state is not restored.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
    { "id": "DEC-SHOW-VERSION-001", "decision": "ShowClock accepts schema and protocol version 1 only. Mixed-version rolling operation is unsupported; future or downgraded versions require an explicit implementation and separate acceptance decision.", "state": "Accepted", "date": "2026-09-13", "approver": "Operator/product owner via current task ShowClock decision freeze", "alternatives": ["Best-effort backward compatibility", "Negotiated rolling upgrade", "Strict version refusal"], "consequences": "Unsupported schema/protocol envelopes fail closed before payload processing, so no compatibility or rolling-upgrade claim is made for unaccepted versions.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
    { "id": "DEC-SHOW-NETWORK-001", "decision": "The supported ShowClock topology is a manually paired wired two-PC LAN with an exact peer and unicast UDP port 44,666. Discovery is only an untrusted endpoint hint; Wi-Fi, multicast, public discovery, broker availability, and public-LAN operation are outside the supported acceptance boundary.", "state": "Accepted", "date": "2026-09-13", "approver": "Operator/product owner via current task ShowClock decision freeze", "alternatives": ["Wi-Fi and multicast as supported transports", "Broker-mediated public discovery", "Exact-peer wired unicast"], "consequences": "The current implementation remains transport-neutral/loopback-tested and must preserve exact-peer authenticated admission when the supported LAN adapter is exercised; network and venue acceptance remain separate gates.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
  ...
  "q4_evidence": [
    { "id": "EV-UI-H5-EDIT-CONTEXT-REFLOW-CURRENT-2026-09-21", "scope": "Current-source Edit Video Outputs/Layers context reflow, viewport regressions, and exact-release native visual confirmation", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-21", "command": "pnpm.cmd --dir app run check:edit-ia-video (1920x1080, 1920x1032, 2048x1152, 1366x768, 1280x720); pnpm.cmd --dir app run check:fullscreen-vj (1920x1080, 1366x768, 1280x720); pnpm.cmd --dir app run check:topbar-pulse; pnpm.cmd --dir app run check:video-setup-viewport; pnpm.cmd --dir app run check:patch-viewport; pnpm.cmd --dir app run build; pnpm.cmd --dir app tauri build --no-bundle; exact release process/responding/maximized-window check and native PrintWindow capture", "exit_code": 0, "assertion_count": 9, "ignored_count": 0, "warning_count": 1, "artifact_hash": "A2D1D09ACBDBDA2444F53FBE19A8AAA57C1817CBF1D7559ED0FB0C005041F8F6", "artifact_na_reason": "The native screenshot is stored under the user temp directory and is not a shipped artifact; the exact binary identity, viewport results, visual finding, and H5 nonclaims are recorded in the linked checkpoint.", "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "app/src/styles.css", "qa/harnesses/capture-window.ps1"], "currency_nonclaim": "This current-source layout and exact-release window observation does not establish H5 acceptance; it does not establish native action workflows, accessibility, recording, physical output, external clients, failure/recovery, venue acceptance, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-AI3-NATIVE-INGRESS-POST-RELAUNCH-ENUM-2026-09-21", "scope": "Post-relaunch production WinMM/midir SMC-Mixer input/output inventory using deliberately nonmatching selectors to stop before endpoint open/send", "kind": "current-source-automated", "status": "open", "date": "2026-09-21", "command": "MSVC 14.44.35207 x64; SYNDOCAL_TEST_MIDI_INPUT=__CODEX_ENUM_ONLY_NO_MATCH_INPUT__; SYNDOCAL_TEST_MIDI_OUTPUT=__CODEX_ENUM_ONLY_NO_MATCH_OUTPUT__; cargo test -p io --release --locked -j 1 physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture --test-threads=1", "exit_code": 1, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The diagnostic stopped after printing current production endpoint inventory; it opens no endpoint, sends no bytes, and produces no shipped artifact.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "crates/io/src/midi.rs"], "currency_nonclaim": "This does not establish current-source AI3 ingress acceptance; the no-match diagnostic only confirms port names after relaunch and does not establish a connected Bluetooth bridge, app-selected input, operator MIDI event, mapping/lease routing, feedback, Clock/MTC, or physical acceptance.", "linked_q1_ids": ["COV-AI-CONTROL-001", "COV-INPUT-001"] },
    { "id": "EV-UI-H5-VJ-CONTEXT-REFLOW-CURRENT-2026-09-21", "scope": "Current-source Fullscreen VJ context reflow: stack Outputs above Layers at normal height while preserving side-by-side compact layouts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-21", "command": "CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:fullscreen-vj (1920x1080, 1366x768, 1280x720)", "exit_code": 0, "assertion_count": 3, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The rendered-browser gate emits local screenshots rather than a shipped artifact; current-source measurements, native window smoke, and screenshot/build hashes are recorded in the linked UI checkpoint.", "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "app/src/styles.css"], "currency_nonclaim": "This current-source viewport/layout evidence does not establish current-source H5 acceptance; it does not establish native button-by-button interaction, accessibility, physical output, external clients, recovery, venue acceptance, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-AI3-INPUT-PRODUCTION-RECHECK-2026-09-18", "scope": "Current-host SMC-Mixer production WinMM/midir endpoint enumeration/open and supervised operator-ingress capture recheck", "kind": "current-source-automated", "status": "open", "date": "2026-09-18", "command": "MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_OUTPUT=SMC-Mixer; cargo test -p io --release --locked -j 1 physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture --test-threads=1; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=30; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1", "exit_code": 101, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The endpoint/open/feedback test passed, but the supervised 30-second input capture received no operator message and produced no accepted raw-ingress artifact.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/INPUT_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This current-source endpoint and fail-closed capture result does not establish current-source AI3 or physical-input acceptance; it does not establish controller movement, mapped ingress, feedback observation, Clock/MTC, reconnect/replacement, latency, OSC/Remote, DMX/Art-Net, native UI routing, or venue acceptance.", "linked_q1_ids": ["COV-AI-CONTROL-001", "COV-INPUT-001"] },
    {"id":"EV-UI-CAPTURE-HELPER-PRINTWINDOW-CURRENT-2026-09-18","scope":"Current exact-release capture helper recheck uses HWND PrintWindow and matches the direct native screenshot","kind":"current-source-automated","status":"accepted-current","date":"2026-09-18","command":"powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File qa/harnesses/capture-window.ps1 -TitlePattern ^Syndocal$ -OutPath C:\\TEMP\\syndocal-capture-helper-fixed-20260918.png -SettleMilliseconds 300","exit_code":0,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":"3EAEE18ED2069A9731F4C40DD33A07DDAD831B70CF009F844A269B914A8A37A1","artifact_na_reason":null,"raw_evidence_paths":["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md","qa/harnesses/capture-window.ps1"],"currency_nonclaim":"This current-source capture-helper result does not establish current-source H5 acceptance; it only proves the selected HWND is rendered instead of an unrelated foreground window and does not establish native interaction, accessibility, physical output, external clients, recovery, or venue acceptance.","linked_q1_ids":["COV-UI-SHELL-001"]},
    {"id":"EV-UI-H5-NATIVE-PRINTWINDOW-CURRENT-2026-09-18","scope":"Current exact-release Syndocal HWND PrintWindow visual recheck of Control > Lighting > Live after UI reflow and native restart","kind":"current-source-automated","status":"accepted-current","date":"2026-09-18","command":"Resolve exact target/release/syndocal.exe; verify one responsive process; Win32 PrintWindow capture of the exact Syndocal HWND","exit_code":0,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":"3EAEE18ED2069A9731F4C40DD33A07DDAD831B70CF009F844A269B914A8A37A1","artifact_na_reason":null,"raw_evidence_paths":["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This current exact-release visual containment slice does not establish current-source acceptance; it does not establish button-by-button H5 live output, dangerous-operation, recording, recovery, native accessibility, physical-display, external-client, or venue acceptance.","linked_q1_ids":["COV-UI-SHELL-001"]},
    {"id":"EV-AI3-NATIVE-INGRESS-OPERATOR-WINDOW-120S-2026-09-18","scope":"Current-host UI Automation-confirmed connected BTMidiConnector SMC-Mixer state followed by an operator-directed 120-second production input capture window","kind":"current-source-automated","status":"open","date":"2026-09-18","command":"Windows UI Automation named-control inspection retained SMC-Mixer Connected.; MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=120; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1","exit_code":101,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The connected bridge remained observable, but the operator-directed 120-second production capture received no raw MIDI and produced no accepted raw-ingress artifact.","raw_evidence_paths":["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This does not establish current-source acceptance. It records only a longer connected-bridge no-message capture; it does not establish Bluetooth forwarding, physical controller movement, feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, DMX/Art-Net, venue, signing, publication, or product completion.","linked_q1_ids":["COV-AI-CONTROL-001"]},
    {"id":"EV-UI-H5-DISPLAYCONFIG-RECHECK-CURRENT-2026-09-18","scope":"Current-host read-only DisplayConfig-to-GDI monitor topology recheck after current hardware changes","kind":"current-source-automated","status":"accepted-current","date":"2026-09-18","command":"powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File qa/harnesses/run-syndocal-three-display-show-acceptance.ps1 -EvidenceSlug current-three-display-after-com5-20260918","exit_code":0,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The read-only harness observed one active DisplayConfig identity and returned not-configured; it produces no shipped artifact and cannot substitute PnP count for stable active monitor identity acceptance.","raw_evidence_paths":["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This observation does not establish current-source acceptance or three-display hardware acceptance. It records only the current DisplayConfig-to-GDI observation and not-configured verdict; it does not establish native Control interaction, physical output, external clients, recovery, venue/soak, signing, publication, or product completion.","linked_q1_ids":["COV-UI-SHELL-001"]},
    {"id":"EV-AI3-NATIVE-INGRESS-CAPTURE-2026-09-18","scope":"Current-host production SMC-Mixer MIDI enumeration/open recheck and bounded supervised operator-ingress capture","kind":"current-source-automated","status":"open","date":"2026-09-18","command":"MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_OUTPUT=SMC-Mixer; cargo test -p io --release --locked -j 1 physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture --test-threads=1; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=30; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1","exit_code":1,"assertion_count":2,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"Enumeration/open and safe feedback passed, but the supervised 30-second capture received no MIDI and therefore produced no accepted raw-ingress artifact.","raw_evidence_paths":["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This evidence does not establish current-source acceptance. It establishes only current endpoint enumeration/openability and a fail-closed no-message capture; it does not establish Bluetooth forwarding, controller movement, complete feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, DMX/Art-Net, venue, signing, publication, or product completion.","linked_q1_ids":["COV-AI-CONTROL-001"]},
    {"id":"EV-AI3-NATIVE-INGRESS-CANDIDATE-SCAN-2026-09-18","scope":"Current-host production midir candidate input scan after SMC-Mixer bridge connection","kind":"current-source-automated","status":"open","date":"2026-09-18","command":"MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=30; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1 for SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer, SMC-Mixer-bt, and MIDIIN2 (SMC-Mixer)","exit_code":1,"assertion_count":3,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"All three named inputs were opened for 30 seconds and received no operator ingress; no accepted raw-ingress artifact was produced.","raw_evidence_paths":["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This evidence does not establish current-source acceptance. It establishes only that three currently enumerated candidate inputs fail-closed without a message during bounded capture; it does not establish Bluetooth forwarding, controller movement, feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, DMX/Art-Net, venue, signing, publication, or product completion.","linked_q1_ids":["COV-AI-CONTROL-001"]},
    {"id":"EV-AI3-NATIVE-INGRESS-CONNECTED-CAPTURE-2026-09-18","scope":"Current-host Windows UI Automation-confirmed connected BTMidiConnector SMC-Mixer state followed by production supervised operator-ingress capture","kind":"current-source-automated","status":"open","date":"2026-09-18","command":"Windows UI Automation named-control inspection of BTMidiConnector (SMC-Mixer, Disconnect Device, SMC-Mixer Connected.; Add Bluetooth Device dialog closed via ExitButton without pairing); MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=30; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1","exit_code":101,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The connector's connected state was observed, but the production capture received no operator ingress and produced no accepted raw-ingress artifact.","raw_evidence_paths":["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This does not establish current-source acceptance. It records only the current connected-bridge UI state and a fail-closed no-message capture; it does not establish Bluetooth forwarding, physical controller movement, feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, DMX/Art-Net, venue, signing, publication, or product completion.","linked_q1_ids":["COV-AI-CONTROL-001"]},
    {"id":"EV-AI3-NATIVE-INGRESS-OPERATOR-WINDOW-2026-09-18","scope":"Current-host UI Automation-confirmed connected BTMidiConnector SMC-Mixer state followed by an operator-directed 60-second production input capture window","kind":"current-source-automated","status":"open","date":"2026-09-18","command":"Windows UI Automation named-control inspection retained SMC-Mixer Connected.; MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=60; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1","exit_code":101,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The connected bridge remained observable, but the operator-directed 60-second production capture received no raw MIDI and produced no accepted raw-ingress artifact.","raw_evidence_paths":["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This does not establish current-source acceptance. It records only a longer connected-bridge no-message capture; it does not establish Bluetooth forwarding, physical controller movement, feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, DMX/Art-Net, venue, signing, publication, or product completion.","linked_q1_ids":["COV-AI-CONTROL-001"]},
    { "id": "EV-ACCESSIBILITY-CURRENT-SW-2026-09-18", "scope": "Current-source accessibility-adjacent recheck after UI containment changes, including the compact safety-blackout label localization repair", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "pnpm.cmd --dir app run check:localization; pnpm.cmd --dir app run check:terminology; pnpm.cmd --dir app run check:empty-states; node app/scripts/check-project-history-keyboard.mjs; node app/scripts/check-timeline-space-keyboard.mjs; pnpm.cmd --dir app run check:stage-labels; pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run build", "exit_code": 0, "assertion_count": 8, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source semantic and build checks produce no separately accepted native accessibility artifact; native screen-reader, contrast, scaling, IME, reduced-motion, and dangerous-action matrix boundaries are recorded in the linked QA document.", "raw_evidence_paths": ["qa/ACCESSIBILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "app/src/uiLocalization.ts", "app/scripts/check-localization.mjs"], "currency_nonclaim": "This is current-source localization, compact-label, keyboard-routing, semantic, TypeScript, and build evidence only; it does not establish NVDA speech announcements, High Contrast, native 125/150/200% scaling, IME, reduced motion, full native dangerous-action/recovery workflow, physical/external acceptance, signing, publication, or product completion.", "linked_q1_ids": ["COV-ACCESSIBILITY-001"] },
    { "id": "EV-OBSERVABILITY-CURRENT-SW-2026-09-18", "scope": "Current-source observability/support and release recheck after the current migration checkpoint: status, diagnostics/redaction, updater fail-closed behavior, release artifact negatives, bundled library, strict JSON, and focused MSVC Tauri tests", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:status; pnpm.cmd --dir app run check:release:self-test; pnpm.cmd --dir app run check:bundled-library; node app/scripts/check-windows-release-artifacts.mjs --self-test; pnpm.cmd --dir app run check:strict-json; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 diagnostic_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 updater_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement_is_redacted -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 970, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source observability/release checks and focused Rust tests produce no signed/publication artifact; the external updater, clean-machine, support-drill, native, and physical acceptance boundaries are recorded in the linked QA document.", "raw_evidence_paths": ["qa/OBSERVABILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/UPDATE_RELEASE_RUNBOOK.md"], "currency_nonclaim": "This is current-source status, diagnostics/redaction, updater identity, release-negative, bundled-library, strict-parser, and focused native-test evidence only; it does not establish live signed update behavior, wrong-channel/downgrade/signature/corruption/offline/rollback acceptance, deployed support drills, clean-machine installation, signing/publication, physical/external devices, native accessibility, or product completion.", "linked_q1_ids": ["COV-OBSERVABILITY-001"] },
    { "id": "EV-MIGRATION-CORPUS-CURRENT-SW-2026-09-18", "scope": "Current-source Windows migration corpus runner and Rust acceptance recheck after the current Remote/Security checkpoint, including the stale test-selection assertion repair", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "MSVC 14.44.35207 x64; node app/scripts/check-migration-corpus.mjs", "exit_code": 0, "assertion_count": 12, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source migration tests and the maintained runner produce no shipped or cross-platform acceptance artifact; the broader compatibility boundary and exact result are recorded in the linked QA document.", "raw_evidence_paths": ["qa/MIGRATION_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "app/scripts/check-migration-corpus.mjs"], "currency_nonclaim": "This is current-source Windows migration corpus and runner evidence only; it does not establish the broader hostile-input/fuzz matrix, cross-platform file identity, real upgrade/downgrade or clean-machine rehearsal, external clients, physical output, signing, publication, or product completion.", "linked_q1_ids": ["COV-MIGRATION-001"] },
    { "id": "EV-AI8-EXTERNAL-CURRENT-SW-2026-09-18", "scope": "Current-source AI8 bridge, lifecycle, admission, MCP adapter/transport, and strict-parser recheck", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; node tools/syndocal-mcp/check.mjs; node tools/syndocal-mcp/check-transports.mjs; pnpm.cmd --dir app run check:strict-json", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source bridge and fake-loopback transport checks produce no clean-install, authenticated real-client, external endpoint, physical-output, security-review, signing, or publication artifact; the boundary is recorded in the linked checkpoint.", "raw_evidence_paths": ["qa/AI8_EXTERNAL_ACCEPTANCE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI5_SIDECAR_AUTH_CHECKPOINT_2026-09-13.md", "tools/syndocal-mcp/README.md"], "currency_nonclaim": "This current-source bridge/adapter evidence cannot establish AI8 release-native external acceptance, clean installation, an authenticated real client, crash/restart/update behavior, public-network security, physical output, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI8-EXTERNAL-NATIVE-PROBE-2026-09-18", "scope": "Exact current release descriptor/process identity with real local MCP stdio initialize followed by fail-closed authenticated tools/list", "kind": "current-source-automated", "status": "open", "date": "2026-09-18", "command": "node tools/syndocal-mcp/server.mjs --expected-executable target/release/syndocal.exe --principal-id show-operator --principal-incarnation 1 --credential-file %LOCALAPPDATA%\\Syndocal\\show-operator.credential; MCP initialize + tools/list", "exit_code": 0, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The exact descriptor/process identity was verified and initialize completed, but tools/list was rejected because the paired credential file is absent; no authenticated external-client artifact exists.", "raw_evidence_paths": ["qa/AI8_EXTERNAL_ACCEPTANCE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "tools/syndocal-mcp/README.md"], "currency_nonclaim": "This current-source native-sidecar probe cannot establish authenticated real external-client acceptance, clean install, restart/update, security review, physical output, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-DURABLE-ACCEPTANCE-CURRENT-SW-2026-09-18", "scope": "Current-source AI3 durable journal, Agent Bridge lifecycle, admission, project recovery, output-control, ownership, and focused release durable-test recheck", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:project-recovery-e3; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 durable -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 29, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source checks and 23 release durable tests produce no native dangerous-action, external-client, physical ACK, five-display, signing, publication, or product-completion artifact; the acceptance boundary is recorded in the linked checkpoint.", "raw_evidence_paths": ["qa/AI3_DURABLE_ACCEPTANCE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI3_DURABLE_RECOVERY_CHECKPOINT_2026-09-13.md", "qa/M5_RELIABILITY_VALIDATION.md"], "currency_nonclaim": "This current-source durable/recovery evidence cannot establish native Yes/No/Close behavior, external reply-loss/crash recovery, physical creation/teardown ACK, five-display hardware behavior, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-PHYSICAL-REARM-CURRENT-SW-2026-09-18", "scope": "Current-source AI3 project replacement, recovery, output-control, ownership, and safety recheck plus current physical-output preflight", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:project-transaction; pnpm.cmd --dir app run check:project-recovery-e3; node app/scripts/check-project-transaction-recovery-controller.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_control_retirement -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 output_lease_app_state_retirement -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 9, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source checks and release tests produce no physical-output or hardware-acknowledgement artifact; the current no-FTDI preflight and external re-Arm boundary are recorded in the linked checkpoint.", "raw_evidence_paths": ["qa/AI3_PHYSICAL_REARM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This current-source replacement/recovery/output-control evidence cannot establish physical New/Load/Recovery/Backup/Take Over retirement, hardware ACK, explicit re-Arm, fixture visibility, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-NATIVE-INGRESS-OPERATOR-CAPTURE-2026-09-15", "scope": "Current-host SMC-Mixer production midir operator-ingress capture attempt with a bounded 30-second raw-message window", "kind": "current-source-automated", "status": "open", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=30; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1", "exit_code": 1, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The bounded capture produced no operator message and therefore no accepted raw-ingress artifact; the failure output is retained in the linked checkpoint.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This current-source failed capture cannot establish physical MIDI acceptance, controller movement, feedback, Clock/MTC, reconnect, latency, native ingress, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-UI-H5-NATIVE-VISUAL-CURRENT-2026-09-15", "scope": "Current release native Syndocal window visual recheck confirms the high-DPI Video upper desk is readable and lower panes remain contained", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File qa/harnesses/capture-window.ps1 -TitlePattern '^Syndocal$' -OutPath C:\\\\TEMP\\syndocal-control-ui-current-20260915.png -SettleMilliseconds 1200; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": "6B1E35E286CAFC1EA0B58563484766DB0F5EBF4F43DA28DF09C9D753623AE797", "artifact_na_reason": null, "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source native visual layout evidence only; it does not establish current-source acceptance or native H5 interaction, dangerous workflow, accessibility, physical output, external clients, recovery, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-UI-H5-THREE-DISPLAY-PREFLIGHT-2026-09-15", "scope": "Current-host read-only three-display preflight records exactly two connected monitors and rejects unconfigured three-display acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File qa/harnesses/run-syndocal-three-display-show-acceptance.ps1 -EvidenceSlug current-three-display-preflight-20260915c", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Read-only topology preflight produces no shipped artifact; its exact monitor inventory, verdict, and no-mutation boundary are recorded in the linked QA checkpoint.", "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-host DisplayConfig observation only; it does not establish current-source acceptance or three-display identity acceptance, native Control interaction, physical output, external clients, recovery, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-UI-H5-THREE-DISPLAY-TOPOLOGY-2026-09-15", "scope": "Current-host read-only DisplayConfig recheck observes three connected displays while the separate StandardRelease role-profile preflight remains not-configured", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File qa/harnesses/run-syndocal-three-display-show-acceptance.ps1 -EvidenceSlug current-three-display-recheck-20260915b", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Read-only topology observation produces no shipped artifact; the exact three-monitor inventory, role-profile mismatch, verdict, and no-mutation boundary are recorded in the linked QA checkpoint.", "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-host three-display topology evidence only; it does not establish current-source acceptance, the configured editor/LED/projector role profile, native Control interaction, physical output, external clients, recovery, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-REMOTE-PAIRING-DUPLICATE-2026-09-15", "scope": "Current-source Remote pairing admission rejects repeated token query parameters and uses the bounded constant-time comparison for the single accepted PIN", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "node app/scripts/check-dj-link-runtime.mjs; MSVC 14.44.35207 x64; cargo test -p io --release --locked remote_ -- --test-threads=1; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 68, "ignored_count": 1, "warning_count": 1, "artifact_hash": "CCB0DFD91BAE17D78CF8A0C0EEAA4BBCA6F3AC593B4DF6377B2841DC6914E307", "artifact_na_reason": null, "raw_evidence_paths": ["qa/REMOTE_SECURITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source pairing/admission plus exact Windows native build/process-smoke evidence only; it does not establish real LAN/TLS exposure, external client acceptance, updater trust, dependency/SBOM/redaction, physical RDM/TOD cancellation, or product completion.", "linked_q1_ids": ["COV-SECURITY-001"] },
    { "id": "EV-REMOTE-AUTHORITY-DUPLICATE-2026-09-15", "scope": "Current-source Remote authority admission rejects duplicate Host or Origin headers instead of selecting an ambiguous first value", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "node app/scripts/check-dj-link-runtime.mjs; MSVC 14.44.35207 x64; cargo test -p io --release --locked remote_ -- --test-threads=1; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 68, "ignored_count": 1, "warning_count": 1, "artifact_hash": "6B1E35E286CAFC1EA0B58563484766DB0F5EBF4F43DA28DF09C9D753623AE797", "artifact_na_reason": null, "raw_evidence_paths": ["qa/REMOTE_SECURITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source Remote authority admission plus exact Windows native build/process-smoke evidence only; it does not establish real LAN/TLS exposure, external client acceptance, updater trust, dependency/SBOM/redaction, physical RDM/TOD cancellation, or product completion.", "linked_q1_ids": ["COV-SECURITY-001"] },
    { "id": "EV-UI-H5-VIDEO-HIDPI-2026-09-15", "scope": "Current-source Video upper-desk high-DPI regression repair: physical 2560x1504 equivalent CSS 1280x752 surface retains the monitor-first 60/40 split while low-DPI 1280x720 keeps its compact floor", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:control-upper-workspaces (3840x2160, 2560x1440, 2560x1504, 1920x1080, 1280x720, 2560x1504-2x CSS1280x752 deviceScaleFactor=2); MSVC 14.44.35207 x64; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 1, "artifact_hash": "01C5F39A056F781DA74BA5DB138318AD190299469CDD77FA66E47CB63059C5E7", "artifact_na_reason": null, "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source rendered-browser Video geometry plus exact Windows native build/process-smoke evidence only; it does not establish native button-by-button Control interaction, native accessibility, the current three-display acceptance gate, physical output, external clients, recovery, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-VIDEO-CAMERA-CURRENT-PHYSICAL-2026-09-14", "scope": "Current-source physical ASUS 5M DirectShow camera capture and two clean worker start/stop cycles", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "MSVC 14.44.35207 x64; SYNDOCAL_FFMPEG=<explicit FFmpeg 8.1 path>; SYNDOCAL_TEST_CAMERA_ENDPOINT=<canonical ASUS 5M nv12 1280x720 30/1 profile>; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 camera_worker_captures_a_real_frame_and_restarts_cleanly -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The physical camera test has no separately shipped artifact; exact current source, device/profile, FFmpeg path, and result are recorded in the linked QA checkpoint.", "raw_evidence_paths": ["qa/VIDEO_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This current-source physical camera slice does not establish display/HDMI, NDI/Spout, unplug/replug, frame-drop, one-hour, venue, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-VIDEO-CAMERA-CURRENT-PHYSICAL-2026-09-15", "scope": "Current-host physical ASUS 5M DirectShow camera capture and two clean worker start/stop cycles on the current release source", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; SYNDOCAL_FFMPEG=<explicit FFmpeg 8.1 path>; SYNDOCAL_TEST_CAMERA_ENDPOINT=<canonical encoded ASUS 5M nv12 1280x720 30/1 profile recorded in the QA checkpoint>; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 camera_worker_captures_a_real_frame_and_restarts_cleanly -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The physical camera recheck has no separately shipped artifact; the exact current source, device/profile, FFmpeg path, canonical endpoint, and result are recorded in the linked QA checkpoint.", "raw_evidence_paths": ["qa/VIDEO_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This current-source physical camera recheck does not establish display/HDMI, NDI/Spout, unplug/replug, frame-drop, one-hour, venue, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-UI-H5-BOTH-BROWSER-RERUN-2026-09-14", "scope": "Fresh current-source H5 Control Both rendered browser gate across 3840x2160, 2560x1440, 1920x1080, and 1280x720", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "PowerShell $env:CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:control-upper-workspaces", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The browser gate emits local screenshots but no separately shipped artifact; exact current-source viewport results and zero CDP diagnostics are recorded in the linked QA checkpoints.", "raw_evidence_paths": ["qa/CONTROL_BOTH_CHECKPOINT_2026-09-14.md", "qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This does not establish current-source product acceptance; it is fresh rendered browser evidence only and does not establish native button-by-button interaction, native accessibility, physical output, external clients, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-REMOTE-SECURITY-CURRENT-SW-2026-09-14", "scope": "Current-source Remote/Security authority, adapter, admission, strict-parser, and output-ownership contracts adjacent to external LAN/TLS and adversarial acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; node tools/syndocal-mcp/check.mjs; pnpm.cmd --dir app run check:strict-json; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:ai5-sidecar; pnpm.cmd --dir app run check:ai6-admin-ui; pnpm.cmd --dir app run check:ai7-adversarial-proof", "exit_code": 0, "assertion_count": 9, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source checks and fake loopback produce no real LAN/TLS, adversarial client, fuzz, update, SBOM, redaction, or physical RDM/TOD artifact; the external security boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/REMOTE_SECURITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/REMOTE_TOUCH_SOFTWARE_REVALIDATION_2026-09-12.md", "qa/SECURITY_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source authority, adapter, parser, and ownership evidence only; it does not establish public-network/TLS safety, adversarial client acceptance, parser/path/archive fuzz, updater trust, SBOM/redaction, physical RDM/TOD, or product completion.", "linked_q1_ids": ["COV-SECURITY-001"] },
    { "id": "EV-REMOTE-SECURITY-CURRENT-SW-2026-09-15", "scope": "Current-source Remote/Security authority, adapter, admission, strict-parser, output-ownership, AI5/AI6/AI7, and release remote-test recheck after current AI3/UI/observability checkpoints", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; node app/scripts/check-dj-link-runtime.mjs; cargo test -p io --release --locked remote_ -- --test-threads=1; pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; node tools/syndocal-mcp/check.mjs; pnpm.cmd --dir app run check:strict-json; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:ai5-sidecar; pnpm.cmd --dir app run check:ai6-admin-ui; pnpm.cmd --dir app run check:ai7-adversarial-proof", "exit_code": 0, "assertion_count": 10, "ignored_count": 1, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source checks and loopback tests produce no real LAN/TLS, external-client, public endpoint, RDM/TOD, dependency/SBOM, updater, signing, or publication artifact; the external boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/REMOTE_SECURITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/REMOTE_TOUCH_SOFTWARE_REVALIDATION_2026-09-12.md", "qa/SECURITY_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is current-source Remote/Security and loopback evidence only; it does not establish current-source acceptance, real LAN/TLS exposure, external client acceptance, physical RDM/TOD cancellation, dependency/SBOM/redaction review, updater trust, signing, publication, or product completion.", "linked_q1_ids": ["COV-SECURITY-001"] },
    { "id": "EV-REMOTE-SECURITY-CURRENT-SW-2026-09-18", "scope": "Current-source Remote/Security authority, adapter, admission, strict-parser, output-ownership, AI5/AI6/AI7, and release remote-test recheck after the current COM5 physical-output checkpoint", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "MSVC 14.44.35207 x64; node app/scripts/check-dj-link-runtime.mjs; cargo test -p io --release --locked -j 1 remote_ -- --test-threads=1; pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; node tools/syndocal-mcp/check.mjs; pnpm.cmd --dir app run check:strict-json; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:ai5-sidecar; pnpm.cmd --dir app run check:ai6-admin-ui; pnpm.cmd --dir app run check:ai7-adversarial-proof", "exit_code": 0, "assertion_count": 10, "ignored_count": 1, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source checks and fake-loopback tests produce no real LAN/TLS, external-client, public endpoint, RDM/TOD, dependency/SBOM, updater, signing, or publication artifact; the external boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/REMOTE_SECURITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source Remote/Security and loopback evidence only; it does not establish current-source acceptance, real LAN/TLS exposure, external client acceptance, physical RDM/TOD cancellation, dependency/SBOM/redaction review, updater trust, signing, publication, or product completion.", "linked_q1_ids": ["COV-SECURITY-001"] },
    { "id": "EV-AI8-EXTERNAL-CURRENT-SW-2026-09-14", "scope": "Current-source AI8 bridge, lifecycle, admission, fake-loopback adapter, and strict-parser contracts adjacent to release-native external acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; node tools/syndocal-mcp/check.mjs; pnpm.cmd --dir app run check:strict-json", "exit_code": 0, "assertion_count": 5, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Local source checks and fake loopback produce no clean-install, real external-client, physical-output, security-review, signing, or publication artifact; the release-native boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI8_EXTERNAL_ACCEPTANCE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI_CONTROL_SOFTWARE_REVALIDATION_2026-09-12.md", "qa/M6_RELEASE_VALIDATION.md"], "currency_nonclaim": "Current-source bridge/admission/parser evidence only; it does not establish clean-install, real external clients, release restart/update, public-network security, physical output, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI8-EXTERNAL-CURRENT-SW-2026-09-15", "scope": "Current-source AI8 bridge, lifecycle, admission, fake-loopback adapter, and strict-parser recheck after current AI3/Remote/UI/observability checkpoints", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; node tools/syndocal-mcp/check.mjs; pnpm.cmd --dir app run check:strict-json", "exit_code": 0, "assertion_count": 5, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Local source checks and fake loopback produce no clean-install, real external-client, physical-output, security-review, signing, or publication artifact; the release-native boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI8_EXTERNAL_ACCEPTANCE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI_CONTROL_SOFTWARE_REVALIDATION_2026-09-12.md", "qa/M6_RELEASE_VALIDATION.md"], "currency_nonclaim": "This is current-source bridge/admission/parser evidence only; it does not establish current-source acceptance, clean-install, real external clients, release restart/update, public-network security, physical output, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-DURABLE-ACCEPTANCE-CURRENT-SW-2026-09-14", "scope": "Current-source AI3 durable journal, Agent Bridge lifecycle, admission, project recovery, output-control, and ownership contracts adjacent to native dangerous-action and hardware acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:project-recovery-e3; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Source checks produce no native dangerous-action, external-client, physical ACK, or five-display artifact; the software boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI3_DURABLE_ACCEPTANCE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI3_DURABLE_RECOVERY_CHECKPOINT_2026-09-13.md", "qa/M5_RELIABILITY_VALIDATION.md"], "currency_nonclaim": "Current-source durable/admission/recovery evidence only; it does not establish native reply-loss/restart, physical creation/teardown ACK, five-display behavior, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-DURABLE-ACCEPTANCE-CURRENT-SW-2026-09-15", "scope": "Current-source AI3 durable journal, Agent Bridge lifecycle, admission, project recovery, output-control, and ownership recheck after current Remote/UI/observability checkpoints", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "pnpm.cmd --dir app run check:agent-bridge; node app/scripts/check-agent-bridge-bootstrap.mjs; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:project-recovery-e3; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Source checks produce no native dangerous-action, external-client, physical ACK, or five-display artifact; the software boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI3_DURABLE_ACCEPTANCE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI3_DURABLE_RECOVERY_CHECKPOINT_2026-09-13.md", "qa/M5_RELIABILITY_VALIDATION.md"], "currency_nonclaim": "This is current-source durable/admission/recovery evidence only; it does not establish current-source acceptance or native Yes/No/Close, reply-loss/restart, physical creation/teardown ACK, five-display behavior, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-PHYSICAL-REARM-CURRENT-SW-2026-09-14", "scope": "Current-source AI3 project replacement/recovery/output-control/ownership/safety contracts adjacent to physical re-Arm acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "MSVC 14.44.35207 x64 (Build Tools); pnpm.cmd --dir app run check:project-transaction; pnpm.cmd --dir app run check:project-recovery-e3; node app/scripts/check-project-transaction-recovery-controller.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_control_retirement -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 output_lease_app_state_retirement -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 15, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Source checks produce no physical-output or hardware-acknowledgement artifact; the external re-Arm boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI3_PHYSICAL_REARM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI3_OUTPUT_LEASE_CURRENT_REVALIDATION_2026-09-09.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "Current-source project/recovery, output-control, ownership, and safety evidence only; it does not establish physical retirement/re-Arm, hardware ACK, native device behavior, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-PHYSICAL-REARM-CURRENT-SW-2026-09-15", "scope": "Current-source AI3 project replacement, recovery, output-control, ownership, safety, and focused release-test recheck after current Remote/UI/observability checkpoints", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:project-transaction; pnpm.cmd --dir app run check:project-recovery-e3; node app/scripts/check-project-transaction-recovery-controller.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_control_retirement -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 output_lease_app_state_retirement -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 9, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Source checks and focused release tests produce no physical-output or hardware-acknowledgement artifact; the external re-Arm boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI3_PHYSICAL_REARM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI3_OUTPUT_LEASE_CURRENT_REVALIDATION_2026-09-09.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is current-source replacement/recovery/output-control evidence only; it does not establish current-source acceptance or physical retirement/re-Arm, hardware ACK, native device behavior, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-NATIVE-INGRESS-CURRENT-SW-2026-09-14", "scope": "Current-source AI3 ingress/admission/ownership/safety contracts and bounded Agent Bridge hostile-request corpus adjacent to native client and device acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "MSVC 14.44.35207 x64; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 agent_bridge_ -- --nocapture --test-threads=1; pnpm.cmd --dir app run check:frontend-command-routing; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; pnpm.cmd --dir app run check:dvc-midi-shortcuts; node app/scripts/check-dvc-dmx-shortcuts.mjs; pnpm.cmd --dir app run check:agent-bridge; pnpm.cmd --dir app run check:warnings -- --configuration windows-native-release", "exit_code": 0, "assertion_count": 16, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Source checks and the bounded release corpus produce no native client, device, or physical-output artifact; the exact MSVC/linker, corpus result, warning ratchet, and external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/SYNDOCAL_AI_CONTROL_PLANE_ROADMAP.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "Current-source admission, bounded parser, ownership, safety, shortcut, and warning evidence only; it does not establish native MIDI/OSC/DMX/Remote ingress, real Art-Net/fixture behavior, reconnect, latency, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-AI3-NATIVE-INGRESS-CURRENT-SW-2026-09-15", "scope": "Current-source AI3 ingress, admission, ownership, safety, shortcut, Agent Bridge, warning, and release-test recheck after current Remote/UI/observability checkpoints", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:frontend-command-routing; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; pnpm.cmd --dir app run check:dvc-midi-shortcuts; node app/scripts/check-dvc-dmx-shortcuts.mjs; pnpm.cmd --dir app run check:agent-bridge; pnpm.cmd --dir app run check:warnings -- --configuration windows-native-release; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 agent_bridge_ -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 10, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Source checks and focused release tests produce no native client, device, or physical-output artifact; the exact linker, corpus result, warning ratchet, and external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/SYNDOCAL_AI_CONTROL_PLANE_ROADMAP.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is current-source ingress/admission/ownership/safety evidence only; it does not establish current-source acceptance or native MIDI/OSC/DMX/Remote ingress, real Art-Net/fixture behavior, controller movement, Clock/MTC, reconnect, latency, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] },
    { "id": "EV-COMPARE-PINNED-CURRENT-SW-2026-09-14", "scope": "Current-source comparison precondition audit: status-model contract plus pinned comparator/document boundary for SynapseRack and Daslight", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:status", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The status-model check produces no comparator, license, hardware, content, or physical-output artifact; the external comparison boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/COMPARE_PINNED_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/SYNDOCAL_SYNAPSERACK_VIDEO_OPERATOR_BENCHMARK.md", "qa/DASLIGHT_PARITY_COMPLETION_PLAN.md", "qa/M6_RELEASE_VALIDATION.md"], "currency_nonclaim": "Current-source status-model and comparison-precondition evidence only; it does not claim SynapseRack or Daslight parity, pinned-version measurement, license approval, physical output, external-client, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-COMPARE-VIDEO-001", "COV-COMPARE-LIGHTING-001"] },
    { "id": "EV-VENUE-SOAK-CURRENT-SW-2026-09-14", "scope": "Current-source status model and frontend production build adjacent to the venue performance gate", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:status; pnpm.cmd --dir app run build", "exit_code": 0, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Status/build checks produce no venue GPU, integrated A/V, physical output, or one-hour time-series artifact; the external venue boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/VENUE_SOAK_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M5_RELIABILITY_VALIDATION.md"], "currency_nonclaim": "Current-source status/build evidence only; it does not claim maximum-condition venue GPU/resource, thermal/clock, integrated A/V/lighting/output/recording, physical output, or product completion.", "linked_q1_ids": ["COV-PERFORMANCE-001"] },
    { "id": "EV-VENUE-SOAK-MIXED-CURRENT-SW-2026-09-14", "scope": "Current-source engine mixed Color/Chaser/Move benchmark and bounded M5 software soak adjacent to the venue performance gate", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "rustfmt --check crates/engine/examples/syndocal_soak.rs; MSVC 14.44.35207 x64; cargo build -p engine --example syndocal_soak --release --locked; cargo test -p engine mixed_color_chaser_move --release --locked -- --nocapture; powershell.exe -NoProfile -ExecutionPolicy Bypass -File qa/run-soak.ps1 -DurationSeconds 60 -SampleIntervalSeconds 5 -Configuration Release -SkipBuild -MixedLighting -ReportPath target/qa/m5-soak-mixed-lighting-current-60-fixed.json", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The local soak report is a build artifact and is not a distributed release artifact; software loopback evidence produces no venue GPU, integrated A/V, physical output, or one-hour time-series acceptance artifact.", "raw_evidence_paths": ["qa/VENUE_SOAK_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M5_RELIABILITY_VALIDATION.md", "crates/engine/examples/syndocal_soak.rs", "qa/run-soak.ps1"], "currency_nonclaim": "Current-source software benchmark and 60-second loopback-soak evidence only; it does not establish maximum-condition venue GPU/resource, thermal/clock, integrated A/V/lighting/output/recording, physical output, one-hour venue acceptance, or product completion.", "linked_q1_ids": ["COV-PERFORMANCE-001"] },
    { "id": "EV-VENUE-SOAK-MIXED-ISOLATED-CURRENT-SW-2026-09-15", "scope": "Current-source mixed Color/Chaser/Move 60-second loopback soak under native-process-isolated host scheduling, with nonblank video and DMX/tick telemetry", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; powershell.exe -NoProfile -ExecutionPolicy Bypass -File qa/run-soak.ps1 -DurationSeconds 60 -SampleIntervalSeconds 5 -Configuration Release -SkipBuild -MixedLighting -ReportPath target/qa/m5-soak-mixed-lighting-current-60-isolated-20260915.json", "exit_code": 0, "assertion_count": 12, "ignored_count": 0, "warning_count": 0, "artifact_hash": "18FD2E2C42A181E6C3355776730AA751B8383F6EAF164631D393659853416A1A", "artifact_na_reason": "The local soak report is a build artifact and is not a distributed release artifact; software loopback evidence produces no venue GPU, integrated A/V, physical output, or one-hour time-series acceptance artifact.", "raw_evidence_paths": ["qa/VENUE_SOAK_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "crates/engine/examples/syndocal_soak.rs", "qa/run-soak.ps1"], "currency_nonclaim": "This is isolated current-source software-loopback evidence only; it does not establish host-contended behavior, maximum-condition venue GPU/resource, thermal/clock, integrated A/V/lighting/output/recording, physical output, one-hour venue acceptance, or product completion.", "linked_q1_ids": ["COV-PERFORMANCE-001"] },
    { "id": "EV-VIDEO-PHYSICAL-CURRENT-SW-2026-09-14", "scope": "Current-source video output routing, managed-window lifecycle, observation, and bounded polling contracts adjacent to physical display/capture acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:video-output-routing-runtime; pnpm.cmd --dir app run check:video-output-window-runtime; pnpm.cmd --dir app run check:video-output-window-observation; pnpm.cmd --dir app run check:video-runtime-polling", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source routing/window checks produce no physical display, receiver, or capture artifact; the external video boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/VIDEO_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M5_RELIABILITY_VALIDATION.md"], "currency_nonclaim": "Current-source video routing evidence only; it does not claim physical display/HDMI, NDI/Spout/camera reception, capture faults, reconnect, frame drops, one-hour soak, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-DJ-LINK-CURRENT-SW-2026-09-14", "scope": "Current-source DJ Link track-mapping and frontend runtime policy contracts adjacent to live peer/hardware acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:dj-link", "exit_code": 0, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source DJ Link checks start no external Agent or pedal and produce no live peer/hardware artifact; the external matrix boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/DJ_LINK_HARDWARE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/REKORDBOX_STREAM_DECK_PEDAL_ACCEPTANCE.md"], "currency_nonclaim": "Current-source DJ Link policy evidence only; it does not claim live Agent/rekordbox/Pedal/remote clients, HELLO/ACK/STATE_SYNC, reconnect/restart, or product completion.", "linked_q1_ids": ["COV-REMOTE-TOUCH-001"] },
    { "id": "EV-INPUT-PHYSICAL-CURRENT-SW-2026-09-14", "scope": "Current-source physical-input routing and generation contracts: DVC MIDI/DMX shortcut inventories and frontend command authority inventory", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:dvc-midi-shortcuts; node app/scripts/check-dvc-dmx-shortcuts.mjs; pnpm.cmd --dir app run check:frontend-command-routing", "exit_code": 0, "assertion_count": 80, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source input routing checks produce no physical client/device artifact; the external input boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/INPUT_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "Current-source routing evidence only; it does not claim physical MIDI/OSC/Remote clients, controller/feedback behavior, reconnect, latency, native device behavior, or product completion.", "linked_q1_ids": ["COV-INPUT-001"] },
    { "id": "EV-INPUT-PHYSICAL-MIDI-CURRENT-2026-09-14", "scope": "Current-source current-host physical SMC-Mixer MIDI enumerate/open and safe All Notes Off feedback recheck", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "MSVC 14.44.35207 x64; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_OUTPUT=SMC-Mixer; cargo test -p io --release --locked -j 1 physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The safe physical MIDI transport slice has no shipped binary artifact; exact current source, device names, toolchain, command, and result are recorded in the linked QA documents.", "raw_evidence_paths": ["qa/INPUT_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is only a current-source physical MIDI enumerate/open/safe-feedback slice; it does not constitute physical controller movement, LED observation, Clock/MTC, latency, OSC/Remote, reconnect/replacement, native UI, DMX, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-INPUT-001", "COV-AI-CONTROL-001"] },
    { "id": "EV-INPUT-PHYSICAL-MIDI-CURRENT-2026-09-15", "scope": "Current-source current-host reconnected SMC-Mixer physical MIDI enumerate/open and safe All Notes Off feedback recheck", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; where.exe link.exe (pinned linker first); SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_OUTPUT=SMC-Mixer; cargo test -p io --release --locked -j 1 physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The reconnected safe physical MIDI transport slice has no shipped binary artifact; exact current source, device names, pinned toolchain, command, result, and remaining external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/INPUT_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is only a current-source reconnected physical MIDI enumerate/open/safe-feedback slice; it does not constitute physical controller movement, LED observation, Clock/MTC, latency, OSC/Remote, reconnect/replacement, native UI, DMX, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-INPUT-001", "COV-AI-CONTROL-001"] },
    { "id": "EV-INPUT-PHYSICAL-MIDI-INPUT-2026-09-15", "scope": "Current-host reconnected SMC-Mixer direct WinMM input observation across the two exposed input aliases", "kind": "historical-evidence", "status": "accepted-historical", "date": "2026-09-15", "command": "Windows WinMM; Python ctypes; input aliases SMC-Mixer index 1 and MIDIIN2 (SMC-Mixer) index 2; bounded 15-second MIM_DATA observer", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "A direct host input observation has no shipped software artifact; exact endpoints, raw message examples, counts, duplicate-alias boundary, and remaining production listener acceptance are recorded in the linked QA document.", "raw_evidence_paths": ["qa/INPUT_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This direct WinMM host observation is not current-source Syndocal listener or native UI acceptance; it does not constitute independent dual-input proof, mapping/Learn consumption, controller/Clock/MTC acceptance, LED feedback, latency, reconnect/replacement, OSC/Remote, DMX, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-INPUT-001"] },
    { "id": "EV-DMX-USB-RDM-CURRENT-SW-2026-09-14", "scope": "Current-source USB-DMX/RDM-adjacent output contracts: revision-fenced status, exact machine-local identity, S0/zero-first safety, bounded shutdown, strict receipts, output ownership, and no bypass routes", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime", "exit_code": 0, "assertion_count": 3, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source USB-DMX/RDM contracts produce no RDM gateway, fixture, or analyzer artifact; the physical RDM boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/DMX_USB_RDM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "Current-source output-control and safety evidence only; it does not claim Enttec/DMXKing RDM hardware, two fixtures, discovery/inventory churn, analyzer capture, physical output, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-DMX-ARTNET-CURRENT-SW-2026-09-14", "scope": "Current-source DMX preparation, addressing, output ownership, safety blackout, and show-setup contracts adjacent to Art-Net/sACN acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:dmx-addressing; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; node app/scripts/check-dmx-show-setup.mjs", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source DMX contracts produce no network-node or fixture artifact; the external Art-Net/sACN boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/DMX_ARTNET_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "Current-source DMX preparation and safety evidence only; it does not claim real Art-Net/sACN nodes, fixture behavior, reconnect, topology, 44 Hz continuity, physical output, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-ASIO-PERSISTENCE-CURRENT-SW-2026-09-14", "scope": "Current-source ASIO selection persistence and normal-package separation: explicit selection lifecycle, stale/ambiguous rejection, exact runtime inventory, ASIO payload/glob rejection, and SDK-pin immutability", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:live-audio; pnpm.cmd --dir app run check:asio-packaging", "exit_code": 0, "assertion_count": 170, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source selection/package checks produce no accepted final native/public ASIO artifact; the licensing and native persistence boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_PERSISTENCE_PACKAGE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md", "qa/ASIO_SDK_PIN.json"], "currency_nonclaim": "Current-source persistence and package-separation evidence only; it does not claim final native UI telemetry, stale-device operator acceptance, licensed/public ASIO packaging, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-LATENCY-CURRENT-SW-2026-09-14", "scope": "Current-source live-audio lifecycle and telemetry-adjacent proof for the ASIO latency gate", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:live-audio", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The source lifecycle check produces no physical marker, TouchDesigner, or input-to-pixel measurement artifact; the external measurement boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_LATENCY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "Current-source lifecycle evidence only; it does not claim capture-to-engine or input-to-pixel latency, five matched TouchDesigner trials, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-SOAK-CURRENT-SW-2026-09-14", "scope": "Current-source ASIO/WASAPI lifecycle proof adjacent to the soak gate: fail-closed live-audio lifecycle, availability, selection persistence, presentation, and request ordering", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:live-audio", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The lifecycle source check produces no one-hour hardware artifact; the absent long-duration external evidence is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_SOAK_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "Current-source lifecycle evidence only; it does not claim matched one-hour ASIO/WASAPI soak, callback or capture latency budgets, thermal/clock stability, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-FAULT-CURRENT-SW-2026-09-14", "scope": "Current-source ASIO fault and lifecycle contracts: terminal-event mapping, callback silence, SDK-independent bridge behavior, host-lease ownership, Stop/Close release, and no-fallback handling", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "cargo test --manifest-path tools/asio-bridge/Cargo.toml --locked -- --nocapture; pnpm.cmd --dir app run check:asio-v3-contract", "exit_code": 0, "assertion_count": 53, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "SDK-independent bridge and FFI source tests produce no accepted native device/fault artifact; the real-driver boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_FAULT_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "Current-source fault-contract evidence only; it does not claim occupied/reset/resync/XRUN/unplug/callback-gap/no-callback native recovery, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-FORMAT-CURRENT-SW-2026-09-14", "scope": "Current-source ASIO explicit configuration and format admission: fail-closed lifecycle, selection persistence, IPC request mapping, unsupported-value rejection, and ABI-v3 contract", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:live-audio; pnpm.cmd --dir app run check:live-audio-ipc-v1; pnpm.cmd --dir app run check:asio-v3-contract", "exit_code": 0, "assertion_count": 22, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source configuration and contract checks produce no real-driver or shipped ASIO matrix artifact; the native external boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_FORMAT_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "Current-source fail-closed configuration evidence only; it does not claim the advertised sample-rate/buffer/format/channel matrix, real-driver selection, no-fallback native acceptance, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-LICENSE-CURRENT-SW-2026-09-14", "scope": "Current-source ASIO licensing and package-separation boundary: pinned SDK, distribution_approved false, exact normal-package runtime allowlist, ASIO rejection cases, and ABI-v3 contract", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:asio-packaging; pnpm.cmd --dir app run check:asio-v3-contract", "exit_code": 0, "assertion_count": 191, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source package-boundary and contract checks produce no licensed/public ASIO artifact; the separate local-only payload and unresolved distribution decision are recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_LICENSE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md", "qa/ASIO_SDK_PIN.json"], "currency_nonclaim": "Current-source fail-closed package boundary only; it does not claim GPLv3 or Steinberg approval, legal review, notices/source-obligation completion, public distribution, real-device/native acceptance, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-UI-H5-BOTH-SW-2026-09-14", "scope": "Current-source H5 Control Both overview: four-domain navigation, combined Lighting and Video operator summary, lease-bound master/blackout routes, cue controls, Preview/Program and recording/output truth, rendered 1920x1080 browser gate, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run check:release:static; pnpm.cmd --dir app run check:project-shortcuts; pnpm.cmd --dir app run check:workspace-operator; pnpm.cmd --dir app run check:frontend-command-routing; CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; SYNDOCAL_CONTROL_VIEWPORT=1920x1080; node app/scripts/check-control-upper-workspaces-browser.mjs; MSVC 14.44.35207 x64; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 10, "ignored_count": 0, "warning_count": 1, "artifact_hash": "16A853E5F1AB38C97918854B436A2CC8A9B15CF8AA72732BA16DDB2C8A7456AC", "artifact_na_reason": null, "raw_evidence_paths": ["qa/CONTROL_BOTH_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source Control Both software, rendered-browser, and Windows native process-smoke evidence only; it does not establish native button-by-button interaction, physical DMX/Art-Net/sACN/USB/RDM/MIDI/OSC/video/display output, external clients, real two-machine operation, venue/soak, accessibility, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-MIGRATION-CORPUS-SW-2026-09-14", "scope": "Current-source Windows project storage, transaction, recovery, publication, strict-JSON, and bounded in-memory migration corpus: golden load/save/reload, legacy defaults, mappings, version rejection, duplicate IDs, corrupt references/values, UTF-8/depth/truncation, retired mappings, and embedded-profile path non-reopening", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:project-storage; pnpm.cmd --dir app run check:project-transaction; pnpm.cmd --dir app run check:project-recovery-e3; pnpm.cmd --dir app run check:project-publication-e4; pnpm.cmd --dir app run check:project-open-bootstrap; node app/scripts/check-project-history-preflight.mjs; node app/scripts/check-project-history-keyboard.mjs; node app/scripts/check-project-transaction-recovery-controller.mjs; pnpm.cmd --dir app run check:strict-json; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_file_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_recovery_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_publication_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 migration_corpus -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 11, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The software and corpus commands produce no shipped binary; exact current source, test counts, lockfile, linker procedure, command results, and remaining external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/MIGRATION_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source Windows migration, recovery, publication, and bounded hostile-input software evidence only; it does not establish the broader fuzz matrix, cross-platform file identity, real upgrade/downgrade machine rehearsals, external clients, physical output, venue, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-MIGRATION-001"] },
    { "id": "EV-UI-H5-VIDEO-LAUNCH-SW-2026-09-14", "scope": "Current-source H5 Control Video Clip Launch canonical OutputControl operation: Video/Both lease and resource selection, non-zero layer and bounded fade validation, schema-v12 wire admission, generation/fence revalidation, shared launch core, static contracts, rendered Touch viewport, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "cargo test -p protocol --locked control_plane -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 control_plane::tests -- --nocapture --test-threads=1; pnpm.cmd --dir app run check:release:static; pnpm.cmd --dir app run check:output-control-runtime; SYNDOCAL_VIEWPORT_TRACE=1 pnpm.cmd --dir app run check:touch; MSVC 14.44.35207 x64; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 100, "ignored_count": 0, "warning_count": 1, "artifact_hash": "1BCD3DF94A8260CA31FF78DD71DAFF5CDB3A04CE49313E1BB43FB5DED3D71DA7", "artifact_na_reason": null, "raw_evidence_paths": ["qa/OUTPUT_CONTROL_VIDEO_LAUNCH_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source protocol/native/frontend/static, rendered-browser, and Windows native build/process-smoke evidence only; it does not establish native button-by-button interaction, physical HDMI/video output, NDI/Spout/display reception, real two-machine operation, venue/soak, accessibility, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-UI-H3-SETUP-SW-2026-09-13", "scope": "Current-source Setup Fixture Library/Patch/Repair/GDTF/OFL, Stage mapping, selected fixture inspector, Video Outputs, I/O connection workbench, DMX preparation, focused empty/error/keyboard/pointer/browser viewport contracts, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:patch-transaction-d2 && pnpm.cmd --dir app run check:fixture-catalog && pnpm.cmd --dir app run check:patch-profile-counts && pnpm.cmd --dir app run check:profile-library && pnpm.cmd --dir app run check:gdtf-profile-actions && pnpm.cmd --dir app run check:fixture-live-color && pnpm.cmd --dir app run check:fixture-limits-degrees && pnpm.cmd --dir app run check:dmx-addressing && node app/scripts/check-dmx-show-setup.mjs && node app/scripts/check-mapping-stage-geometry.mjs && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 d2_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 patch_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 gdtf_ -- --nocapture --test-threads=1 && cargo test -p engine --release --locked -j 1 fixture_patch_ -- --nocapture --test-threads=1 && cargo test -p engine --release --locked -j 1 fixture_profile_repair_ -- --nocapture --test-threads=1 && cargo test -p gdtf --release --locked -j 1 -- --nocapture --test-threads=1 && node app/scripts/check-viewport-containment.mjs --patch-only && node app/scripts/check-viewport-containment.mjs --fixture-catalog-only && node app/scripts/check-viewport-containment.mjs --mapping-viewport-conformance-only && node app/scripts/check-viewport-containment.mjs --setup-video-only && node app/scripts/check-viewport-containment.mjs --setup-io-only && node app/scripts/check-viewport-containment.mjs --setup-dmx-only && node app/scripts/check-viewport-containment.mjs --setup-stage-band-sequence-only && node app/scripts/check-viewport-containment.mjs --fixture-groups-only && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 83, "ignored_count": 0, "warning_count": 0, "artifact_hash": "38C4E36E28522CCB3D5E458ED55196EB820560945D17670E8B1D2B71C8B5E43D", "artifact_na_reason": null, "raw_evidence_paths": ["qa/UI_H3_SETUP_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source Setup software/browser and Windows native process evidence only; it cannot establish native button-by-button accessibility, NVDA/High Contrast/scaling/IME, physical DMX/MIDI/OSC/RDM/video/audio devices, fixture illumination, downstream reception, real two-machine operation, venue, signing, publication, or H4-H5 completion.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-PATCH-GDTF-001"] },
    { "id": "EV-UI-H2-SHELL-SW-2026-09-13", "scope": "Current-source shared Setup/Edit/Control shell, fail-closed ShowClock status chip, operator navigation labels/focus, Full/Partial operator-lock boundaries, seven browser pane-window routes, five viewport sizes, and Windows native process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:workspace-operator && node app/scripts/check-workspace-navigation-controller.mjs && pnpm.cmd --dir app run check:workspace-operator-viewport && pnpm.cmd --dir app run check:frontend-invokes && pnpm.cmd --dir app run check:frontend-command-routing && pnpm.cmd --dir app run check:empty-states && pnpm.cmd --dir app build && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 40, "ignored_count": 0, "warning_count": 0, "artifact_hash": "38C4E36E28522CCB3D5E458ED55196EB820560945D17670E8B1D2B71C8B5E43D", "artifact_na_reason": null, "raw_evidence_paths": ["qa/UI_H2_SHELL_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source shell/browser and Windows native process evidence only; it cannot establish native button-by-button accessibility, NVDA/High Contrast/scaling/IME, physical HDMI/DMX/MIDI output, external devices, real two-machine operation, venue, signing, publication, or H3-H5 completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-UI-H1-REACHABILITY-SW-2026-09-13", "scope": "Current-source Control Video reachability, full Video Control surface, reactive ISF busy propagation, browser viewport/locale acceptance, and Windows native process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:vj-operator && pnpm.cmd --dir app run check:frontend-invokes && pnpm.cmd --dir app run check:frontend-command-routing && pnpm.cmd --dir app run check:empty-states && pnpm.cmd --dir app build && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 8, "ignored_count": 0, "warning_count": 0, "artifact_hash": "38C4E36E28522CCB3D5E458ED55196EB820560945D17670E8B1D2B71C8B5E43D", "artifact_na_reason": null, "raw_evidence_paths": ["qa/UI_H1_REACHABILITY_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software, browser viewport/locale, and Windows native process evidence only; it cannot establish native button-by-button accessibility, physical HDMI/output, external devices, venue operation, or H2-H5 completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-AUDIO-AUTHORED-SW-2026-09-13", "scope": "Current-source authored Timeline audio policy schema/migration, ShowClock PTS/resync, deterministic seek/loop/transport, fail-closed underrun/device-fault software, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:timeline-cue-audio && pnpm.cmd --dir app run check:timeline-audio-output-bus && pnpm.cmd --dir app run check:timeline-loop-runtime && pnpm.cmd --dir app run check:timeline-transport-runtime && cargo test -p protocol --release --locked -j 1 timeline_audio_policy -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 timeline_audio -- --nocapture --test-threads=1 && cargo test -p engine --release --locked -j 1 timeline_fractional_ticks -- --nocapture --test-threads=1 && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 7, "ignored_count": 0, "warning_count": 0, "artifact_hash": "0A10CFDFC49C543F3B9AD0792BA9BE3D52A32F3CF7C6F8EA30D1E8515D51AED5", "artifact_na_reason": null, "raw_evidence_paths": ["qa/AUDIO_AUTHORED_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source protocol/engine/Tauri/frontend and Windows native build/process-smoke evidence only; it does not establish real audio devices, physical audible output, long-duration/venue, recording integration, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-AUDIO-AUTHORED-001"] },
    { "id": "EV-MEDIA-DERIVED-SW-2026-09-13", "scope": "Current-source media-derived identity/cache/work-admission policy plus deterministic thumbnail, audio-analysis, video-prefetch, and frame-cache software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:media-thumbnails && pnpm.cmd --dir app run check:media-asset-operations && pnpm.cmd --dir app run check:media-asset-authority && pnpm.cmd --dir app run check:native-thumbnail-request && pnpm.cmd --dir app run check:bundled-library && pnpm.cmd --dir app run check:vj-first-run && node app/scripts/check-vj-media-import-access.mjs && cargo test -p engine --release --locked -j 1 media_derived -- --nocapture --test-threads=1 && cargo test -p audio --release --locked -j 1 -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 prefetch -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 ffmpeg_cli_decoder_ -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 still_image_cache_ -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 53, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and Rust tests have no shipped artifact; the exact source, current Windows MSVC procedure, commands, results, and boundaries are recorded in the linked checkpoint.", "raw_evidence_paths": ["qa/MEDIA_DERIVED_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish a complete proxy/transcode artifact pipeline, general derived-data UI, hard-stop decoder/OS-I/O/GPU cancellation, cold/warm workload budgets, MP4 missing-file recovery, native renderer/GPU/display, physical or audible devices, external clients/clocks, venue/soak, cross-platform execution, signing, publication, or product-wide media acceptance.", "linked_q1_ids": ["COV-MEDIA-DERIVED-001"] },
    ...
    { "id": "EV-DJ-LINK-SETUP-SW-2026-09-13", "scope": "Current-source DJ Link Setup: exact wired Show-LAN binding, machine-local Credential Manager token arm/rotate/disarm, listener/session diagnostics, Track-to-Timeline mapping policy/CAS dispatch, disconnect/replacement fencing, focused Setup I/O browser reachability, and Windows native process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:dj-link && node app/scripts/check-viewport-containment.mjs --setup-io-only && cmd.exe /d /s /c call vcvars64.bat -vcvars_ver=14.44 with the exact Build Tools 14.44.35207 linker && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 dj_link -- --nocapture --test-threads=1 && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 120, "ignored_count": 1, "warning_count": 0, "artifact_hash": "38C4E36E28522CCB3D5E458ED55196EB820560945D17670E8B1D2B71C8B5E43D", "artifact_na_reason": null, "raw_evidence_paths": ["qa/DJ_LINK_SETUP_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software, focused rendered-browser, and Windows native process evidence only; it cannot establish a real wired DJ-PC/Agent, rekordbox Master Track, Stream Deck/Pedal, MIDI/TouchOSC client, LAN/reconnect, physical output, venue/soak, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-REMOTE-TOUCH-001"] },
    { "id": "EV-UI-H4-EDIT-SW-2026-09-13", "scope": "Current-source H4 Edit Media/Video Control, Timeline authoring and persistence, scoped FX, Stage labels, rendered-browser viewport contracts, focused Rust release regressions, and Windows native process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:edit-video-fx && pnpm.cmd --dir app run check:edit-ia-video && pnpm.cmd --dir app run check:timeline-advanced && pnpm.cmd --dir app run check:timeline-follow-runtime && pnpm.cmd --dir app run check:timeline-follow-hold-ui && pnpm.cmd --dir app run check:timeline-loop-runtime && pnpm.cmd --dir app run check:timeline-transport-runtime && pnpm.cmd --dir app run check:timeline-cue-audio && pnpm.cmd --dir app run check:timeline-audio-output-bus && pnpm.cmd --dir app run check:timeline-snap && pnpm.cmd --dir app run check:timeline-source-shelf && pnpm.cmd --dir app run check:timeline-layered && pnpm.cmd --dir app run check:timeline-viewport && pnpm.cmd --dir app run check:fx-visual && pnpm.cmd --dir app run check:fx-palettes && pnpm.cmd --dir app run check:stage-labels && pnpm.cmd --dir app run check:media-thumbnails && pnpm.cmd --dir app run check:media-asset-operations && pnpm.cmd --dir app run check:media-asset-authority && pnpm.cmd --dir app run check:project-transaction && pnpm.cmd --dir app run check:project-authority && pnpm.cmd --dir app run check:project-storage && pnpm.cmd --dir app run check:project-recovery-e3 && pnpm.cmd --dir app run check:project-publication-e4 && pnpm.cmd --dir app run check:project-open-bootstrap && pnpm.cmd --dir app run check:project-shortcuts && cargo test -p engine --release --locked -j 1 timeline_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_ -- --nocapture --test-threads=1 && pnpm.cmd --dir app build && pnpm.cmd --dir app run check:frontend-invokes && pnpm.cmd --dir app run check:frontend-command-routing && pnpm.cmd --dir app run check:empty-states && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 372, "ignored_count": 3, "warning_count": 1, "artifact_hash": "853303B90C95195877B6B215B4496D5CAC0C3BD4CAFCDBD44D43EF7B5936B2C9", "artifact_na_reason": null, "raw_evidence_paths": ["qa/UI_H4_EDIT_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source Edit software, rendered-browser, focused Rust release, and Windows native process-smoke evidence only; it cannot establish native accessibility matrix, physical or external devices, two-machine/venue/soak, cross-platform, security/release, or product-wide acceptance.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-MEDIA-T1-001", "COV-MEDIA-DERIVED-001", "COV-VIDEO-SLOT-001", "COV-VIDEO-FX-001", "COV-PROJECT-TX-001", "COV-STAGE-001", "COV-TIMELINE-MUSICAL-001"] },
    ...
    { "id": "EV-PERFORMANCE-STATIC-2026-09-12", "scope": "Current-main virtualized large-show bounds and deterministic Timeline viewport software boundaries", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "node app/scripts/check-virtualization.mjs && node app/scripts/check-timeline-viewport.mjs", "exit_code": 0, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks have no shipped binary artifact; the exact source base, commands, and result are recorded in the linked QA document.", "raw_evidence_paths": ["qa/PERFORMANCE_STATIC_BOUNDARY_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software boundary evidence only; it cannot establish whole-product performance budgets, browser/native frame timing, resource ceilings, or venue-soak acceptance.", "linked_q1_ids": ["COV-PERFORMANCE-001"] },
    { "id": "EV-PERFORMANCE-SNAPSHOT-2026-09-12", "scope": "Current-main isolated snapshot construction, serialization, reader-width, and writer-contention benchmark", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "cargo test -p engine --release --locked benchmark_show_ -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 5, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "This is an engine test benchmark with no shipped binary artifact; source HEAD, fixture identity, toolchain, command, and raw medians are recorded in the linked QA document.", "raw_evidence_paths": ["qa/SNAPSHOT_PERFORMANCE_CURRENT_MAIN_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source isolated benchmark evidence only; it cannot establish whole-product latency/frame/resource budgets, native-window behavior, app FPS, hardware, physical output, or venue-soak acceptance.", "linked_q1_ids": ["COV-PERFORMANCE-001"] },
    { "id": "EV-NATIVE-THUMBNAIL-CANCEL-2026-09-12", "scope": "Current-main native thumbnail layer/asset cancellation, startup ownership, snapshot, and cleanup probe", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File target/qa/native-thumbnail-cancel-20260912-02/native-thumbnail-cancel.ps1", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": "144CD12F9B247575DE4E40FC966BEA703D74206B159C736AFA5A6FE66957C9E3", "artifact_na_reason": null, "raw_evidence_paths": ["qa/THUMBNAIL_NATIVE_CANCELLATION_CURRENT_MAIN_2026-09-12.md"], "currency_nonclaim": "Current-source native cancellation evidence only; it cannot establish missing-file recovery, hard-stop synchronous cancellation, device/hardware, venue, cross-platform, signing, publication, or product completion.", "linked_q1_ids": ["COV-MEDIA-DERIVED-001"] },
    { "id": "EV-RELEASE-SOFTWARE-2026-09-12", "scope": "Current-main release metadata, warning ratchet, artifact self-test, and build-wrapper software gates", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:release && pnpm.cmd --dir app run check:release:self-test && pnpm.cmd --dir app run check:warnings -- --configuration windows-native-release && pnpm.cmd --dir app run check:warnings:self-test && pnpm.cmd --dir app run check:tauri-build-wrapper", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": "144CD12F9B247575DE4E40FC966BEA703D74206B159C736AFA5A6FE66957C9E3", "artifact_na_reason": null, "raw_evidence_paths": ["qa/RELEASE_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software/release gate evidence only; it cannot establish signed or published artifacts, legal/distribution acceptance, clean-machine installation, updater service, hardware, physical output, or product completion.", "linked_q1_ids": ["COV-RELEASE-001"] }
    ,{ "id": "EV-OBSERVABILITY-SOFTWARE-2026-09-12", "scope": "Current-main status truth, diagnostics/redaction, updater identity, and release artifact negative software gates", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:status && pnpm.cmd --dir app run check:bundled-library && pnpm.cmd --dir app run check:strict-json && node app/scripts/check-windows-release-artifacts.mjs --self-test && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 diagnostic_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 updater_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement_is_redacted -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 10, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Software tests have no shipped artifact; current source, toolchain, commands, and no-external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/OBSERVABILITY_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it does not establish deployed support runbooks, live signed update endpoints, clean-machine install, physical/device, signing/publication, or product completion.", "linked_q1_ids": ["COV-OBSERVABILITY-001"] }
    ,{ "id": "EV-VIDEO-SOURCE-SW-2026-09-12", "scope": "Current-main video source identity, output-window runtime, observation, and Bank/Scene source-shelf software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:camera-input && pnpm.cmd --dir app run check:video-output-window-runtime && pnpm.cmd --dir app run check:video-output-window-observation && node app/scripts/check-timeline-source-shelf-contract.mjs", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks have no shipped binary artifact; the exact source base, commands, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/VIDEO_SOURCE_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish camera/capture/NDI/Spout/Syphon availability, permission, reconnect, native-window, physical-device, or one-hour matrix acceptance.", "linked_q1_ids": ["COV-VIDEO-SOURCE-001"] },
    { "id": "EV-VIDEO-SOURCE-LIVE-2026-09-13", "scope": "Current-source live video identity/generation, explicit source state and fault reporting, input worker retirement, frontend fault visibility, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "cargo test -p video --release --locked -j 1 live_source -- --nocapture --test-threads=1 && cargo test -p video --release --locked -j 1 external_video -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 \"external_video\" -- --nocapture --test-threads=1 && pnpm.cmd --dir app run check:camera-input && pnpm.cmd --dir app run check:video-output-window-runtime && pnpm.cmd --dir app run check:video-output-window-observation && node app/scripts/check-timeline-source-shelf-contract.mjs && pnpm.cmd --dir app build && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 19, "ignored_count": 0, "warning_count": 0, "artifact_hash": "3EF1495441806FA326F8FD1AD60E41FD4717CDDB5F2350A081D41BE0DF91FEBE", "artifact_na_reason": null, "raw_evidence_paths": ["qa/VIDEO_LIVE_SOURCES_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software and Windows native process evidence only; it cannot establish real camera/capture devices, permission dialogs, NDI/Spout/Syphon peer interoperability, standalone generator input, GPU interop, reconnect timing, one-hour/venue operation, recording integration, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-VIDEO-SOURCE-001"] },
    { "id": "EV-VIDEO-SLOT-SW-2026-09-12", "scope": "Current-main Clip Slot/Follow model, polling, routing, and engine gate software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "node app/scripts/check-video-clip-slot-bank.mjs && pnpm.cmd --dir app run check:timeline-follow-runtime && pnpm.cmd --dir app run check:timeline-follow-hold-ui && pnpm.cmd --dir app run check:video-runtime-polling && pnpm.cmd --dir app run check:video-output-routing-runtime && cargo test -p engine --release --locked -j 1 video_full_gate_engine_path -- --test-threads=1 && cargo test -p engine --release --locked -j 1 video_sample_clip_take_queue -- --test-threads=1 && cargo test -p engine --release --locked -j 1 video_sample_follow_admission -- --test-threads=1", "exit_code": 0, "assertion_count": 8, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and engine tests have no shipped binary artifact; the exact source base, MSVC linker, commands, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/VIDEO_SLOT_FX_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish browser, native UI, GPU, 4K, multi-display, physical output, venue, or full C2/C4 integration acceptance.", "linked_q1_ids": ["COV-VIDEO-SLOT-001"] },
    { "id": "EV-VIDEO-FX-SW-2026-09-12", "scope": "Current-main authored FX, draft helpers, value generator, cue recall, visualization, palettes, and typed transition-bus software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "node app/scripts/check-authored-effect-enable.mjs && node app/scripts/check-effect-draft-helpers.mjs && node app/scripts/check-value-effect-generator.mjs && node app/scripts/check-cue-effect-recall.mjs && pnpm.cmd --dir app run check:fx-visual && pnpm.cmd --dir app run check:fx-palettes && cargo test -p engine --release --locked -j 1 video_transition_bus_c3_is_typed -- --test-threads=1", "exit_code": 0, "assertion_count": 7, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and engine tests have no shipped binary artifact; the exact source base, MSVC linker, commands, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/VIDEO_SLOT_FX_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish Transition Bus completion, GPU/native rendering, hardware, physical output, venue, or full C2/C4 integration acceptance.", "linked_q1_ids": ["COV-VIDEO-FX-001"] },
    { "id": "EV-AUDIO-AUTHORED-SW-2026-09-12", "scope": "Current-main authored Timeline audio cue, output bus, loop/transport, and fractional-tick software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:timeline-cue-audio && pnpm.cmd --dir app run check:timeline-audio-output-bus && pnpm.cmd --dir app run check:timeline-loop-runtime && pnpm.cmd --dir app run check:timeline-transport-runtime && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 timeline_audio -- --test-threads=1 && cargo test -p engine --release --locked -j 1 timeline_fractional_ticks -- --test-threads=1", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and Rust tests have no shipped binary artifact; the exact source base, MSVC linker, commands, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/AUDIO_AUTHORED_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish authored-audio migration, real audio-device behavior, physical output, long-duration, or venue acceptance.", "linked_q1_ids": ["COV-AUDIO-AUTHORED-001"] },
    { "id": "EV-RECORDING-SW-2026-09-12", "scope": "Current-main recording publication/recovery, diagnostics, lifecycle, renderer framing, and failure-boundary software tests", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 recording_ -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 60, "ignored_count": 6, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic recording software tests have no shipped binary artifact; the exact source base, MSVC linker, command, ignored boundary, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/RECORDING_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish real H.264/AAC codec acceptance on this checkout, in-app/native recording UI, disk-full/power-loss, two-PC ownership, long-duration A/V, device, venue, signing, or publication acceptance.", "linked_q1_ids": ["COV-RECORDING-001"] },
    { "id": "EV-RECORDING-SW-2026-09-13", "scope": "Current-source recording lifecycle enum, publication/recovery, worker ownership, status-bar bridge/UI, browser DOM observation, and Windows native process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 recording_ -- --nocapture --test-threads=1 && pnpm.cmd --dir app build && pnpm.cmd --dir app run check:agent-bridge && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 61, "ignored_count": 6, "warning_count": 0, "artifact_hash": "BEF911C6D3BF83362504AC466B01459314A02F04D5073E3C158302BBE2CD4A21", "artifact_na_reason": null, "raw_evidence_paths": ["qa/RECORDING_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software, browser DOM, and Windows native process evidence only; it cannot establish real H.264/AAC codec acceptance, disk-full/power-loss recovery, authoritative asset import, two-PC ownership, encoder hardware, native in-app recording interaction beyond process smoke, device, venue, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-RECORDING-001"] },
    { "id": "EV-PROJECT-AUTHORITY-SW-2026-09-12", "scope": "Current-main project transaction and mutation-controller software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:project-transaction && node app/scripts/check-project-transaction-mutation-controller.mjs", "exit_code": 0, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks have no shipped binary artifact; the exact source base, commands, results, and no-native/UI-side-effect boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/STAGE_PROJECT_AUTHORITY_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it does not claim the frozen project-authority re-audit, native UI, external client, physical output, or product-wide acceptance.", "linked_q1_ids": ["COV-PROJECT-AUTH-001"] },
    { "id": "EV-UI-SHELL-SW-2026-09-12", "scope": "Current-main UI shell routing, invoke inventory, window mode, localization, keyboard, pane, shortcut, operator, and label software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:frontend-command-routing && pnpm.cmd --dir app run check:frontend-invokes && pnpm.cmd --dir app run check:desktop-window && pnpm.cmd --dir app run check:localization && pnpm.cmd --dir app run check:terminology && pnpm.cmd --dir app run check:tauri-build-wrapper && pnpm.cmd --dir app run check:empty-states && pnpm.cmd --dir app run check:project-shortcuts && pnpm.cmd --dir app run check:workspace-operator && node app/scripts/check-pane-window-lifecycle.mjs && node app/scripts/check-project-history-keyboard.mjs && node app/scripts/check-timeline-space-keyboard.mjs && pnpm.cmd --dir app run check:stage-labels", "exit_code": 0, "assertion_count": 13, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks have no shipped binary artifact; the exact source base, commands, results, and native/viewport nonclaim are recorded in the linked QA document.", "raw_evidence_paths": ["qa/UI_SHELL_ACCESSIBILITY_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish native three-screen layout, viewport/scaling, screen-reader/high-contrast/IME behavior, native keyboard-only acceptance, physical output, or product-wide acceptance.", "linked_q1_ids": ["COV-UI-SHELL-001"] },
    { "id": "EV-ACCESSIBILITY-SW-2026-09-12", "scope": "Current-main localization, terminology, empty-state, keyboard, and stage-label accessibility-related software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:localization && pnpm.cmd --dir app run check:terminology && pnpm.cmd --dir app run check:empty-states && node app/scripts/check-project-history-keyboard.mjs && node app/scripts/check-timeline-space-keyboard.mjs && pnpm.cmd --dir app run check:stage-labels", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks have no shipped binary artifact; the exact source base, commands, results, and native accessibility nonclaim are recorded in the linked QA document.", "raw_evidence_paths": ["qa/UI_SHELL_ACCESSIBILITY_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish native screen-reader, High Contrast, color-independent presentation, DPI scaling, IME, reduced-motion, focus-return, native keyboard-only, physical output, or product-wide acceptance.", "linked_q1_ids": ["COV-ACCESSIBILITY-001"] },
    { "id": "EV-ACCESSIBILITY-CURRENT-SW-2026-09-14", "scope": "Current-source accessibility-related contracts after H5: Japanese localization coverage, terminology, empty-state guidance, project-history keyboard routing, Timeline Space routing, stage-label layout, TypeScript, and frontend build", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "pnpm.cmd --dir app run check:localization; pnpm.cmd --dir app run check:terminology; pnpm.cmd --dir app run check:empty-states; node app/scripts/check-project-history-keyboard.mjs; node app/scripts/check-timeline-space-keyboard.mjs; pnpm.cmd --dir app run check:stage-labels; pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run build", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source static checks and frontend build produce no separately accepted native/public artifact; native accessibility and external-environment proof remain open and are recorded in the linked QA document.", "raw_evidence_paths": ["qa/ACCESSIBILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M5_RELIABILITY_VALIDATION.md"], "currency_nonclaim": "Current-source localization, keyboard, label, TypeScript, and build evidence only; it does not establish NVDA, High Contrast, color-independent state, DPI scaling, IME, native focus, reduced motion, physical/external devices, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-ACCESSIBILITY-001"] },
    { "id": "EV-PATCH-GDTF-SW-2026-09-12", "scope": "Current-main PATCH/Repair, fixture catalog/profile, GDTF, DMX addressing, and allocator/repair rollback software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:patch-transaction-d2 && pnpm.cmd --dir app run check:fixture-catalog && pnpm.cmd --dir app run check:patch-profile-counts && pnpm.cmd --dir app run check:profile-library && pnpm.cmd --dir app run check:gdtf-profile-actions && pnpm.cmd --dir app run check:fixture-live-color && pnpm.cmd --dir app run check:fixture-limits-degrees && pnpm.cmd --dir app run check:dmx-addressing && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 d2_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 patch_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 gdtf_ -- --nocapture --test-threads=1 && cargo test -p engine --release --locked -j 1 fixture_patch_ -- --test-threads=1 && cargo test -p engine --release --locked -j 1 fixture_profile_repair_ -- --test-threads=1 && cargo test -p gdtf --release --locked -j 1 -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 14, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and Rust tests have no shipped binary artifact; the exact source base, MSVC linker, commands, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/PATCH_GDTF_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish real fixtures, physical DMX/output, native UI, D-lane completion, visual comparator parity, venue, or product-wide acceptance.", "linked_q1_ids": ["COV-PATCH-GDTF-001"] },
    { "id": "EV-RECOVERY-SAVE-SW-2026-09-12", "scope": "Current-main project recovery, publication, storage, history preflight, and keyboard software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:project-recovery-e3 && pnpm.cmd --dir app run check:project-publication-e4 && pnpm.cmd --dir app run check:project-storage && node app/scripts/check-project-history-preflight.mjs && node app/scripts/check-project-history-keyboard.mjs", "exit_code": 0, "assertion_count": 5, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks have no shipped binary artifact; the exact source base, commands, and recovery boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/PROJECT_PUBLICATION_RESTART_RECOVERY_2026-09-05.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish native launch, power/disk-fault matrices, upgrade compatibility, cross-platform identity, external endpoint, physical output, or product-wide recovery acceptance.", "linked_q1_ids": ["COV-RECOVERY-SAVE-001"] },
    { "id": "EV-MIGRATION-SW-2026-09-12", "scope": "Current-main project-file validation, recovery/publication state, bootstrap, transaction recovery, strict JSON, and migration software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:project-storage && pnpm.cmd --dir app run check:project-transaction && pnpm.cmd --dir app run check:project-recovery-e3 && pnpm.cmd --dir app run check:project-publication-e4 && pnpm.cmd --dir app run check:project-open-bootstrap && node app/scripts/check-project-history-preflight.mjs && node app/scripts/check-project-history-keyboard.mjs && node app/scripts/check-project-transaction-recovery-controller.mjs && pnpm.cmd --dir app run check:strict-json && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_file_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_recovery_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_publication_ -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 12, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and Rust tests have no shipped binary artifact; the exact source base, MSVC linker, commands, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/MIGRATION_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish supported upgrade/downgrade machine rehearsals, hostile-input fuzz breadth, cross-platform file identity, external endpoint, physical output, or product-wide acceptance.", "linked_q1_ids": ["COV-MIGRATION-001"] },
    { "id": "EV-INPUT-SW-2026-09-12", "scope": "Current-main MIDI/DMX input shortcut, show-setup, addressing, command-routing, and narrow-reader software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:dvc-midi-shortcuts && node app/scripts/check-dvc-dmx-shortcuts.mjs && node app/scripts/check-dmx-show-setup.mjs && node app/scripts/check-dmx-addressing-helpers.mjs && pnpm.cmd --dir app run check:frontend-command-routing && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 midi_feedback_route_uses_the_narrow_engine_reader -- --test-threads=1", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and one focused Rust test have no shipped binary artifact; the exact source base, MSVC linker, commands, and no-physical-device boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/F1_INPUT_GENERATION_AUDIT_2026-09-08.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish physical MIDI/OSC/DMX/Remote clients, reconnect/latency matrices, native device behavior, venue, Mac, signing, or publication acceptance.", "linked_q1_ids": ["COV-INPUT-001"] },
    { "id": "EV-AUDIO-LIVE-SW-2026-09-12", "scope": "Current-main live-audio lifecycle, IPC, ASIO packaging/contract, input fail-closed tests, TTL expiry, and unverified legacy rejection", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:live-audio && pnpm.cmd --dir app run check:live-audio-ipc-v1 && pnpm.cmd --dir app run check:asio-packaging && pnpm.cmd --dir app run check:asio-v3-contract && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 live_audio_input_tests -- --test-threads=1 && cargo test -p engine --release --locked -j 1 live_audio_spectrum_expires_inside_the_engine_at_the_ttl_boundary -- --test-threads=1 && cargo test -p engine --release --locked -j 1 unverified_legacy_live_audio_cannot_drive_node_graph -- --test-threads=1", "exit_code": 0, "assertion_count": 7, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and Rust tests have no shipped binary artifact; the exact source base, MSVC linker, commands, and no-device boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/AUDIO_LIVE_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish final ASIO DLL/native loading, license/artifact decision, device fault/XRUN matrices, one-hour soak, physical latency, TouchDesigner parity, browser, venue, or product-wide acceptance.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-OUTPUT-LOCAL-SW-2026-09-12", "scope": "Current-main output ownership, control/blackout, video routing/window observation, Spout retirement, and managed-display software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:output-ownership && pnpm.cmd --dir app run check:output-control-runtime && pnpm.cmd --dir app run check:safety-blackout-runtime && pnpm.cmd --dir app run check:video-output-routing-runtime && pnpm.cmd --dir app run check:video-output-window-runtime && pnpm.cmd --dir app run check:video-output-window-observation && cargo test -p engine --release --locked -j 1 output_ownership -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 output_ownership -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 show_spout_managed_terminal -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_retirement_spout -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_retirement_callback_failure -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 show_spout_disabled_activation -- --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 managed_display_window_projection -- --test-threads=1", "exit_code": 0, "assertion_count": 13, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and Rust tests have no shipped binary artifact; the exact source base, MSVC linker, commands, and no-physical-output boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/OUTPUT_DIAGNOSTICS_AUTHORITY_REVALIDATION_2026-09-11.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish DMX/NDI/Spout/display hardware, physical output, external clients, distributed/venue, or product-wide acceptance.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] }
    ,{ "id": "EV-TIMELINE-MUSICAL-SW-2026-09-12", "scope": "Current-main Timeline/Musical deterministic scheduler, follow/hold, cue-audio, loop, transport, and fractional-tick software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:timeline-advanced && node app/scripts/check-timeline-navigator-actions.mjs && pnpm.cmd --dir app run check:timeline-automation && node app/scripts/check-timeline-overlap-clusters.mjs && node app/scripts/check-timeline-block-loop.mjs && pnpm.cmd --dir app run check:timeline-follow-runtime && pnpm.cmd --dir app run check:timeline-follow-hold-ui && pnpm.cmd --dir app run check:timeline-cue-audio && pnpm.cmd --dir app run check:timeline-loop-runtime && pnpm.cmd --dir app run check:timeline-transport-runtime && cargo test -p engine --release --locked -j 1 timeline_fractional_ticks -- --test-threads=1", "exit_code": 0, "assertion_count": 11, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source checks and six focused engine tests have no shipped binary artifact; the exact current-main source base, MSVC linker procedure, commands, results, and non-native boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/TIMELINE_MUSICAL_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish audible devices, native A/V/Lighting synchronization, external clocks, browser acceptance, venue acceptance, or product-wide acceptance.", "linked_q1_ids": ["COV-TIMELINE-MUSICAL-001"] }
    ...
    ,{ "id": "EV-MEDIA-T1-SW-2026-09-12", "scope": "Current-main Media T1 authority, VJ first-run/import access, backend operator, and project transaction software contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app run check:media-asset-authority && node app/scripts/check-vj-first-run.mjs && node app/scripts/check-vj-media-import-access.mjs && pnpm.cmd --dir app run check:backend-operator-contract && pnpm.cmd --dir app run check:project-transaction", "exit_code": 0, "assertion_count": 5, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Deterministic source/policy checks have no shipped binary artifact; the exact current-main source base, commands, results, and non-browser/native boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/MEDIA_T1_SOFTWARE_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "Current-source software evidence only; it cannot establish cross-platform media safety, real media-corpus behavior, browser/native rendered reachability, or product-wide acceptance.", "linked_q1_ids": ["COV-MEDIA-T1-001"] }
    ,{ "id": "EV-OUTPUT-PHYSICAL-DMX-2026-09-12", "scope": "Current-host FTDI COM5 Enttec Open DMX serial worker and operator-confirmed fixture output", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; SYNDOCAL_PHYSICAL_SERIAL=COM5; SYNDOCAL_PHYSICAL_SECONDS=10; SYNDOCAL_PHYSICAL_MASTER=20; cargo test -p engine --locked physical_serial_rainbow_demo_drives_master_dimmer_and_rgb_cells -- --ignored --nocapture", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The current physical serial-DMX slice has no shipped binary artifact; exact source, port identity, toolchain, command, telemetry, and operator result are recorded in the linked QA document.", "raw_evidence_paths": ["qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is only a current serial-DMX port/worker and operator-confirmed fixture slice; it does not constitute current-source acceptance of long-run timing/waveform, RDM/TOD, Art-Net/sACN, NDI/Spout/display, ownership replacement, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-OUTPUT-PHYSICAL-DMX-2026-09-15", "scope": "Current-host FTDI COM5 serial-DMX transport worker telemetry at bounded master/seconds settings", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; SYNDOCAL_PHYSICAL_SERIAL=COM5; SYNDOCAL_PHYSICAL_SECONDS=10; SYNDOCAL_PHYSICAL_MASTER=20; cargo test -p engine --locked physical_serial_rainbow_demo_drives_master_dimmer_and_rgb_cells -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The current physical serial-DMX recheck has no separately shipped artifact; exact source, port identity, toolchain, command, telemetry, and absence of operator visual confirmation are recorded in the linked M4 QA document.", "raw_evidence_paths": ["qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This current-source serial-DMX transport telemetry does not establish operator-confirmed fixture output, long-run timing/waveform, RDM/TOD, Art-Net/sACN, NDI/Spout/display, ownership replacement, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] }
    ,{ "id": "EV-INPUT-PHYSICAL-MIDI-2026-09-12", "scope": "Current-host physical SMC-Mixer MIDI enumerate/open and safe feedback send", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_OUTPUT=SMC-Mixer; cargo test -p io --locked physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The safe physical MIDI slice has no shipped binary artifact; exact current source, device names, toolchain, command, and result are recorded in the linked QA document.", "raw_evidence_paths": ["qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is only a physical MIDI enumerate/open/safe-feedback slice and does not constitute current-source acceptance of controller movement, LED observation, clock/MTC, latency, OSC/Remote, DMX, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-INPUT-001"] },
    { "id": "EV-SHOWCLOCK-PROTOCOL-SW-2026-09-12", "scope": "Current-main ShowClock v1 authenticated sample/action admission, typed kind-bound action payloads, initial-arm confirmation, Manual Hold/Re-arm protocol core, atomic peer/estimator admission, explicit canonical wire tags, and session-monotonic action sequence admission", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p protocol --locked -- --test-threads=1", "exit_code": 0, "assertion_count": 249, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Pure protocol tests have no shipped binary artifact; the current source, lockfile, command, and results are recorded in the linked QA document.", "raw_evidence_paths": ["qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is current-source protocol evidence only; it does not constitute current-source acceptance of LAN discovery/pairing, clock estimator accuracy, native output authority, physical devices, automatic failover, partition/rejoin, two-machine soak, or venue acceptance.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] }
    ,{ "id": "EV-SHOWCLOCK-ENGINE-CONTINUITY-SW-2026-09-12", "scope": "Current-main Engine BpmClock absolute beat-position continuity across 24 PPQN MIDI pulses and phase-only external resync, plus queued Clip Take generation/hold regression", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; cargo test -p engine --locked bpm_clock -- --nocapture --test-threads=1; cargo test -p engine --locked video_clip_slot_quantization_uses_global_beats_and_holds_discontinuity -- --nocapture --test-threads=1; cargo test -p engine --locked -- --test-threads=1", "exit_code": 0, "assertion_count": 1086, "ignored_count": 14, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source Rust tests have no shipped binary artifact; the exact source, pinned Windows toolchain/linker procedure, commands, results, and external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/ENGINE_CLOCK_CONTINUITY_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is only current-source Engine software evidence; it does not constitute estimator/bounded-slew/Hold/STALE acceptance, LAN, native-window, physical device, two-process, two-machine, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
    { "id": "EV-SHOWCLOCK-RUNTIME-LAN-SW-2026-09-12", "scope": "Current-main ShowClock deterministic estimator with bounded slew, expiry-derived STALE/Hold/Re-arm, bounded action scheduling with session-monotonic sequence admission, all-domain output-generation gate, exact-peer signed UDP loopback transport, and atomic peer/estimator admission", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; cargo test -p protocol --locked show_clock -- --nocapture --test-threads=1; cargo test -p io --locked show_clock_lan -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 23, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source protocol/IO tests have no shipped binary artifact; exact sources, pinned Windows linker, commands, results, and loopback-only boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is current-source and loopback software evidence only; it does not constitute Tauri IPC/UI wiring, physical output, restart replay restoration, real wired two-machine partition/rejoin, witness/interlock, automatic failover, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] }
    ,{ "id": "EV-SHOWCLOCK-IPC-UI-2PROC-SW-2026-09-12", "scope": "Current-main ShowClock process-owned Primary/Standby Tauri IPC lifecycle, typed kind-bound action IPC, explicit local output arm, local lighting dispatcher and per-operation video ownership, fixed-capacity generation-bound scheduling, Manual Hold/Re-arm, STALE/FAULT permit revocation, exact-peer two-process sample loopback, stale-on-primary-loss, session-incarnation fence, Setup/IO UI wiring, status-driven monotonic action-sequence recovery including duplicate-admission floor preservation, generation-reset action-status clearing, panic-safe two-process child reaping, and native release/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; cargo test --manifest-path app/src-tauri/Cargo.toml --locked show_clock_ipc::tests -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --locked control_plane::tests -- --nocapture --test-threads=1; cargo test -p io --locked --test show_clock_two_process -- --nocapture --test-threads=1; pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run build; pnpm.cmd --dir app run check:frontend-invokes; pnpm.cmd --dir app run check:frontend-command-routing; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 47, "ignored_count": 0, "warning_count": 0, "artifact_hash": "963EFCAF7F53D9E9E14A0AC6D3B7CFA6819CA56E096F90D6309AD2CC1A356EF4", "artifact_na_reason": "The native release build produces the current checkout executable; this hash is the exact current-source process-smoke binary and is not a signed or published release artifact.", "raw_evidence_paths": ["qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md", "qa/LUNA_SHOWCLOCK_REVIEW_HANDOFF_2026-09-12.md"], "currency_nonclaim": "Current-source ShowClock action/fence IPC/UI, software output arm and dispatcher, two-process loopback, and Windows native build/process-smoke evidence only; it does not constitute native UI interaction matrix, physical output, restart replay restoration, real wired two-machine partition/rejoin, witness/interlock, automatic failover, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] }
    ,{ "id": "EV-INPUT-DMX-TIMEOUT-SW-2026-09-12", "scope": "Current-source Art-Net input timeout liveness under unrelated-universe and malformed loopback traffic, single SignalLost emission, and valid recovery", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "MSVC 14.44.35207 x64; cargo test -p io --locked dmx_input::tests -- --nocapture --test-threads=1; cargo test -p io --locked -- --test-threads=1", "exit_code": 0, "assertion_count": 181, "ignored_count": 3, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source IO tests have no shipped binary artifact; the exact source, pinned Windows toolchain/linker procedure, commands, results, and external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/DMX_INPUT_TIMEOUT_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is only current-source IO software evidence; it does not constitute physical DMX or external Art-Net-node acceptance, native-window, LAN, two-process, two-machine, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-INPUT-001"] }
    ,{ "id": "EV-INPUT-FRONTEND-AUTHORITY-SW-2026-09-12", "scope": "Current-source frontend MIDI/OSC authority lifecycle across trusted mapping flush, own ACK Learn continuation, stale replacement rejection, and fail-closed Connect/Start/Feedback routes", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-12", "command": "pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run check:project-transaction; pnpm.cmd --dir app run check:frontend-command-routing; pnpm.cmd --dir app build; MSVC 14.44.35207 x64; pnpm.cmd --dir app tauri build --no-bundle", "exit_code": 0, "assertion_count": 5, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source frontend checks and the native no-bundle build produce no separately retained product artifact for this evidence row; the exact source, commands, native build result, process/window smoke boundary, and external boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/FRONTEND_INPUT_AUTHORITY_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is only current-source frontend plus Windows native-build/process-smoke evidence; it does not constitute physical MIDI/OSC, controller movement, LED/clock/MTC, latency, external LAN, two-process, two-machine, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-INPUT-001"] }
    ,{ "id": "EV-INPUT-PHYSICAL-MIDI-LED-2026-09-12", "scope": "Current-host SMC-Mixer direct WinMM channel-1 LED point-light on/off across three cycles", "kind": "historical-evidence", "status": "accepted-historical", "date": "2026-09-12", "command": "Windows WinMM; Python ctypes; SMC-Mixer output index 2; channel-1 Note On notes 0/8/16/24; three 2-second-on/1-second-off cycles", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "A direct device check has no shipped software artifact; the exact device, sequence, timing, user observation, and boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/M4_IO_VALIDATION.md", "qa/LUNA_SHOWCLOCK_REVIEW_HANDOFF_2026-09-12.md"], "currency_nonclaim": "This external observation does not constitute current-source acceptance, Syndocal auto-feedback/native UI, controller movement, MIDI Clock/MTC, latency, OSC/Remote, DMX, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-INPUT-001"] }
    ,{ "id": "EV-TIMELINE-FOLLOW-SW-2026-09-13", "scope": "Current-source Timeline Follow admission, crossfade/BPM slew, Hold/Cut/Fault policy, Trans/Complete Guide, settlement, abort/replay fencing, persisted controls, and rendered-browser operator surfaces", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "pnpm.cmd --dir app run check:timeline-follow-runtime && pnpm.cmd --dir app run check:timeline-follow-hold-ui && pnpm.cmd --dir app run check:timeline-advanced && pnpm.cmd --dir app run check:timeline-cue-audio && pnpm.cmd --dir app run check:timeline-loop-runtime && pnpm.cmd --dir app run check:timeline-transport-runtime && cargo test -p engine --release --locked -j 1 timeline_follow -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 timeline_follow -- --nocapture --test-threads=1 && PLAYWRIGHT_MODULE_PATH=C:\\Users\\janua\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\node_modules\\playwright; CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:timeline-performance", "exit_code": 0, "assertion_count": 37, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Focused source checks, 27 engine tests, 3 Tauri tests, and the rendered-browser fixture produce no separately shipped artifact; exact current source, MSVC linker procedure, commands, results, and boundaries are recorded in the linked checkpoint.", "raw_evidence_paths": ["qa/TIMELINE_FOLLOW_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software/runtime/UI and rendered-browser evidence only; it cannot establish native renderer/GPU/display behavior, audible devices, external clocks, physical output, venue/soak, cross-platform execution, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-TIMELINE-MUSICAL-001"] }
    ,{ "id": "EV-TIMELINE-PERSISTENCE-SW-2026-09-13", "scope": "Current-source project persistence, Timeline history/editor, Guide routing, and rendered-browser viewport/navigator contracts", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "node app/scripts/check-project-autosave-coordinator.mjs && node app/scripts/check-project-history-keyboard.mjs && node app/scripts/check-project-history-preflight.mjs && node app/scripts/check-project-open-bootstrap.mjs && pnpm.cmd --dir app run check:project-publication-e4 && pnpm.cmd --dir app run check:project-recovery-e3 && pnpm.cmd --dir app run check:project-storage && node app/scripts/check-timeline-navigator-actions.mjs && pnpm.cmd --dir app run check:timeline-advanced && pnpm.cmd --dir app run check:timeline-viewport && node app/scripts/check-timeline-navigator-browser.mjs && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_publication_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_backup_ -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_coordinator_identity_swap -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_history_generation_preflight -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_history_skips_noops -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_save_reload_uses_authored_video -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_load_recomputes_stale_conform_rate -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 timeline_scene_block_edits_survive_project_history_entries -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 timeline_snap_batch_is_preserved_as_one_project_history_entry -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 39, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Focused source checks, 27 Tauri tests, and rendered-browser fixtures produce no separately shipped artifact; exact current source, MSVC linker procedure, commands, results, and boundaries are recorded in the linked checkpoint.", "raw_evidence_paths": ["qa/TIMELINE_PERSISTENCE_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software/runtime/UI and rendered-browser evidence only; it cannot establish native renderer/GPU/display behavior, audible devices, external clocks, physical output, external-client recovery, venue/soak, cross-platform execution, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-TIMELINE-MUSICAL-001"] }
    ,{ "id": "EV-SHOWCLOCK-IMPLEMENTATION-SW-2026-09-13", "scope": "Current-source ShowClock protocol, estimator, scheduler, exact-peer LAN, Tauri IPC/UI, output-gate, frontend routing/admission, and two-process loopback implementation", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "cargo test -p protocol --release --locked -j 1 show_clock -- --nocapture --test-threads=1 && cargo test -p io --release --locked -j 1 show_clock_lan -- --nocapture --test-threads=1 && cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 show_clock_ipc::tests -- --nocapture --test-threads=1 && cargo test -p io --release --locked -j 1 --test show_clock_two_process -- --nocapture --test-threads=1 && pnpm.cmd --dir app run check:frontend-invokes && pnpm.cmd --dir app run check:frontend-command-routing && node app/scripts/check-tauri-admission-inventory.mjs && pnpm.cmd --dir app run check:output-control-runtime && pnpm.cmd --dir app build && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 33, "ignored_count": 0, "artifact_hash": "BEF911C6D3BF83362504AC466B01459314A02F04D5073E3C158302BBE2CD4A21", "artifact_na_reason": null, "warning_count": 0, "raw_evidence_paths": ["qa/SHOWCLOCK_IMPLEMENTATION_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source software, loopback, and Windows native process evidence only; it cannot establish native button-by-button interaction, physical output, real wired two-machine partition/rejoin, crash/restart replay restoration, witness/interlock, automatic failover, venue, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] }
    ,{ "id": "EV-OBSERVABILITY-DIAGNOSTIC-SW-2026-09-13", "scope": "Current-source bounded diagnostic package redaction, canonical ZIP/integrity validation, preview-before-destination workflow, atomic publication staging, and Windows native process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-13", "command": "cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 diagnostic -- --nocapture --test-threads=1 && pnpm.cmd --dir app run check:status && pnpm.cmd --dir app run check:bundled-library && pnpm.cmd --dir app run check:strict-json && pnpm.cmd --dir app run check:release:self-test && pnpm.cmd --dir app run check:output-ownership && pnpm.cmd --dir app run check:release:static && pnpm.cmd --dir app tauri build --no-bundle && Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 43, "ignored_count": 1, "warning_count": 1, "artifact_hash": "2F66AEE1E77ACFE11118E617E5E2E80CE1D6C37D3DB504BF4637537492B4B15A", "artifact_na_reason": null, "raw_evidence_paths": ["qa/OBSERVABILITY_DIAGNOSTIC_PACKAGE_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "Current-source diagnostic software, focused Rust tests, static contracts, and Windows native process-smoke evidence only; it cannot establish updater resilience, deployed support runbooks, clean-machine installation, signed/publication acceptance, physical/external devices, venue/soak, or product-wide completion.", "linked_q1_ids": ["COV-OBSERVABILITY-001"] }
    ,{ "id": "EV-OBSERVABILITY-CURRENT-SW-2026-09-14", "scope": "Current-source observability/support gate: generation-stamped status, bounded redacted diagnostic package and project replacement, updater identity/configuration fail-closed rules, Windows candidate/release artifact negative suites, strict JSON, bundled library, and exact MSVC-source test rerun", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:status; pnpm.cmd --dir app run check:release:self-test; pnpm.cmd --dir app run check:bundled-library; node app/scripts/check-windows-release-artifacts.mjs --self-test; pnpm.cmd --dir app run check:strict-json; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 diagnostic_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 updater_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement_is_redacted -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 967, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "This checkpoint reruns current-source checks and release-mode Rust tests without producing a separately accepted native/public release artifact; the exact external acceptance boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/OBSERVABILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/UPDATE_RELEASE_RUNBOOK.md"], "currency_nonclaim": "Current-source software evidence only; it does not establish live signed N-to-N+1 update behavior, wrong-channel/downgrade/signature/corruption/offline/rollback acceptance, deployed operator/support drills, clean-machine installation, signing/notarization, publication, native accessibility, physical/external devices, venue/soak, or product completion.", "linked_q1_ids": ["COV-OBSERVABILITY-001"] }
    ,{ "id": "EV-OBSERVABILITY-CURRENT-SW-2026-09-15", "scope": "Current-source observability/support and release recheck after Remote authority and high-DPI UI changes: status, diagnostics/redaction, updater fail-closed behavior, release artifact negatives, bundled library, strict JSON, and focused MSVC Tauri tests", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "pnpm.cmd --dir app run check:status; pnpm.cmd --dir app run check:release:self-test; pnpm.cmd --dir app run check:bundled-library; node app/scripts/check-windows-release-artifacts.mjs --self-test; pnpm.cmd --dir app run check:strict-json; vcvars64.bat -vcvars_ver=14.44; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 diagnostic_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 updater_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_replacement_is_redacted -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 970, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "This checkpoint reruns current-source checks and release-mode Rust tests without producing a separately accepted native/public release artifact; the exact external acceptance boundary is recorded in the linked QA checkpoint.", "raw_evidence_paths": ["qa/OBSERVABILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/UPDATE_RELEASE_RUNBOOK.md"], "currency_nonclaim": "This is current-source software evidence only; it does not establish live signed N-to-N+1 update behavior, wrong-channel/downgrade/signature/corruption/offline/rollback acceptance, deployed operator/support drills, clean-machine installation, signing/notarization, publication, native accessibility, physical/external devices, venue/soak, or product completion.", "linked_q1_ids": ["COV-OBSERVABILITY-001"] }
    ,{ "id": "EV-UI-H5-OUTPUT-CONTROL-SW-2026-09-14", "scope": "Current-source H5 Control lighting master and group submaster canonical OutputControl operations: lease role/resource selection, generation/fence admission, native EngineCommand dispatch, Both control surface, fail-closed legacy raw routes, rendered Touch viewport, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "cargo test -p protocol --locked control_plane_command -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --locked --bin syndocal control_plane::tests -- --nocapture --test-threads=1; pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run check:frontend-invokes; pnpm.cmd --dir app run check:frontend-command-routing; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:touch; pnpm.cmd --dir app run build; MSVC 14.44.35207 x64; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 49, "ignored_count": 0, "warning_count": 1, "artifact_hash": "21B68A04DDFF948DD39C156B7CB79297770B8AFF0AFBD59F24235B50E75BE41E", "artifact_na_reason": null, "raw_evidence_paths": ["qa/OUTPUT_CONTROL_MASTER_SUBMASTER_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source OutputControl/protocol/frontend/static contracts, rendered Touch viewport, and Windows native process-smoke evidence only; it does not establish native button-by-button interaction, physical DMX/Art-Net/sACN/NDI/Spout/display output, real two-machine operation, venue/soak, accessibility, signing, publication, or product-wide completion.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] }
    ,{ "id": "EV-UI-H5-VIDEO-MASTER-SW-2026-09-14", "scope": "Current-source H5 Control Video master opacity canonical OutputControl operation: Video/Both lease role and resource selection, schema-v10 wire admission, generation/fence revalidation, native EngineCommand dispatch, viewport fixture update, fail-closed legacy raw route, static contracts, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "cargo test -p protocol --locked control_plane -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 control_plane::tests -- --nocapture --test-threads=1; pnpm.cmd --dir app run check:release:static; pnpm.cmd --dir app run check:touch; pnpm.cmd --dir app run build; MSVC 14.44.35207 x64; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 98, "ignored_count": 0, "warning_count": 1, "artifact_hash": "A92A9DD0C4055DEF5ECD9A1E819B1CD5024D181710A8D43CC02495FC735E90D6", "artifact_na_reason": null, "raw_evidence_paths": ["qa/OUTPUT_CONTROL_VIDEO_MASTER_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source protocol/native/frontend/static and rendered-browser evidence plus Windows native process smoke only; it does not establish native button-by-button interaction, physical DMX/Art-Net/sACN/NDI/Spout/display output, real two-machine operation, venue/soak, accessibility, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] }
    ,{ "id": "EV-UI-H5-VIDEO-TAKE-SW-2026-09-14", "scope": "Current-source H5 Control Video Clip Take canonical OutputControl operation: Video/Both lease role and resource selection, non-zero layer and bounded fade validation, schema-v11 wire admission, generation/fence revalidation, shared Preview/Program/audio transition core, static contracts, rendered Touch viewport, and Windows native build/process smoke", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "cargo test -p protocol --locked control_plane -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 control_plane::tests -- --nocapture --test-threads=1; pnpm.cmd --dir app run check:release:static; pnpm.cmd --dir app run check:output-control-runtime; SYNDOCAL_VIEWPORT_TRACE=1 pnpm.cmd --dir app run check:touch; pnpm.cmd --dir app run build; MSVC 14.44.35207 x64; pnpm.cmd --dir app tauri build --no-bundle; Exact target/release/syndocal.exe process smoke", "exit_code": 0, "assertion_count": 100, "ignored_count": 0, "warning_count": 1, "artifact_hash": "E75D2A29EEDBE405630DA65E8ED383FB4B732FF78CAEF9AB2D42F45A1D583F82", "artifact_na_reason": null, "raw_evidence_paths": ["qa/OUTPUT_CONTROL_VIDEO_TAKE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source protocol/native/frontend/static and rendered-browser evidence plus Windows native process smoke only; it does not establish native button-by-button interaction, physical HDMI/video output, NDI/Spout/display reception, real two-machine operation, venue/soak, accessibility, signing, publication, or product-wide acceptance.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] }
    ,{ "id": "EV-MIGRATION-CORPUS-RERUN-2026-09-14", "scope": "Current-source takeover rerun of the in-memory migration corpus on `ddf66fc2`: release compile with exact MSVC linker, 11 selected migration tests, 224 truncations, 5 malformed byte/number cases, 3 depth cases, and 128 semantic/idempotency cases", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "node app/scripts/check-migration-corpus.mjs (MSVC 14.44.35207 x64; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 migration_corpus_ -- --nocapture --test-threads=1)", "exit_code": 0, "assertion_count": 11, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The rerun is a current-source software/corpus check and produces no shipped artifact; the broader fuzz matrix, cross-platform support decision, and real upgrade/downgrade rehearsal remain explicitly unclaimed in the linked checkpoint.", "raw_evidence_paths": ["qa/MIGRATION_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source migration corpus evidence only; it does not establish the broader hostile-input fuzz matrix, non-Windows file-identity support, real upgrade/downgrade machine compatibility, external clients, physical output, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-MIGRATION-001"] },
    { "id": "EV-MIGRATION-CORPUS-CURRENT-SW-2026-09-15", "scope": "Current-source Windows project storage, transaction, recovery, publication, bootstrap, history, strict JSON, and bounded migration corpus recheck after current AI3, AI8, UI, and Remote checkpoints", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:project-storage; pnpm.cmd --dir app run check:project-transaction; pnpm.cmd --dir app run check:project-recovery-e3; pnpm.cmd --dir app run check:project-publication-e4; pnpm.cmd --dir app run check:project-open-bootstrap; node app/scripts/check-project-history-preflight.mjs; node app/scripts/check-project-history-keyboard.mjs; node app/scripts/check-project-transaction-recovery-controller.mjs; pnpm.cmd --dir app run check:strict-json; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_file_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_recovery_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 project_publication_ -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 migration_corpus_ -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 13, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source storage/recovery/publication checks and focused release tests produce no separately shipped or cross-platform acceptance artifact; the broader compatibility boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/MIGRATION_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source Windows migration/recovery/corpus evidence only; it does not establish current-source acceptance, the broader hostile-input/fuzz matrix, cross-platform file identity, real upgrade/downgrade or clean-machine rehearsal, external clients, physical output, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-MIGRATION-001"] }
    ,{ "id": "EV-UI-NATIVE-PANE-DPI-CURRENT-2026-09-14", "scope": "Current-source Windows native main-window and Stage/Timeline pane lifecycle acceptance at the physical 1920x1080 primary display after Per-Monitor V2 checker correction", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "Reversible ChangeDisplaySettings target 1920x1080@180Hz/32bpp; MSVC 14.44.35207 x64 Build Tools linker; pnpm.cmd --dir app run check:native-window; finally restored 2560x1600@180Hz/32bpp", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The 19-image native QA report is generated outside the repository and is not a shipped release artifact; the checker change and exact native evidence are recorded in the linked QA documents.", "raw_evidence_paths": ["qa/NATIVE_WINDOW_ACCEPTANCE.md", "qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/CONTROL_BOTH_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "Current-source Windows native main/pane geometry, lifecycle, restart, reload adoption, and direct-child-close evidence only; it does not establish native Control button-by-button interaction, native accessibility, physical MIDI/OSC/DMX/Art-Net/sACN/USB/RDM/video/display output, real two-machine operation, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-UI-H5-NATIVE-SURFACE-CURRENT-2026-09-14", "scope": "Current-source Windows native Control Lighting/Video/Both/Timeline surface probe at a physical 1920x1080 primary display: four-tab ARIA census, visible panel routing, safe Video Audio In disclosure, empty-show recording guard, Both semantic blackout state, Timeline arranger and lower Source shelf", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-14", "command": "Reversible ChangeDisplaySettings target 1920x1080@180Hz/32bpp; MSVC 14.44.35207 x64 Build Tools linker; temporary local wrapper invoking app/scripts/check-native-window-acceptance.ps1; finally restored 2560x1600@180Hz/32bpp", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The four native Control screenshots and JSON report are generated outside the repository and are not shipped artifacts; the checker change and exact native evidence are recorded in the linked QA documents.", "raw_evidence_paths": ["qa/NATIVE_WINDOW_ACCEPTANCE.md", "qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/CONTROL_BOTH_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source native Control surface structure and semantic-state evidence only; it cannot be treated as current-source product acceptance and it does not claim dangerous Control action, recording, Arm, Take, Take Over, device action, native accessibility workflow, physical MIDI/OSC/DMX/Art-Net/sACN/USB/RDM/video/display output, external client, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001", "COV-OUTPUT-LOCAL-001"] }
    ,{ "id": "EV-UI-H5-BROWSER-RERUN-CURRENT-2026-09-15", "scope": "Current-source H5 Control rendered-browser upper-workspace and interaction-contract rerun across standard, short-height, and high-DPI-equivalent viewports", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:control-upper-workspaces (3840x2160, 2560x1440, 2560x1504, 1920x1080, 1280x720, 2560x1504-2x)", "exit_code": 0, "assertion_count": 6, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The rendered-browser gate produces local screenshots but no separately shipped artifact; exact viewport geometry, focus-return, diagnostics, and no-native/device boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source rendered-browser layout and reachability evidence only; it does not establish current-source acceptance, native button-by-button Control interaction, native accessibility, physical output, external clients, recovery, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] }
    ,{ "id": "EV-ACCESSIBILITY-CURRENT-SW-2026-09-15", "scope": "Current-source accessibility-adjacent localization, terminology, empty-state, keyboard-routing, Stage-label, TypeScript, and production-build recheck after high-DPI Video upper-desk repair", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:localization; pnpm.cmd --dir app run check:terminology; pnpm.cmd --dir app run check:empty-states; node app/scripts/check-project-history-keyboard.mjs; node app/scripts/check-timeline-space-keyboard.mjs; pnpm.cmd --dir app run check:stage-labels; pnpm.cmd --dir app exec tsc --noEmit; pnpm.cmd --dir app run build", "exit_code": 0, "assertion_count": 8, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source semantic and build checks produce no separately accepted native accessibility artifact; the named native accessibility environment and operator matrix remain recorded in the linked QA document.", "raw_evidence_paths": ["qa/ACCESSIBILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This is current-source localization, semantic, keyboard-routing, and build evidence only; it does not establish NVDA/JAWS/Narrator traversal, High Contrast, native scaling, IME, reduced-motion, native dangerous-action keyboard workflow, physical/external acceptance, signing, publication, or product completion.", "linked_q1_ids": ["COV-ACCESSIBILITY-001"] }
    ,{ "id": "EV-ASIO-LICENSE-CURRENT-SW-2026-09-15", "scope": "Current-source ASIO licensing and package-separation boundary recheck: pinned SDK, distribution_approved false, exact normal-package runtime allowlist, ASIO rejection cases, and ABI-v3 contract", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:asio-packaging; pnpm.cmd --dir app run check:asio-v3-contract", "exit_code": 0, "assertion_count": 191, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source package-boundary and ABI checks produce no licensed/public ASIO artifact; the unresolved distribution decision and legal boundary are recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_LICENSE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md", "qa/ASIO_SDK_PIN.json"], "currency_nonclaim": "This is current-source fail-closed package evidence only; it does not establish GPLv3 or Steinberg approval, legal review, notices/source-obligation completion, public distribution, real-device/native acceptance, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-FORMAT-CURRENT-SW-2026-09-15", "scope": "Current-source ASIO explicit configuration and format-admission recheck: fail-closed lifecycle, selection persistence, IPC request mapping, unsupported-value rejection, and ABI-v3 contract", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:live-audio; pnpm.cmd --dir app run check:live-audio-ipc-v1; pnpm.cmd --dir app run check:asio-v3-contract", "exit_code": 0, "assertion_count": 22, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source configuration and contract checks produce no real-driver or shipped ASIO matrix artifact; the native external boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_FORMAT_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "This is current-source fail-closed configuration evidence only; it does not claim the advertised sample-rate/buffer/format/channel matrix, real-driver selection, no-fallback native acceptance, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-FAULT-CURRENT-SW-2026-09-15", "scope": "Current-source ASIO fault and lifecycle contract recheck: terminal-event mapping, callback silence, SDK-independent bridge behavior, host-lease ownership, Stop/Close release, and no-fallback handling", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; cargo test --manifest-path tools/asio-bridge/Cargo.toml --locked -- --nocapture; pnpm.cmd --dir app run check:asio-v3-contract", "exit_code": 0, "assertion_count": 53, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "SDK-independent bridge and FFI source tests produce no accepted native device/fault artifact; the real-driver boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_FAULT_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "This is current-source fault-contract evidence only; it does not claim occupied/reset/resync/XRUN/unplug/callback-gap/no-callback native recovery, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-SOAK-CURRENT-SW-2026-09-15", "scope": "Current-source ASIO/WASAPI lifecycle proof adjacent to the soak gate: fail-closed live-audio lifecycle, availability, selection persistence, presentation, and request ordering", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:live-audio", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The lifecycle source check produces no one-hour hardware artifact; the absent long-duration external evidence is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_SOAK_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "This is current-source lifecycle evidence only; it does not claim matched one-hour ASIO/WASAPI soak, callback or capture latency budgets, thermal/clock stability, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-LATENCY-CURRENT-SW-2026-09-15", "scope": "Current-source live-audio lifecycle, telemetry-adjacent, IPC, and ABI proof for the ASIO latency gate", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:live-audio; pnpm.cmd --dir app run check:live-audio-ipc-v1; pnpm.cmd --dir app run check:asio-v3-contract", "exit_code": 0, "assertion_count": 22, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The source lifecycle and ABI checks produce no physical marker, TouchDesigner, or input-to-pixel measurement artifact; the external measurement boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_LATENCY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md"], "currency_nonclaim": "This is current-source lifecycle and contract evidence only; it does not claim capture-to-engine or input-to-pixel latency, five matched TouchDesigner trials, physical audio, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-ASIO-PERSISTENCE-CURRENT-SW-2026-09-15", "scope": "Current-source ASIO selection persistence and normal-package separation recheck: explicit selection lifecycle, exact IPC mapping, stale/ambiguous rejection, runtime inventory, ASIO payload/glob rejection, and SDK-pin immutability", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:live-audio; pnpm.cmd --dir app run check:live-audio-ipc-v1; pnpm.cmd --dir app run check:asio-packaging", "exit_code": 0, "assertion_count": 171, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source selection/package checks produce no accepted final native/public ASIO artifact; the licensing and native persistence boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/ASIO_PERSISTENCE_PACKAGE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/ASIO_INPUT_ACCEPTANCE.md", "qa/ASIO_SDK_PIN.json"], "currency_nonclaim": "This is current-source persistence and package-separation evidence only; it does not claim final native UI telemetry, stale-device operator acceptance, licensed/public ASIO packaging, or product completion.", "linked_q1_ids": ["COV-AUDIO-LIVE-001"] },
    { "id": "EV-DMX-ARTNET-CURRENT-SW-2026-09-15", "scope": "Current-source DMX Art-Net/sACN preparation recheck: addressing, output ownership, safety blackout, and canonical show-setup loopback-before-S0 boundary", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:dmx-addressing; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; node app/scripts/check-dmx-show-setup.mjs", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source preparation checks produce no physical Art-Net/sACN node, fixture, packet, or output artifact; the external matrix is recorded in the linked QA document.", "raw_evidence_paths": ["qa/DMX_ARTNET_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is current-source fail-closed preparation evidence only; it does not claim physical nodes/fixtures, reconnect, topology, RGB/wheel, pan/tilt, intensity, or sustained 44 Hz output.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-DMX-USB-RDM-CURRENT-SW-2026-09-15", "scope": "Current-source USB-DMX/RDM output-control, ownership, and safety boundary recheck", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime", "exit_code": 0, "assertion_count": 3, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source output checks produce no USB-DMX/RDM bytes, analyzer, or fixture artifact; the named gateway and two-fixture external matrix remain recorded in the linked QA document.", "raw_evidence_paths": ["qa/DMX_USB_RDM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is current-source output-control evidence only; it does not claim Enttec/DMXKing timing, E1.20 discovery, ACK/NACK, RDM/TOD, or physical fixture acceptance.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-INPUT-PHYSICAL-CURRENT-SW-2026-09-15", "scope": "Current-source physical-input routing and generation contracts recheck: DVC MIDI/DMX shortcut inventories and frontend command authority inventory", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:dvc-midi-shortcuts; node app/scripts/check-dvc-dmx-shortcuts.mjs; pnpm.cmd --dir app run check:frontend-command-routing", "exit_code": 0, "assertion_count": 80, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source input-routing checks produce no physical client/device artifact; the external input boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/INPUT_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This is current-source routing evidence only; it does not claim physical MIDI/OSC/Remote clients, controller/feedback behavior, reconnect, latency, Clock/MTC, or native device acceptance.", "linked_q1_ids": ["COV-INPUT-001"] },
    { "id": "EV-DJ-LINK-CURRENT-SW-2026-09-15", "scope": "Current-source DJ Link track-mapping, peer-authority, Release, reconnect-fencing, and frontend/runtime policy recheck adjacent to live hardware acceptance", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run check:dj-link", "exit_code": 0, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source DJ Link checks start no external Agent or pedal and produce no live peer/hardware artifact; the external matrix boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/DJ_LINK_HARDWARE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/REKORDBOX_STREAM_DECK_PEDAL_ACCEPTANCE.md"], "currency_nonclaim": "This is current-source DJ Link policy evidence only; it does not claim live Agent/rekordbox/Pedal/remote clients, HELLO/ACK/STATE_SYNC, reconnect/restart, MIDI traffic, or product completion.", "linked_q1_ids": ["COV-REMOTE-TOUCH-001"] },
    { "id": "EV-SHOWCLOCK-VENUE-CURRENT-SW-2026-09-15", "scope": "Current-source ShowClock protocol, paired-LAN loopback, Tauri IPC, and two-process venue-boundary recheck", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; cargo test -p protocol --release --locked -j 1 show_clock -- --nocapture --test-threads=1; cargo test -p io --release --locked -j 1 show_clock_lan -- --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 show_clock_ipc::tests -- --nocapture --test-threads=1; cargo test -p io --release --locked -j 1 --test show_clock_two_process -- --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 33, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Current-source and loopback tests produce no real-switch, second-machine, physical-output, or venue rehearsal artifact; the distributed boundary is recorded in the linked QA document.", "raw_evidence_paths": ["qa/SHOWCLOCK_VENUE_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/SHOWCLOCK_RUNTIME_LAN_REVALIDATION_2026-09-12.md"], "currency_nonclaim": "This is current-source authenticated loopback evidence only; it does not establish a real network switch, two-machine partition/rejoin, crash/restart replay, device-loss recovery, physical output, or venue completion.", "linked_q1_ids": ["COV-SHOWCLOCK-001"] },
    { "id": "EV-UI-H5-VIDEO-REPAIR-CURRENT-2026-09-15", "scope": "Current-source Video upper-desk repair: high-DPI monitor-first reflow for the user-reported physical 2560x1504 surface, ordinary 1280x720 short-height preservation, rendered six-viewport reachability, and safe native Control/pane lifecycle evidence", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; pnpm.cmd --dir app run build; CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:control-upper-workspaces (3840x2160, 2560x1440, 2560x1504, 1920x1080, 1280x720, 2560x1504-2x); pnpm.cmd --dir app run check:native-window -MinimumMaximizedClient 2560x1500 -ExpectedFullscreen 2560x1600 -EvidenceDir C:\\TEMP\\syndocal-native-h5-fixed-20260915-final3", "exit_code": 0, "assertion_count": 16, "ignored_count": 0, "warning_count": 1, "artifact_hash": null, "artifact_na_reason": "The native JSON report and screenshots are generated outside the repository and are not shipped artifacts; the current-source layout, safe native action boundary, and unaccepted H5 workflow boundaries are recorded in the linked QA document.", "raw_evidence_paths": ["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/NATIVE_WINDOW_ACCEPTANCE.md"], "currency_nonclaim": "This is current-source Video layout, rendered-browser, safe native surface, and pane lifecycle evidence only; it does not establish H5 live/dangerous Control operation, recording, native accessibility, physical MIDI/OSC/DMX/video output, external clients, failure/recovery rehearsal, venue/soak, signing, publication, or product completion.", "linked_q1_ids": ["COV-UI-SHELL-001"] }
    ,{ "id": "EV-VIDEO-SCREEN-CAPTURE-CURRENT-2026-09-15", "scope": "Current-source Windows visible-desktop screen-capture worker rerun with a real frame and clean stop", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; SYNDOCAL_FFMPEG=<explicit WinGet FFmpeg 9.0.1 path>; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 screen_worker_captures_a_real_frame -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The worker receives the visible desktop frame in memory and emits no separately shipped artifact; the physical display/output boundary remains recorded in the linked QA document.", "raw_evidence_paths": ["qa/VIDEO_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This current-source screen-capture worker slice does not establish a Syndocal-owned fullscreen output window, physical display pixels, HDMI/NDI/Spout reception, camera fault/replug, frame-drop budget, one-hour operation, or product completion.", "linked_q1_ids": ["COV-OUTPUT-LOCAL-001"] },
    { "id": "EV-RECORDING-REAL-CODEC-LONG-2026-09-15", "scope": "Current-source real FFmpeg H.264/AAC recording generation plus synthetic 30-minute A/V sync boundary with first/middle/last video and audio observations", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-15", "command": "MSVC 14.44.35207 x64; SYNDOCAL_FFMPEG=<explicit WinGet FFmpeg 9.0.1 path>; SYNDOCAL_FFPROBE=<explicit WinGet FFprobe 9.0.1 path>; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 recording_command_writes_a_real_video_and_audio_mp4 -- --ignored --nocapture --test-threads=1; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 recording_command_keeps_long_av_sync_with_first_and_last_flash_clicks -- --ignored --nocapture --test-threads=1", "exit_code": 0, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The MP4/report are test-only files under C:\\TEMP and are not shipped artifacts; the native UI, physical camera/display, disk/power, encoder ownership, and venue boundaries remain recorded in the linked QA document.", "raw_evidence_paths": ["qa/RECORDING_CHECKPOINT_2026-09-13.md"], "currency_nonclaim": "This closes only current-source real-codec file generation and synthetic 30-minute A/V sync; it does not establish native in-app recording interaction, physical capture/output, disk-full/power-loss recovery, two-PC ownership, or product completion.", "linked_q1_ids": ["COV-RECORDING-001"] },
    {"id":"EV-ACCESSIBILITY-NATIVE-UIA-CURRENT-2026-09-15","scope":"Current native Syndocal UI Automation census and keyboard-only focus/confirmation recheck with NVDA 2026.1.1 installed","kind":"current-source-automated","status":"accepted-current","date":"2026-09-15","command":"winget install --id NVAccess.NVDA --exact; native Syndocal release window; Windows UI Automation census (202 descendants); WScript.Shell Tab traversal; keyboard focus Prepare + Enter + confirmation cancel","exit_code":0,"assertion_count":3,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The UI Automation census and focus transcript are current native observations, not a shipped artifact; the named accessibility gaps and nonclaim are recorded in the linked QA checkpoint.","raw_evidence_paths":["qa/ACCESSIBILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This records UI Automation names/focus and pre-action confirmation only; it is not current-source acceptance and does not establish NVDA speech announcements, High Contrast, native 125/150/200% scaling, IME, reduced motion, full dangerous-action/recovery workflow, or product completion.","linked_q1_ids":["COV-ACCESSIBILITY-001"]},
    {"id":"EV-OUTPUT-COM5-PREPARE-UI-CURRENT-2026-09-15","scope":"Current native COM5 USB-DMX Prepare attempt, fail-closed publication result, All Blackout rejection, exact-process restart recovery, and direct zero-frame handle probe","kind":"current-source-automated","status":"accepted-current","date":"2026-09-15","command":"Native release Syndocal UI: load samples/phase1-mini-show.sdc; select COM5 FTDI; Prepare confirmation Yes; observe 4/4 optional Open DMX arm publication_failed; All Blackout invalid_request/forbidden; discard-close and restart exact target/release/syndocal.exe; Windows SerialPort direct COM5 250000 baud 8N2 writes two zero-only 513-byte frames and closes","exit_code":0,"assertion_count":5,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"Native screenshots are stored under C:\\TEMP and are not shipped artifacts; no physical fixture receipt, BREAK/MAB timing capture, or serial-DMX analyzer artifact was produced.","raw_evidence_paths":["qa/DMX_USB_RDM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md","qa/VIDEO_PHYSICAL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This records current native fail-closed, application-restart, and direct serial-handle zero-write behavior only; it is not current-source acceptance and does not claim physical zero delivery, fixture output, blackout delivery, RDM/TOD, analyzer timing, or product completion.","linked_q1_ids":["COV-OUTPUT-LOCAL-001"]},
    {"id":"EV-UI-H5-ALL-SCREEN-REVIEW-CURRENT-2026-09-15","scope":"Current-source all-screen UI clipping review and repairs: topbar safety-label containment, compact Touch Image-tile containment, Timeline runtime-label spacing, rendered Lighting/Video/Both/Timeline and Setup I/O/Patch/Video matrices, Touch matrix, and safe native release/pane recheck","kind":"current-source-automated","status":"accepted-current","date":"2026-09-15","command":"pnpm.cmd --dir app run build; CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:topbar-pulse; pnpm.cmd --dir app run check:control-upper-workspaces; pnpm.cmd --dir app run check:video-setup-viewport; node app/scripts/check-viewport-containment.mjs --setup-io-only; node app/scripts/check-viewport-containment.mjs --patch-only; pnpm.cmd --dir app run check:touch; pnpm.cmd --dir app tauri build --no-bundle; node app/scripts/run-native-window-acceptance.mjs -MinimumMaximizedClient 2560x1500 -ExpectedFullscreen 2560x1600 -EvidenceDir C:\\TEMP\\syndocal-native-ui-final-20260915","exit_code":0,"assertion_count":40,"ignored_count":1,"warning_count":1,"artifact_hash":null,"artifact_na_reason":"The native report and viewport screenshots are generated under C:\\TEMP and are not shipped artifacts; this record preserves the exact current-source UI evidence and its nonclaims in the linked checkpoint.","raw_evidence_paths":["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md","qa/NATIVE_WINDOW_ACCEPTANCE.md"],"currency_nonclaim":"This accepts current-source rendered layout, containment, focus-return, diagnostics, exact release build/process smoke, and safe native pane lifecycle only; it does not establish native button-by-button live/dangerous Control operation, physical output, accessibility matrix, external clients, failure/recovery rehearsal, venue/soak, signing, publication, or product completion.","linked_q1_ids":["COV-UI-SHELL-001"]}
    ,{"id":"EV-UI-H5-ALL-SCREEN-RECHECK-CURRENT-2026-09-18","scope":"Current-source rendered UI recheck for the reported upper-screen collapse across shared Edit workspaces, Setup DMX/IO, Video Setup, and Touch surfaces","kind":"current-source-automated","status":"accepted-current","date":"2026-09-18","command":"CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:topbar-pulse; pnpm.cmd --dir app run check:control-upper-workspaces; pnpm.cmd --dir app run check:video-setup-viewport; pnpm.cmd --dir app run check:touch; node app/scripts/check-viewport-containment.mjs --setup-dmx-only; node app/scripts/check-viewport-containment.mjs --setup-io-only","exit_code":0,"assertion_count":42,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"Rendered screenshots are generated under C:\\TEMP and are not shipped artifacts; this current-source recheck records containment, focus-return, diagnostics, and the startup-harness retry boundary in the linked QA document.","raw_evidence_paths":["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This current-source rendered UI evidence does not establish native button-by-button live/dangerous Control operation, recording, native accessibility, physical output, external clients, failure/recovery, venue/soak, signing, publication, or product completion.","linked_q1_ids":["COV-UI-SHELL-001"]}
    ,{"id":"EV-UI-H5-SHORT-OPERATOR-REPAIR-CURRENT-2026-09-18","scope":"Current-source short-height operator reflow repair for the reported upper-screen collapse: Control upper workspaces, VJ operator, fullscreen VJ, Audio Reactive, live audio, Video Setup, Touch, and Workspace Operator rendered containment","kind":"current-source-automated","status":"accepted-current","date":"2026-09-18","command":"CHROME_PATH=C:\\Users\\janua\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe; pnpm.cmd --dir app run check:control-upper-workspaces; pnpm.cmd --dir app run check:vj-operator; pnpm.cmd --dir app run check:fullscreen-vj; pnpm.cmd --dir app run check:audio-reactive-viewport; pnpm.cmd --dir app run check:live-audio-viewport; pnpm.cmd --dir app run check:video-setup-viewport; pnpm.cmd --dir app run check:touch; pnpm.cmd --dir app run check:workspace-operator-viewport","exit_code":0,"assertion_count":46,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"Rendered screenshots and DOM geometry are generated under C:\\TEMP and are not shipped artifacts; the exact current-source results and nonclaims are recorded in the linked UI checkpoint.","raw_evidence_paths":["qa/UI_H5_CONTROL_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md","app/src/styles.css","app/scripts/check-viewport-containment.mjs"],"currency_nonclaim":"This current-source rendered UI evidence does not establish native button-by-button live/dangerous Control operation, recording, native accessibility, physical output, external clients, failure/recovery, venue/soak, signing, publication, or product completion.","linked_q1_ids":["COV-UI-SHELL-001"]},
    {"id":"EV-AI3-NATIVE-INGRESS-BRIDGE-PREFLIGHT-2026-09-18","scope":"Current-host SMC-Mixer Bluetooth bridge installation and production midir/WinMM recheck","kind":"current-source-automated","status":"open","date":"2026-09-18","command":"PnP SMC-Mixer Bluetooth MIDI IN/OUT inventory; official Sinco Connector install; official BMIDI_Driver_2.1.0.44.exe MD5 f9b4f6f3894dceddb54398a055948bc8 and Authenticode Valid; connector diagnostic; MSVC 14.44.35207 x64 cargo test -p io --release --locked -j 1 physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture --test-threads=1","exit_code":1,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The bridge and BMIDI driver are installed and diagnostically loadable, but the Connector device action was not invoked and production midir still enumerated CustomMIDI1 only; no physical raw-ingress artifact exists.","raw_evidence_paths":["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This preflight cannot establish current-source acceptance, Bluetooth forwarding, physical MIDI acceptance, controller movement, feedback, Clock/MTC, reconnect, latency, OSC/Remote, DMX/Art-Net, venue, or product completion.","linked_q1_ids":["COV-AI-CONTROL-001"]},
    {"id":"EV-OUTPUT-PHYSICAL-DMX-2026-09-18","scope":"Current-host FTDI COM5 serial-DMX production worker recheck at bounded low-master settings","kind":"current-source-automated","status":"accepted-current","date":"2026-09-18","command":"MSVC 14.44.35207 x64; SYNDOCAL_PHYSICAL_SERIAL=COM5; SYNDOCAL_PHYSICAL_SECONDS=10; SYNDOCAL_PHYSICAL_MASTER=20; cargo test -p engine --release --locked -j 1 physical_serial_rainbow_demo_drives_master_dimmer_and_rgb_cells -- --ignored --nocapture --test-threads=1","exit_code":0,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The current physical serial-DMX recheck has no separately shipped artifact; exact source, port identity, toolchain, command, telemetry, and absence of current operator visual confirmation are recorded in the linked M4 QA document.","raw_evidence_paths":["qa/M4_IO_VALIDATION.md","qa/DMX_USB_RDM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This current-source serial-DMX transport telemetry does not establish operator-confirmed current fixture output, long-run timing/waveform, RDM/TOD, Art-Net/sACN, NDI/Spout/display, ownership replacement, AI3 project re-Arm, venue, signing, publication, or product completion.","linked_q1_ids":["COV-OUTPUT-LOCAL-001"]}
    ,{"id":"EV-OUTPUT-PHYSICAL-DMX-30S-2026-09-18","scope":"Current-host FTDI COM5 serial-DMX production worker supervised 30-second recheck at bounded low-master settings","kind":"current-source-automated","status":"accepted-current","date":"2026-09-18","command":"MSVC 14.44.35207 x64; SYNDOCAL_PHYSICAL_SERIAL=COM5; SYNDOCAL_PHYSICAL_SECONDS=30; SYNDOCAL_PHYSICAL_MASTER=20; cargo test -p engine --release --locked -j 1 physical_serial_rainbow_demo_drives_master_dimmer_and_rgb_cells -- --ignored --nocapture --test-threads=1","exit_code":0,"assertion_count":1,"ignored_count":0,"warning_count":0,"artifact_hash":null,"artifact_na_reason":"The current 30-second physical serial-DMX recheck has no separately shipped artifact; exact source, port identity, toolchain, command, telemetry, and absence of current operator visual confirmation are recorded in the linked M4 and DMX/RDM QA documents.","raw_evidence_paths":["qa/M4_IO_VALIDATION.md","qa/DMX_USB_RDM_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"],"currency_nonclaim":"This current-source serial-DMX transport telemetry does not establish operator-confirmed current fixture output, long-run timing/waveform, RDM/TOD, Art-Net/sACN, NDI/Spout/display, ownership replacement, AI3 project re-Arm, venue, signing, publication, or product completion.","linked_q1_ids":["COV-OUTPUT-LOCAL-001"]}
    ,{ "id": "EV-ACCESSIBILITY-NATIVE-HC-200-CURRENT-2026-09-18", "scope": "Current exact-release native accessibility recheck with NVDA process active, Windows High Contrast toggled and restored, UI Automation census, and 200% effective DPI visual containment", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-18", "command": "Start C:\\Program Files\\NVDA\\nvda_noUIAccess.exe; exact target/release/syndocal.exe; Windows UI Automation census after NVDA activation (136 descendants); GetDpiForWindow=192 (200%); SystemParametersInfo High Contrast flags 126 -> 127 -> 126; PrintWindow capture C:\\TEMP\\syndocal-native-high-contrast-20260918.png", "exit_code": 0, "assertion_count": 4, "ignored_count": 0, "warning_count": 0, "artifact_hash": "AF5196AB8531743D55D5C61310CBDC7D7DA5222F1ABCEABEF1A5B57C2AED8DAB", "artifact_na_reason": "The native screenshot is generated under C:\\TEMP and is not a shipped artifact; the exact UIA/NVDA-process observation, High Contrast restore, 200% DPI result, visual review, and remaining native accessibility nonclaims are recorded in the linked QA checkpoint.", "raw_evidence_paths": ["qa/ACCESSIBILITY_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This current native slice does not establish current-source acceptance; it does not establish NVDA speech announcements, 125%/150% scaling, IME, reduced motion, complete keyboard-only dangerous-action/recovery, every dialog/popout focus return, physical output, external clients, venue, signing, publication, or product completion.", "linked_q1_ids": ["COV-ACCESSIBILITY-001"] }
    ,{ "id": "EV-AI3-NATIVE-INGRESS-CURRENT-SW-2026-09-21", "scope": "Current-working-tree AI3 ingress/admission/ownership/safety recheck, release Agent Bridge regression, and Windows-native warning ratchet", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-21", "command": "pnpm.cmd --dir app run check:frontend-command-routing; node app/scripts/check-tauri-admission-inventory.mjs; pnpm.cmd --dir app run check:output-control-runtime; pnpm.cmd --dir app run check:output-ownership; pnpm.cmd --dir app run check:safety-blackout-runtime; pnpm.cmd --dir app run check:dvc-midi-shortcuts; node app/scripts/check-dvc-dmx-shortcuts.mjs; pnpm.cmd --dir app run check:agent-bridge; cargo test --manifest-path app/src-tauri/Cargo.toml --release --locked -j 1 agent_bridge_ -- --nocapture --test-threads=1; pnpm.cmd --dir app run check:warnings -- --configuration windows-native-release", "exit_code": 0, "assertion_count": 10, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "These current-source suites produce no native hardware-ingress or physical-output artifact; their results and nonclaims are retained in the AI3 checkpoint.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "qa/SYNDOCAL_AI_CONTROL_PLANE_ROADMAP.md", "qa/M4_IO_VALIDATION.md"], "currency_nonclaim": "This does not establish current-source acceptance. The checks establish current-working-tree source/admission/ownership/safety/Agent Bridge and Windows warning evidence only; they do not establish physical SMC-Mixer control movement, feedback/Clock/MTC, native OSC/Remote, real DMX/Art-Net, reconnection, latency, venue, or marker completion.", "linked_q1_ids": ["COV-AI-CONTROL-001"] }
    ,{ "id": "EV-AI3-NATIVE-INGRESS-OPERATOR-CAPTURE-2026-09-21", "scope": "Current-host UI-visible SMC-Mixer connected state followed by a 60-second production WinMM/midir operator-ingress capture", "kind": "current-source-automated", "status": "open", "date": "2026-09-21", "command": "BTMidiConnector UI: paired SMC-Mixer Connect Device then observed SMC-Mixer Connected.; MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=60; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1", "exit_code": 101, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The production input opened but received no MIDI message during the 60-second capture, so no raw ingress artifact exists.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This does not establish current-source acceptance. It records a connected bridge and fail-closed no-message capture only; it does not establish physical controller movement, mapped/canonical ingress, feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, real DMX/Art-Net, venue, or AI3 acceptance.", "linked_q1_ids": ["COV-AI-CONTROL-001", "COV-INPUT-001"] },
    { "id": "EV-AI3-NATIVE-INGRESS-ALIAS-CAPTURE-2026-09-21", "scope": "Current-host exact SMC-Mixer-bt and MIDIIN2 (SMC-Mixer) production WinMM/midir input alias captures plus no-output endpoint enumeration", "kind": "current-source-automated", "status": "open", "date": "2026-09-21", "command": "MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer-bt; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=60; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1 (exit 101, no message); repeat with SYNDOCAL_TEST_MIDI_INPUT=MIDIIN2 (SMC-Mixer) (exit 101, no message); read-only PnP/process inventory; no-output physical_midi_ports_enumerate_open_and_send_feedback diagnostic with guaranteed nonmatching selectors (listed endpoints then failed before connect/send)", "exit_code": 101, "assertion_count": 2, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "Both selected inputs opened but yielded no raw event. Operator movement during the windows was not independently confirmed; the separate endpoint enumeration intentionally stopped before opening an endpoint or sending output.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md"], "currency_nonclaim": "This does not establish current-source acceptance. It records current-host no-message alias captures and endpoint inventory only; it does not establish that the controller is faulty, physical movement, mapped/canonical ingress, feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, DMX/Art-Net, venue, or AI3 acceptance.", "linked_q1_ids": ["COV-AI-CONTROL-001", "COV-INPUT-001"] },
    { "id": "EV-AI3-NATIVE-INGRESS-UI-SELECTION-2026-09-21", "scope": "Current-source MIDI input selection default and production MIDI parser/control/feedback regression set", "kind": "current-source-automated", "status": "accepted-current", "date": "2026-09-21", "command": "pnpm.cmd --dir app run check:f1-input-generations; MSVC 14.44.35207 x64 with pinned linker first; cargo test -p io --release --locked -j 1 midi_ -- --test-threads=1", "exit_code": 0, "assertion_count": 9, "ignored_count": 3, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The source checks and Rust tests produce no raw physical ingress/output artifact; input-selection behavior and acceptance boundary are retained in the linked checkpoint.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_CURRENT_SOURCE_CHECKPOINT_2026-09-14.md", "app/src/createControlInputController.ts", "crates/io/src/midi.rs"], "currency_nonclaim": "This does not establish current-source acceptance. It records input-selection source and software tests only; it does not prove selected UI port state, physical operator movement, raw SMC-Mixer ingress through mapped callbacks/leases, feedback/Clock/MTC, reconnect, latency, or the full AI3 native/hardware matrix.", "linked_q1_ids": ["COV-AI-CONTROL-001", "COV-INPUT-001"] }
    ,{ "id": "EV-AI3-NATIVE-INGRESS-ENDPOINT-INVENTORY-2026-09-22", "scope": "Current-host USB/Bluetooth SMC-Mixer device identity and production WinMM/midir endpoint inventory with nonmatching selectors", "kind": "current-source-automated", "status": "open", "date": "2026-09-22", "command": "MSVC 14.44.35207 x64 with pinned linker first; read-only PnP/BTMidiConnector UIA inventory; SYNDOCAL_TEST_MIDI_INPUT=__CODEX_ENUM_ONLY_NO_MATCH_INPUT__; SYNDOCAL_TEST_MIDI_OUTPUT=__CODEX_ENUM_ONLY_NO_MATCH_OUTPUT__; cargo test -p io --release --locked -j 1 physical_midi_ports_enumerate_open_and_send_feedback -- --ignored --nocapture --test-threads=1 (intentional no-match before endpoint open/send)", "exit_code": 101, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The diagnostic printed current endpoint names then failed before opening an endpoint or sending bytes; no raw ingress artifact was produced.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_RECHECK_2026-09-22.md", "crates/io/src/midi.rs"], "currency_nonclaim": "This does not establish current-source AI3 ingress acceptance; endpoint presence, USB/BLE identity, and bridge Connected state do not prove a controller event, app-selected input, mapping/lease routing, feedback, Clock/MTC, or physical acceptance.", "linked_q1_ids": ["COV-AI-CONTROL-001", "COV-INPUT-001"] }
    ,{ "id": "EV-AI3-NATIVE-INGRESS-OPERATOR-CAPTURE-2026-09-22", "scope": "Current-host UI-verified SMC-Mixer connection and 60-second production WinMM/midir receive-only operator-ingress capture", "kind": "current-source-automated", "status": "open", "date": "2026-09-22", "command": "BTMidiConnector UIA: SMC-Mixer Connected.; MSVC 14.44.35207 x64 with pinned linker first; SYNDOCAL_TEST_MIDI_INPUT=SMC-Mixer; SYNDOCAL_TEST_MIDI_CAPTURE_SECONDS=60; cargo test -p io --release --locked -j 1 physical_midi_input_captures_operator_ingress -- --ignored --nocapture --test-threads=1", "exit_code": 101, "assertion_count": 1, "ignored_count": 0, "warning_count": 0, "artifact_hash": null, "artifact_na_reason": "The production input opened but received no MIDI message; operator movement during the capture was not independently confirmed, so no raw ingress artifact exists.", "raw_evidence_paths": ["qa/AI3_NATIVE_INGRESS_RECHECK_2026-09-22.md", "crates/io/src/midi.rs"], "currency_nonclaim": "This does not establish current-source acceptance or device fault. It records a connected bridge and fail-closed no-message capture only; it does not establish physical operator movement, app-selected/mapped ingress, feedback/Clock/MTC, reconnect/replacement, latency, OSC/Remote, real DMX/Art-Net, venue, or AI3 acceptance.", "linked_q1_ids": ["COV-AI-CONTROL-001", "COV-INPUT-001"] }
  ]
}
```
...
## 45. 2026-09-12 ShowClock atomic admission and canonical-tag checkpoint

The current ShowClock continuation hardens the software admission boundary.
Peer validation and estimator generation/receive-order validation now complete
before either validator state or estimator state is committed, so a rejected
estimator observation cannot consume peer sequence state. Sample and action
canonical bytes use explicit stable wire-tag mappings rather than enum
declaration casts; the existing v1 canonical vectors remain unchanged.

The focused protocol suite passes 19/19 and the full protocol suite passes 237
unit tests, 7 integration tests, and 4 doctests. The focused LAN suite passes
3/3 and the two-process integration suite passes 2/2. The exact pinned MSVC
14.44.35207 no-bundle build passes in 3m35s without first-party warnings; the
current executable SHA-256 is
`DBD55E63DA4AA2CE629941838E1779081ED7A22107B11FEC4DD548F9C7CFEF3E`, and the
exact-path process smoke observed one responsive Syndocal window with maximize
requested and clean exit.

This checkpoint remains current-source and loopback evidence only. Native UI
...
completion remain unaccepted external gates.

## 46. 2026-09-12 ShowClock current-source native artifact refresh

After formatting the current ShowClock protocol sources, the exact pinned
MSVC 14.44.35207 x64 `tauri build --no-bundle` was rerun. It completed in
3m32s without first-party warnings. The exact-path process smoke observed one
...
This refresh only updates the artifact binding for the software/native
process-smoke checkpoint. It does not claim native UI interaction, physical
...
venue behavior, signing, publication, or product-wide completion. No physical
DMX output was emitted in this checkpoint.

## 48. 2026-09-12 ShowClock UI sequence recovery

The ShowClock panel now advances its action-sequence input from the latest
backend status on polling and command responses. After a panel remount or
refresh, the next action therefore does not resubmit an old sequence. Session
id and pairing key remain non-persistent, and unsafe/non-safe integer status
values are ignored.
...
## 47. 2026-09-12 ShowClock session-monotonic action admission

The ShowClock action scheduler now retains a session-local monotonic sequence
floor. Replayed or reordered Primary action sequences are rejected before
queue mutation, same-time/same-sequence collisions cannot overwrite a queued
action, and the floor resets only after an explicitly advanced armed-fence
rebind. The regression proves queued-action preservation and post-dispatch
replay rejection.

Protocol focused tests pass 20/20 and the full protocol suite passes 238 unit,
7 integration, and 4 doctests. IO LAN passes 3/3, two-process passes 2/2,
and Tauri ShowClock passes 6/6. The pinned MSVC 14.44.35207 x64 no-bundle
build passes in 3m33s without first-party warnings; exact-path process smoke
...
## 49. 2026-09-13 ShowClock duplicate action status recovery floor

During the remaining ShowClock IPC audit, Standby status was found to accept an
old authenticated duplicate after a later action and then publish the older
sequence as `last_action_sequence`. That could cause a remounted UI to choose a
sequence already rejected by the backend admission floor. The status publisher
now keeps the maximum observed sequence while still reporting the latest action
id, admission result, and accepted-action count. The focused regression
`duplicate_action_status_cannot_lower_sequence_recovery_floor` closes this
local recovery-path defect.

The current source passes protocol 20/20 plus the full protocol suite (238 unit,
7 integration, 4 doctests), IO LAN 3/3, two-process 2/2, and Tauri ShowClock
7/7. TypeScript/Vite passes with 354 modules; frontend invoke inventory and
routing pass with 464 and 133/31/28/471. The exact pinned MSVC 14.44.35207
no-bundle build completed in 2m37s (180.02s wall) without first-party warnings.
The exact-path process smoke observed one responsive `Syndocal` window,
requested maximize, exited with code 0, and left no exact-path process. The
current-source executable SHA-256 is
`56BD2EF7B828D1597ECFD3C4EC842248FDC41A668A16D5C298AA14310854FCC2`.

This is current-source, native process-smoke, and loopback evidence only. It
does not claim native UI interaction, physical MIDI/OSC/DMX/Art-Net output,
...
## 50. 2026-09-13 ShowClock generation-reset status and child-process reap safety

During the remaining ShowClock IPC/process audit, Manual Re-arm was found to
reset the estimator and scheduler while leaving old-generation action counters
and the last action identity in the published status. Re-arm now clears
`accepted_actions`, `scheduled_actions`, `last_action_sequence`, and
`last_action_id`; the lifecycle regression asserts the complete reset.

The two-process loopback harness now wraps its spawned child in a Drop guard
that kills and joins it on early assertion/setup exit, while preserving the
normal success-path wait. This closes a local test-harness ownership boundary;
it is not evidence for a real two-machine fault or partition test.

The current source passes Tauri ShowClock 7/7 and two-process 2/2. The exact
pinned MSVC 14.44.35207 x64 no-bundle build passes in 2m31s (174.5s wall)
without first-party warnings. Exact-path process smoke observed one responsive
Syndocal window, requested maximize, closed cleanly with exit code 0, and left
no exact-path process. The current-source executable SHA-256 is
`963EFCAF7F53D9E9E14A0AC6D3B7CFA6819CA56E096F90D6309AD2CC1A356EF4`.

This remains current-source, native process-smoke, and loopback evidence only.
Native UI button-by-button interaction, physical output, real wired two-machine
partition/rejoin/crash/restart/soak, replay restoration, witness/interlock,
automatic failover, venue behavior, signing, publication, and product-wide
completion remain unaccepted external gates. No physical DMX output was
emitted.

...
| Lighting Cue Engine v2 | Complete locally; Daslight FX parity open | Cue Lists/Executors, tracking/block, Parts, IFCB Fade/Delay, Follow, MIB, HTP/LTP, Programmer/Blind, reference Palettes, ordered FX stack and seven-family/13-preset library; independent Color engine with 2-8 stops, four algorithms, RGB/HSV interpolation, spread and RGB/RGBW/CMY/HSV/wheel bindings; independent Chaser with ordered fixture/group/gap steps, 1-16 feature ranges, Forward/Reverse/Bounce/seeded Random, Wings, active width, duty/fading, Size/Phase/spread and free/beat clocks; publication-safe add/update, selective Effect ON/OFF Cue Recall and scoped Look update; DMX Input/Merge, ENTTEC Pro-compatible/DMXKing/Open DMX serial output and RDM protocol tests | Per-Cue Effect parameter morph/fade and source-linked scene blocks; calibrated Amber/Lime/UV/multi-emitter colorimetry and physical Color/Chaser acceptance; independent Move/Curve/Value/image-mapping engines; Art-Net/sACN/serial waveform, QLC+-class serial VID/PID and dual-port expansion, RDM fixtures/gateway, controller round trip |
...
| Performance/reliability | Complete for established local gates; new Color/Chaser venue budget open | Two one-hour release soaks, zero drops/send failures, p99 timing budgets pass; 4K HAP R GPU and engine large-show tests pass; deterministic 200 fixtures × 64 active effect regressions cover both Color and Chaser with one Chaser level evaluation per fixture/effect/tick; maximum-control Chaser also evaluates 10 effects × 16 features × 64 fixtures × maximum width/Wings over 10 frames inside the focused budget | Release-build 44 Hz/p95/p99 mixed Color/Chaser benchmark and one-hour mixed lighting soak; representative multi-layer 4K media and mixed ISF/HAP one-hour venue-host soak |

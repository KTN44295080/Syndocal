...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Protocol admission and manual fence core are implemented; network adapter, estimator soak, partition/rejoin, and two-machine venue proof remain." },
      ...
      "evidence_ids": ["EV-SHOWCLOCK-PROTOCOL-SW-2026-09-12"]
    },
    {

...
async function runSelfTest() {
  ...
  pass(validateVersionSet({ workspaceVersion: "1.2.0-alpha.19", lockVersion: "1.2.0-alpha.19", packageVersion: "1.2.0-alpha.19", tauriVersion: "1.2.0-alpha.19" }) === "1.2.0-alpha.19", "synchronized version set is accepted");
  rejects(() => validateVersionSet({ workspaceVersion: "1.2.0-alpha.19", lockVersion: "1.2.0-alpha.14", packageVersion: "1.2.0-alpha.19", tauriVersion: "1.2.0-alpha.19" }), /version drift/, "version drift is rejected");

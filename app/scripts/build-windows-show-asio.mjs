...
async function runSelfTest() {
  ...
  pass(validateVersionSet({ workspaceVersion: "1.2.0-alpha.23", lockVersion: "1.2.0-alpha.23", packageVersion: "1.2.0-alpha.23", tauriVersion: "1.2.0-alpha.23" }) === "1.2.0-alpha.23", "synchronized version set is accepted");
  rejects(() => validateVersionSet({ workspaceVersion: "1.2.0-alpha.23", lockVersion: "1.2.0-alpha.14", packageVersion: "1.2.0-alpha.23", tauriVersion: "1.2.0-alpha.23" }), /version drift/, "version drift is rejected");

...
```json syndocal-q1-q4-ledger
{
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P1", "disposition": "Protocol admission, deterministic estimator/bounded-slew/Hold/STALE, action scheduling, output-generation gate, exact-peer loopback transport, and current-source engine beat-position continuity are implemented; Tauri IPC/UI wiring, restart replay restoration, partition/rejoin, witness/interlock, and two-machine venue proof remain." },
      "nonclaim": "This row does not claim Tauri IPC/UI wiring, automatic failover, physical output, restart replay restoration, partition/rejoin, or two-machine venue acceptance.",
      "decision_ids": ["DEC-SHOW-TRANSPORT-001", "DEC-SHOW-FENCE-001", "DEC-CLOCK-MASTER-001"],
      "risk_ids": ["R-SHOW-SPLIT-001"],
      "evidence_ids": ["EV-SHOWCLOCK-PROTOCOL-SW-2026-09-12", "EV-SHOWCLOCK-ENGINE-CONTINUITY-SW-2026-09-12", "EV-SHOWCLOCK-RUNTIME-LAN-SW-2026-09-12"]
    },
    {

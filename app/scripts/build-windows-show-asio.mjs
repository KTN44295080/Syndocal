...
async function runSelfTest() {
  ...
  pass(validateVersionSet({ workspaceVersion: "1.2.0-alpha.24", lockVersion: "1.2.0-alpha.24", packageVersion: "1.2.0-alpha.24", tauriVersion: "1.2.0-alpha.24" }) === "1.2.0-alpha.24", "synchronized version set is accepted");
  rejects(() => validateVersionSet({ workspaceVersion: "1.2.0-alpha.24", lockVersion: "1.2.0-alpha.14", packageVersion: "1.2.0-alpha.24", tauriVersion: "1.2.0-alpha.24" }), /version drift/, "version drift is rejected");

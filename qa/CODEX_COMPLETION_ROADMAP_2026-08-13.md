...
```json syndocal-q1-q4-ledger
{
  ...
  "expected_counts": {
    ...
    "flow_markers": { "Open": 27, "Deferred": 8, "Complete": 23 },
    "q1_rows": 32,
    "q2_decisions": 15,
    "q3_risks": 14,
    "q4_evidence": 48
  ...
  "q1_requirements": [
    ...
    },
    {
      ...
      "status": "In progress",
      "commit": "",
      "residual_risk": { "classification": "P2", "disposition": "H1 current-source reachability is accepted; H2-H5 shared shell/workspace completion, native interaction, and physical boundaries remain." },
      "nonclaim": "This row does not claim H2-H5 shared-shell/workspace completeness or native interaction/physical acceptance.",
      "decision_ids": [],
      "risk_ids": [],
      "evidence_ids": ["EV-UI-SHELL-SW-2026-09-12", "EV-UI-H1-REACHABILITY-SW-2026-09-13"]
    },
    {

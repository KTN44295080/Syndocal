...
# counts. Engine inventory is already 250 after the strict Release count repair;
# Tauri and unclassified counts remain unchanged here.
replace_exact(
    registry,
...
replace_exact(
    ...
    "        assert_eq!(registry.operations.len(), 1413);",
